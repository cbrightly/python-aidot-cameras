...
public class VersionedParcelParcel extends VersionedParcel {
    ...
    public VersionedParcel createSubParcel() {
        ...
        int i2 = i;
        return new VersionedParcelParcel(parcel, dataPosition, i2, this.mPrefix + JustifyTextView.TWO_CHINESE_BLANK, this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
