...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public boolean onStateChange(int[] stateSet) {
        ...
        VectorDrawableCompatState state = this.mVectorState;
        ColorStateList colorStateList = state.mTint;
        if (!(colorStateList == null || (mode = state.mTintMode) == null)) {
    ...
    public float getPixelSize() {
        ...
        float intrinsicWidth = vPathRenderer.mBaseWidth;
        float intrinsicHeight = vPathRenderer.mBaseHeight;
        return Math.min(vPathRenderer.mViewportWidth / intrinsicWidth, vPathRenderer.mViewportHeight / intrinsicHeight);
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static androidx.vectordrawable.graphics.drawable.VectorDrawableCompat create(@androidx.annotation.NonNull android.content.res.Resources r7, @androidx.annotation.DrawableRes int r8, @androidx.annotation.Nullable android.content.res.Resources.Theme r9) {
        /*
    ...
    public static VectorDrawableCompat createFromXmlInner(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) {
    ...
    private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser, Resources.Theme theme) {
        ...
        float namedFloat = TypedArrayUtils.getNamedFloat(a, parser, "viewportHeight", 8, pathRenderer.mViewportHeight);
        pathRenderer.mViewportHeight = namedFloat;
        if (pathRenderer.mViewportWidth <= 0.0f) {
            ...
            float dimension = a.getDimension(2, pathRenderer.mBaseHeight);
            pathRenderer.mBaseHeight = dimension;
    ...
    private void inflateInternal(Resources res, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) {
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public VectorDrawableCompatState(VectorDrawableCompatState copy) {
            ...
            if (copy != null) {
                ...
                VPathRenderer vPathRenderer = new VPathRenderer(copy.mVPathRenderer);
                this.mVPathRenderer = vPathRenderer;
                if (copy.mVPathRenderer.mFillPaint != null) {
                    vPathRenderer.mFillPaint = new Paint(copy.mVPathRenderer.mFillPaint);
                }
    ...
    public static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int w, int h, ColorFilter filter) {
            ...
            if (matrixScale != 0.0f) {
                ...
                float f2 = fullPath.mTrimPathStart;
                if (f2 == 0.0f && fullPath.mTrimPathEnd == 1.0f) {
                    float f3 = scaleX;
                } else {
                    float f4 = fullPath.mTrimPathOffset;
                    float start = (f2 + f4) % 1.0f;
                    float end = (fullPath.mTrimPathEnd + f4) % 1.0f;
                ...
                if (fullPath.mStrokeColor.willDraw()) {
                    ...
                    Paint.Join join = fullPath.mStrokeLineJoin;
                    if (join != null) {
                        strokePaint.setStrokeJoin(join);
                    }
                    Paint.Cap cap = fullPath.mStrokeLineCap;
                    if (cap != null) {
