...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(@androidx.annotation.NonNull android.content.Intent r19) {
        /*
            ...
            monitor-enter(r3)
            java.lang.String r5 = r19.getAction()     // Catch:{ all -> 0x0171 }
            android.content.Context r0 = r1.mAppContext     // Catch:{ all -> 0x0171 }
            android.content.ContentResolver r0 = r0.getContentResolver()     // Catch:{ all -> 0x0171 }
            java.lang.String r0 = r2.resolveTypeIfNeeded(r0)     // Catch:{ all -> 0x0171 }
            android.net.Uri r8 = r19.getData()     // Catch:{ all -> 0x0171 }
            java.lang.String r4 = r19.getScheme()     // Catch:{ all -> 0x0171 }
            r11 = r4
            java.util.Set r9 = r19.getCategories()     // Catch:{ all -> 0x0171 }
            int r4 = r19.getFlags()     // Catch:{ all -> 0x0171 }
            r4 = r4 & 8
        ...
        L_0x002e:
            ...
            r6.append(r0)     // Catch:{ all -> 0x0171 }
            java.lang.String r7 = " scheme "
            r6.append(r7)     // Catch:{ all -> 0x0171 }
            r6.append(r11)     // Catch:{ all -> 0x0171 }
            java.lang.String r7 = " of intent "
            r6.append(r7)     // Catch:{ all -> 0x0171 }
            r6.append(r2)     // Catch:{ all -> 0x0171 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0171 }
            android.util.Log.v(r4, r6)     // Catch:{ all -> 0x0171 }
        L_0x0057:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r4 = r1.mActions     // Catch:{ all -> 0x0171 }
            java.lang.String r6 = r19.getAction()     // Catch:{ all -> 0x0171 }
            java.lang.Object r4 = r4.get(r6)     // Catch:{ all -> 0x0171 }
            java.util.ArrayList r4 = (java.util.ArrayList) r4     // Catch:{ all -> 0x0171 }
            r15 = r4
            ...
            r6.append(r7)     // Catch:{ all -> 0x0171 }
            r6.append(r15)     // Catch:{ all -> 0x0171 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0171 }
            android.util.Log.v(r4, r6)     // Catch:{ all -> 0x0171 }
        L_0x007e:
            r4 = 0
            ...
            r7 = r6
        L_0x0082:
            int r4 = r15.size()     // Catch:{ all -> 0x0171 }
            if (r7 >= r4) goto L_0x0137
            java.lang.Object r4 = r15.get(r7)     // Catch:{ all -> 0x0171 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r4 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x0171 }
            r6 = r4
            ...
            android.content.IntentFilter r13 = r6.filter     // Catch:{ all -> 0x0171 }
            r12.append(r13)     // Catch:{ all -> 0x0171 }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x0171 }
            android.util.Log.v(r4, r12)     // Catch:{ all -> 0x0171 }
        L_0x00a9:
            boolean r4 = r6.broadcasting     // Catch:{ all -> 0x0171 }
        ...
        L_0x00bd:
            ...
            goto L_0x0130
        L_0x00c4:
            android.content.IntentFilter r4 = r6.filter     // Catch:{ all -> 0x0171 }
            ...
            r0 = r10
            r10 = r12
            int r4 = r4.match(r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x0171 }
            ...
            r7.append(r10)     // Catch:{ all -> 0x0171 }
            java.lang.String r10 = java.lang.Integer.toHexString(r4)     // Catch:{ all -> 0x0171 }
            r7.append(r10)     // Catch:{ all -> 0x0171 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0171 }
            android.util.Log.v(r6, r7)     // Catch:{ all -> 0x0171 }
        L_0x00f3:
            if (r0 != 0) goto L_0x00fc
            java.util.ArrayList r6 = new java.util.ArrayList     // Catch:{ all -> 0x0171 }
            r6.<init>()     // Catch:{ all -> 0x0171 }
            r10 = r6
            goto L_0x00fd
        L_0x00fc:
            r10 = r0
        L_0x00fd:
            r10.add(r13)     // Catch:{ all -> 0x0171 }
            r0 = 1
            r13.broadcasting = r0     // Catch:{ all -> 0x0171 }
            goto L_0x0131
        L_0x0104:
        ...
        L_0x011a:
            ...
            r10.append(r12)     // Catch:{ all -> 0x0171 }
            r10.append(r6)     // Catch:{ all -> 0x0171 }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x0171 }
            android.util.Log.v(r7, r10)     // Catch:{ all -> 0x0171 }
        L_0x0130:
            r10 = r0
        L_0x0131:
            int r7 = r16 + 1
        ...
        L_0x0137:
            ...
            r4 = 0
        L_0x013f:
            int r6 = r0.size()     // Catch:{ all -> 0x0171 }
            if (r4 >= r6) goto L_0x0151
            java.lang.Object r6 = r0.get(r4)     // Catch:{ all -> 0x0171 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r6 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r6     // Catch:{ all -> 0x0171 }
            r7 = 0
            r6.broadcasting = r7     // Catch:{ all -> 0x0171 }
            int r4 = r4 + 1
            goto L_0x013f
        L_0x0151:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r4 = r1.mPendingBroadcasts     // Catch:{ all -> 0x0171 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r6 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x0171 }
            r6.<init>(r2, r0)     // Catch:{ all -> 0x0171 }
            r4.add(r6)     // Catch:{ all -> 0x0171 }
            android.os.Handler r4 = r1.mHandler     // Catch:{ all -> 0x0171 }
            r6 = 1
            boolean r4 = r4.hasMessages(r6)     // Catch:{ all -> 0x0171 }
            if (r4 != 0) goto L_0x0169
            android.os.Handler r4 = r1.mHandler     // Catch:{ all -> 0x0171 }
            r4.sendEmptyMessage(r6)     // Catch:{ all -> 0x0171 }
        L_0x0169:
