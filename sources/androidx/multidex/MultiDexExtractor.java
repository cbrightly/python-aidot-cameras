...
public final class MultiDexExtractor implements Closeable {
    ...
    MultiDexExtractor(File sourceApk2, File dexDir2) {
    ...
    public List<? extends File> load(Context context, String prefsKeyPrefix, boolean forceReload) {
    ...
    private static void extract(ZipFile apk, ZipEntry dexFile, File extractTo, String extractedFilePrefix) {
        ...
        try {
            ...
            ZipEntry classesDex = new ZipEntry(Constants.CLASSES_DEX_NAME);
