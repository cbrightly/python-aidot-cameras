...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                if (!swipeRefreshLayout.mUsingCustomStart) {
                    endTarget = swipeRefreshLayout.mSpinnerOffsetEnd - Math.abs(swipeRefreshLayout.mOriginalOffsetTop);
                } else {
                    endTarget = swipeRefreshLayout.mSpinnerOffsetEnd;
                }
                SwipeRefreshLayout swipeRefreshLayout2 = SwipeRefreshLayout.this;
                int i = swipeRefreshLayout2.mFrom;
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((i + ((int) (((float) (endTarget - i)) * interpolatedTime))) - swipeRefreshLayout2.mCircleView.getTop());
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        this.mProgress.setProgressRotation((((0.4f * adjustedPercent) - 16.0f) + (2.0f * tensionPercent)) * 0.5f);
