...
public class PreferenceCategory extends PreferenceGroup {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        if (i >= 28) {
            ...
            if (getContext().getTheme().resolveAttribute(R.attr.colorAccent, value, true) && (titleView = (TextView) holder.findViewById(16908310)) != null && titleView.getCurrentTextColor() == ContextCompat.getColor(getContext(), R.color.preference_fallback_accent_color)) {
