...
public abstract class PreferenceFragmentCompat extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getActivity().getTheme().resolveAttribute(R.attr.preferenceTheme, tv2, true);
        int theme = tv2.resourceId;
        if (theme == 0) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        TypedArray a = getContext().obtainStyledAttributes((AttributeSet) null, R.styleable.PreferenceFragmentCompat, R.attr.preferenceFragmentCompatStyle, 0);
    ...
    public void setPreferencesFromResource(@androidx.annotation.XmlRes int r6, @androidx.annotation.Nullable java.lang.String r7) {
        /*
            r5 = this;
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        fragmentManager.beginTransaction().replace(((View) getView().getParent()).getId(), fragment).addToBackStack((String) null).commit();
        return true;
    }
    ...
    public RecyclerView onCreateRecyclerView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        if (getContext().getPackageManager().hasSystemFeature("android.hardware.type.automotive") && (recyclerView = (RecyclerView) parent.findViewById(R.id.recycler_view)) != null) {
            return recyclerView;
        }
