    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            ...
            if (!isInEditMode()) {
                ...
                heightSize2 = IjkMediaCodecInfo.RANK_SECURE;
            }
        }
        int layoutHeight = 0;
            ...
            if (i < childCount3) {
                ...
                if (child.getVisibility() == 8) {
                    ...
                    if (i4 == -2) {
                        ...
                        childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(i4, 1073741824);
                    }
                    child.measure(childWidthSpec, childHeightSpec3);
                    int childWidth = child.getMeasuredWidth();
                    int i6 = childHeightSpec3;
                    int childHeightSpec4 = child.getMeasuredHeight();
                    float weightSum2 = weightSum;
                    if (heightMode2 == Integer.MIN_VALUE && childHeightSpec4 > layoutHeight) {
                        layoutHeight = Math.min(childHeightSpec4, maxLayoutHeight2);
                    }
                                ...
                                if (!canSlide || child2 == this.mSlideableView) {
                                    ...
                                    if (lp2.weight > 0.0f) {
                                        if (lp2.width == 0) {
                                            ...
                                            if (i9 == -2) {
                                                ...
                                                childHeightSpec = View.MeasureSpec.makeMeasureSpec(i9, 1073741824);
                                            }
                                        } else {
                                    ...
                                    if (skippedFirstPass) {
                                        ...
                                        if (i10 == -2) {
                                            ...
                                            childCount2 = 1073741824;
                                        } else if (i10 == -1) {
                                            childCount2 = 1073741824;
                                            childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, 1073741824);
                                        } else {
                                            childCount2 = 1073741824;
                                            childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(i10, 1073741824);
                                        }
                                    } else {
                                        childCount = childCount3;
                                        childCount2 = 1073741824;
                                    ...
                                    child2.measure(View.MeasureSpec.makeMeasureSpec(fixedPanelWidthLimit2, childCount2), childHeightSpec2);
                                    fixedPanelWidthLimit = fixedPanelWidthLimit2;
                                    maxLayoutHeight = maxLayoutHeight2;
                                } else {
                                    childCount = childCount3;
        ...
        while (i2 < childCount) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.slideable) {
                    ...
                    this.mSlideOffset = ((float) pos) / ((float) range);
                } else {
                    paddingStart = paddingStart2;
