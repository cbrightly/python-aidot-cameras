...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String clientPackageName, int clientUid, Bundle rootHints) {
            ...
            mediaBrowserServiceCompat.mCurConnection = new ConnectionRecord(clientPackageName, -1, clientUid, rootHints, (ServiceCallbacks) null);
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        if (onGetRoot == null) {
                            ...
                            try {
                                mediaBrowserServiceCompat2.mConnections.put(b, connectionRecord);
    ...
    public static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        public void onLoadChildren(String mediaId, List<MediaBrowserCompat.MediaItem> list, Bundle options, Bundle notifyChildrenChangedOptions) {
            Bundle data = new Bundle();
