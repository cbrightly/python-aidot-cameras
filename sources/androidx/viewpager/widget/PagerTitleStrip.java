...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        textView.layout(currLeft, stripHeight, currRight, stripHeight + textView.getMeasuredHeight());
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (View.MeasureSpec.getMode(widthMeasureSpec) == 1073741824) {
            ...
            int childHeightSpec = ViewGroup.getChildMeasureSpec(heightMeasureSpec, heightPadding, -2);
            int widthSize = View.MeasureSpec.getSize(widthMeasureSpec);
            int childWidthSpec = ViewGroup.getChildMeasureSpec(widthMeasureSpec, (int) (((float) widthSize) * 0.2f), -2);
            this.mPrevText.measure(childWidthSpec, childHeightSpec);
            this.mCurrText.measure(childWidthSpec, childHeightSpec);
            this.mNextText.measure(childWidthSpec, childHeightSpec);
    ...
    public class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
        ...
        public void onPageSelected(int position) {
            if (this.mScrollState == 0) {
                ...
                float offset = pagerTitleStrip2.mLastKnownPositionOffset;
                if (offset < 0.0f) {
                    offset = 0.0f;
                }
