...
public final class SavedStateViewModelFactory extends ViewModelProvider.OnRequeryFactory implements ViewModelProvider.Factory {
    ...
    public SavedStateViewModelFactory(@Nullable Application application2, @NotNull SavedStateRegistryOwner owner) {
        this(application2, owner, (Bundle) null);
        k.e(owner, "owner");
    }

    @SuppressLint({"LambdaLast"})
    public SavedStateViewModelFactory(@Nullable Application application2, @NotNull SavedStateRegistryOwner owner, @Nullable Bundle defaultArgs2) {
