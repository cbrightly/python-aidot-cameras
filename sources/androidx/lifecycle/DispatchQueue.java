...
public final class DispatchQueue {
    ...
    @AnyThread
    public final void dispatchAndEnqueue(@NotNull g context, @NotNull Runnable runnable) {
        k.e(context, "context");
        k.e(runnable, "runnable");
        k2 $this$dispatchAndEnqueue_u24lambda_u2d2 = d1.c().W();
        if ($this$dispatchAndEnqueue_u24lambda_u2d2.isDispatchNeeded(context) || canRun()) {
            $this$dispatchAndEnqueue_u24lambda_u2d2.dispatch(context, new a(this, runnable));
        } else {
            enqueue(runnable);
        }
    }
    ...
    public static final void m0dispatchAndEnqueue$lambda2$lambda1(DispatchQueue this$0, Runnable $runnable) {
        k.e(this$0, "this$0");
        k.e($runnable, "$runnable");
