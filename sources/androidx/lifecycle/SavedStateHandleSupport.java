...
public final class SavedStateHandleSupport {
    ...
    public static final <T extends SavedStateRegistryOwner & ViewModelStoreOwner> void enableSavedStateHandles(@NotNull T $this$enableSavedStateHandles) {
        k.e($this$enableSavedStateHandles, "<this>");
    ...
    public static final SavedStateHandle createSavedStateHandle(@NotNull CreationExtras $this$createSavedStateHandle) {
        k.e($this$createSavedStateHandle, "<this>");
    ...
    public static final SavedStateHandlesVM getSavedStateHandlesVM(@NotNull ViewModelStoreOwner $this$savedStateHandlesVM) {
        ...
        k.e($this$savedStateHandlesVM, "<this>");
        InitializerViewModelFactoryBuilder $this$_get_savedStateHandlesVM__u24lambda_u2d1 = new InitializerViewModelFactoryBuilder();
        $this$_get_savedStateHandlesVM__u24lambda_u2d1.addInitializer(a0.b(cls), SavedStateHandleSupport$savedStateHandlesVM$1$1.INSTANCE);
        return (SavedStateHandlesVM) new ViewModelProvider($this$savedStateHandlesVM, $this$_get_savedStateHandlesVM__u24lambda_u2d1.build()).get(VIEWMODEL_KEY, cls);
    }
    ...
    public static final SavedStateHandlesProvider getSavedStateHandlesProvider(@NotNull SavedStateRegistryOwner $this$savedStateHandlesProvider) {
        k.e($this$savedStateHandlesProvider, "<this>");
