...
public final class InitializerViewModelFactory implements ViewModelProvider.Factory {
    ...
    public InitializerViewModelFactory(@NotNull ViewModelInitializer<?>... initializers2) {
        k.e(initializers2, "initializers");
    ...
    public <T extends ViewModel> T create(@NotNull Class<T> modelClass, @NotNull CreationExtras extras) {
        ...
        for (ViewModelInitializer it : this.initializers) {
            if (k.a(it.getClazz$lifecycle_viewmodel_release(), modelClass)) {
