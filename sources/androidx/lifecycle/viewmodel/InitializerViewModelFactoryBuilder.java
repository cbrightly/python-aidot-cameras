...
public final class InitializerViewModelFactoryBuilder {
    ...
    public final <T extends ViewModel> void addInitializer(@NotNull c<T> clazz, @NotNull kotlin.jvm.functions.l<? super CreationExtras, ? extends T> initializer) {
        k.e(clazz, "clazz");
        k.e(initializer, "initializer");
        this.initializers.add(new ViewModelInitializer(a.b(clazz), initializer));
    }
