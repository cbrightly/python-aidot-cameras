...
public final class LinkifyCompat {
    ...
    public static boolean addLinks(@NonNull Spannable text, int mask) {
        ...
        if ((mask & 1) != 0) {
            gatherLinks(links, text, PatternsCompat.AUTOLINK_WEB_URL, new String[]{NetworkManager.MOCK_SCHEME_HTTP, NetworkManager.MOCK_SCHEME_HTTPS, "rtsp://"}, Linkify.sUrlMatchFilter, (Linkify.TransformFilter) null);
        }
        if ((mask & 2) != 0) {
    ...
    private static void pruneOverlaps(ArrayList<LinkSpec> links, Spannable text) {
        ...
        int i3 = 0;
        while (i3 < len - 1) {
            LinkSpec a = links.get(i3);
            LinkSpec b = links.get(i3 + 1);
            int remove = -1;
            int i4 = a.start;
            int i5 = b.start;
            if (i4 <= i5 && (i = a.end) > i5) {
