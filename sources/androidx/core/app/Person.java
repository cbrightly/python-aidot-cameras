...
public class Person {
    ...
    public static Person fromBundle(@NonNull Bundle bundle) {
        ...
        return new Builder().setName(bundle.getCharSequence("name")).setIcon(iconBundle != null ? IconCompat.createFromBundle(iconBundle) : null).setUri(bundle.getString(URI_KEY)).setKey(bundle.getString("key")).setBot(bundle.getBoolean(IS_BOT_KEY)).setImportant(bundle.getBoolean(IS_IMPORTANT_KEY)).build();
    }
    ...
    public static Person fromPersistableBundle(@NonNull PersistableBundle bundle) {
        return new Builder().setName(bundle.getString("name")).setUri(bundle.getString(URI_KEY)).setKey(bundle.getString("key")).setBot(bundle.getBoolean(IS_BOT_KEY)).setImportant(bundle.getBoolean(IS_IMPORTANT_KEY)).build();
    }
