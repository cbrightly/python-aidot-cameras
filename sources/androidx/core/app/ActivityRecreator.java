...
public final class ActivityRecreator {
                    ...
                    mainHandler.postAtFrontOfQueue(new Runnable() {
                        public void run() {
                            try {
                                ...
                                if (method != null) {
                                    method.invoke(activityThread, new Object[]{token, false, "AppCompat recreation"});
                                    return;
                                }
    ...
    private static Method getRequestRelaunchActivityMethod(Class<?> activityThreadClass2) {
        ...
        try {
            ...
            Method relaunch = activityThreadClass2.getDeclaredMethod("requestRelaunchActivity", new Class[]{IBinder.class, List.class, List.class, Integer.TYPE, cls, Configuration.class, Configuration.class, cls, cls});
