...
public class FontProvider {
    ...
    @NonNull
    static FontsContractCompat.FontFamilyResult getFontFamilyResult(@NonNull Context context, @NonNull FontRequest request, @Nullable CancellationSignal cancellationSignal) {
    ...
    @VisibleForTesting
    @Nullable
    static ProviderInfo getProvider(@NonNull PackageManager packageManager, @NonNull FontRequest request, @Nullable Resources resources) {
        ...
        try {
            ...
            if (cursor2 != null && cursor2.getCount() > 0) {
                ...
                while (cursor2.moveToNext()) {
                    ...
                    int weight2 = weightColumnIndex != -1 ? cursor2.getInt(weightColumnIndex) : BaseResp.ERR_MSG_SEND_FAIL;
