...
public final class EditorInfoCompat {
    ...
    public static String[] getContentMimeTypes(EditorInfo editorInfo) {
        ...
        String[] result2 = bundle.getStringArray(CONTENT_MIME_TYPES_KEY);
        if (result2 == null) {
    ...
    private static void trimLongSurroundingText(EditorInfo editorInfo, CharSequence subText, int selStart, int selEnd) {
        ...
        int newAfterCursorLength = Math.min(subText.length() - i, maxLengthMinusSelection - Math.min(subTextBeforeCursorLength, (int) (((double) maxLengthMinusSelection) * 0.8d)));
    ...
    public static CharSequence getInitialTextBeforeCursor(@NonNull EditorInfo editorInfo, int length, int flags) {
        ...
        Bundle bundle = editorInfo.extras;
        if (bundle == null || (surroundingText = bundle.getCharSequence(CONTENT_SURROUNDING_TEXT_KEY)) == null) {
            return null;
        }
    ...
    public static CharSequence getInitialSelectedText(@NonNull EditorInfo editorInfo, int flags) {
        ...
        int correctedTextSelEnd = editorInfo.initialSelStart;
        ...
        int selectionHead = bundle.getInt(CONTENT_SELECTION_HEAD_KEY);
    ...
    static int getProtocol(EditorInfo editorInfo) {
        ...
        boolean hasNewKey = bundle.containsKey(CONTENT_MIME_TYPES_KEY);
