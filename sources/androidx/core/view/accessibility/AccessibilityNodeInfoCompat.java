...
public class AccessibilityNodeInfoCompat {
        ...
        public boolean perform(View view, Bundle arguments) {
            ...
            if (cls != null) {
                try {
                    ...
                    String className = cls2 == null ? BuildConfig.TRAVIS : cls2.getName();
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        TouchDelegateInfoCompat(@NonNull AccessibilityNodeInfo.TouchDelegateInfo info) {
            this.mInfo = info;
        }
        ...
        if (i >= 19 && i < 26) {
            ...
            if (spans != null && spans.length > 0) {
                ...
                for (int i2 = 0; i2 < spans.length; i2++) {
                    int id = idForClickableSpan(spans[i2], tagSpans);
                    tagSpans.put(id, new WeakReference(spans[i2]));
                    addSpanLocationToExtras(spans[i2], (Spanned) text, id);
                }
            }
        }
    }
