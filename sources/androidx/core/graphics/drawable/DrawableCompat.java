...
public final class DrawableCompat {
    ...
    public static void inflate(@NonNull Drawable drawable, @NonNull Resources res, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Resources.Theme theme) {
        if (Build.VERSION.SDK_INT >= 21) {
