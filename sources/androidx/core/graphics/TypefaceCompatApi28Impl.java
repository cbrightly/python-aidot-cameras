...
public class TypefaceCompatApi28Impl extends TypefaceCompatApi26Impl {
    ...
    public Method obtainCreateFromFamiliesWithDefaultMethod(Class<?> fontFamily) {
        ...
        Method m = Typeface.class.getDeclaredMethod(CREATE_FROM_FAMILIES_WITH_DEFAULT_METHOD, new Class[]{Array.newInstance(fontFamily, 1).getClass(), String.class, cls, cls});
