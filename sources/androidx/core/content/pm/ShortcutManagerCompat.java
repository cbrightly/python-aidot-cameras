...
public class ShortcutManagerCompat {
    ...
    static boolean convertUriIconToBitmapIcon(@NonNull Context context, @NonNull ShortcutInfoCompat info) {
        ...
        int type = iconCompat2.mType;
        if (type != 6 && type != 4) {
            return true;
        }
        InputStream is = iconCompat2.getUriInputStream(context);
    ...
    /*  JADX ERROR: StackOverflow in pass: MarkFinallyVisitor
        ...
        */
    public static boolean pushDynamicShortcut(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.NonNull androidx.core.content.pm.ShortcutInfoCompat r8) {
        /*
        ...
        L_0x003f:
            ...
            java.lang.String r6 = androidx.core.content.pm.ShortcutManagerCompat.Api25Impl.getShortcutInfoWithLowestRank(r3)
            r5[r1] = r6
        ...
        L_0x0067:
            ...
            java.util.List r3 = r2.getShortcuts()     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
            int r5 = r3.size()     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
            if (r5 < r0) goto L_0x0084
            java.lang.String[] r5 = new java.lang.String[r4]     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
            java.lang.String r6 = getShortcutInfoCompatWithLowestRank(r3)     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
            r5[r1] = r6     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
            java.util.List r5 = java.util.Arrays.asList(r5)     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
            r2.removeShortcuts(r5)     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
        L_0x0084:
            androidx.core.content.pm.ShortcutInfoCompat[] r5 = new androidx.core.content.pm.ShortcutInfoCompat[r4]     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
            r5[r1] = r8     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
            java.util.List r5 = java.util.Arrays.asList(r5)     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
            r2.addShortcuts(r5)     // Catch:{ Exception -> 0x00d9, all -> 0x00b4 }
