...
public final class PackageInfoCompat {
    ...
    @NonNull
    public static List<Signature> getSignatures(@NonNull PackageManager packageManager, @NonNull String packageName) {
        Signature[] array;
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    public static boolean hasSignatures(@androidx.annotation.NonNull android.content.pm.PackageManager r10, @androidx.annotation.NonNull java.lang.String r11, @androidx.annotation.Size(min = 1) @androidx.annotation.NonNull java.util.Map<byte[], java.lang.Integer> r12, boolean r13) {
        /*
