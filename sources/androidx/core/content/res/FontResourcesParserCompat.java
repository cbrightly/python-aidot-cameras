...
public class FontResourcesParserCompat {
    ...
    public static final class ProviderResourceEntry implements FamilyResourceEntry {
        ...
        public ProviderResourceEntry(@NonNull FontRequest request, int strategy, int timeoutMs, @Nullable String systemFontFamilyName) {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) {
        ...
        int weightAttr = R.styleable.FontFamilyFont_fontWeight;
        ...
        int styleAttr = R.styleable.FontFamilyFont_fontStyle;
        ...
        int i = R.styleable.FontFamilyFont_ttcIndex;
        if (!array.hasValue(i)) {
            i = R.styleable.FontFamilyFont_android_ttcIndex;
        }
        int ttcIndexAttr = i;
        int variationSettingsAttr = R.styleable.FontFamilyFont_fontVariationSettings;
        ...
        int i2 = R.styleable.FontFamilyFont_font;
