...
public final class ResourcesCompat {
    ...
    public static void getFont(@NonNull Context context, @FontRes int id, @NonNull FontCallback fontCallback, @Nullable Handler handler) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.graphics.Typeface loadFont(@androidx.annotation.NonNull android.content.Context r19, android.content.res.Resources r20, android.util.TypedValue r21, int r22, int r23, @androidx.annotation.Nullable androidx.core.content.res.ResourcesCompat.FontCallback r24, @androidx.annotation.Nullable android.os.Handler r25, boolean r26, boolean r27) {
        /*
            r9 = r20
            r10 = r21
            r11 = r22
        ...
        L_0x0034:
            ...
            return r16
        L_0x0037:
            java.lang.String r0 = r8.toLowerCase()     // Catch:{ XmlPullParserException -> 0x00d5, IOException -> 0x00ba }
            java.lang.String r1 = ".xml"
            boolean r0 = r0.endsWith(r1)     // Catch:{ XmlPullParserException -> 0x00d5, IOException -> 0x00ba }
            if (r0 == 0) goto L_0x0096
            android.content.res.XmlResourceParser r0 = r9.getXml(r11)     // Catch:{ XmlPullParserException -> 0x008f, IOException -> 0x0088 }
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = androidx.core.content.res.FontResourcesParserCompat.parse(r0, r9)     // Catch:{ XmlPullParserException -> 0x008f, IOException -> 0x0088 }
            r17 = r1
            if (r17 != 0) goto L_0x0067
            java.lang.String r1 = "Failed to find font-family tag"
            android.util.Log.e(r15, r1)     // Catch:{ XmlPullParserException -> 0x0061, IOException -> 0x005b }
            if (r13 == 0) goto L_0x005a
            r13.callbackFailAsync(r7, r14)     // Catch:{ XmlPullParserException -> 0x0061, IOException -> 0x005b }
        L_0x005a:
            return r16
        L_0x005b:
            r0 = move-exception
        ...
        L_0x0067:
            ...
            r10 = r8
            r8 = r26
            android.graphics.Typeface r1 = androidx.core.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch:{ XmlPullParserException -> 0x0084, IOException -> 0x0080 }
            return r1
        L_0x0080:
            r0 = move-exception
            r1 = r19
        ...
        L_0x0096:
            ...
            r10 = r8
            r1 = r19
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFontFile(r1, r9, r11, r10, r12)     // Catch:{ XmlPullParserException -> 0x00b6, IOException -> 0x00b2 }
            r6 = r0
            if (r13 == 0) goto L_0x00b1
            if (r6 == 0) goto L_0x00a8
            r13.callbackSuccessAsync(r6, r14)     // Catch:{ XmlPullParserException -> 0x00af, IOException -> 0x00ad }
            goto L_0x00b1
        L_0x00a8:
            r2 = -3
            r13.callbackFailAsync(r2, r14)     // Catch:{ XmlPullParserException -> 0x00af, IOException -> 0x00ad }
            goto L_0x00b1
        L_0x00ad:
            r0 = move-exception
            goto L_0x00c0
