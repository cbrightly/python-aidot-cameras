...
public final class MimeTypeFilter {
    ...
    private static boolean mimeTypeAgainstFilter(@NonNull String[] mimeTypeParts, @NonNull String[] filterParts) {
        if (filterParts.length != 2) {
            ...
            if (e.ANY_MARKER.equals(filterParts[0]) || filterParts[0].equals(mimeTypeParts[0])) {
                return e.ANY_MARKER.equals(filterParts[1]) || filterParts[1].equals(mimeTypeParts[1]);
            }
            return false;
        }
    }
