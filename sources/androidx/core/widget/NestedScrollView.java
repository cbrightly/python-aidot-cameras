...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent event) {
        ...
        int i = NeedPermissionEvent.PER_IPC_ALBUM_PERM;
        if (!canScroll) {
            ...
            View nextFocused = FocusFinder.getInstance().findNextFocus(this, currentFocused, NeedPermissionEvent.PER_IPC_ALBUM_PERM);
            if (nextFocused == null || nextFocused == this || !nextFocused.requestFocus(NeedPermissionEvent.PER_IPC_ALBUM_PERM)) {
                return false;
            }
            return true;
            ...
            switch (event.getKeyCode()) {
                ...
                case 20:
                    if (!event.isAltPressed()) {
                        return arrowScroll(NeedPermissionEvent.PER_IPC_ALBUM_PERM);
                    }
                    return fullScroll(NeedPermissionEvent.PER_IPC_ALBUM_PERM);
                case 62:
    ...
    public boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
        View nextFocus;
        if (direction == 2) {
            direction = NeedPermissionEvent.PER_IPC_ALBUM_PERM;
        } else if (direction == 1) {
            direction = 33;
        }
