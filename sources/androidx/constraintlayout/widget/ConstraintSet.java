...
public class ConstraintSet {
            ...
            if (from.mDelta != null) {
                if (from.mTargetString != null) {
                    for (Integer intValue : this.mConstraints.keySet()) {
                        ...
                        String str = potential.layout.mConstraintTag;
                        if (str != null && from.mTargetString.matches(str)) {
    ...
    public static class Constraint {
        ...
        public void fillFrom(int viewId, ConstraintLayout.LayoutParams param) {
            ...
            layout2.baselineToTop = param.baselineToTop;
            layout2.baselineToBottom = param.baselineToBottom;
            ...
            layout3.guideBegin = param.guideBegin;
            layout3.guideEnd = param.guideEnd;
            layout3.mWidth = param.width;
            layout3.mHeight = param.height;
            layout3.leftMargin = param.leftMargin;
            layout3.rightMargin = param.rightMargin;
            layout3.topMargin = param.topMargin;
            layout3.bottomMargin = param.bottomMargin;
            layout3.baselineMargin = param.baselineMargin;
            layout3.verticalWeight = param.verticalWeight;
            layout3.horizontalWeight = param.horizontalWeight;
            layout3.verticalChainStyle = param.verticalChainStyle;
            layout3.horizontalChainStyle = param.horizontalChainStyle;
            layout3.constrainedWidth = param.constrainedWidth;
            layout3.constrainedHeight = param.constrainedHeight;
            layout3.widthDefault = param.matchConstraintDefaultWidth;
            layout3.heightDefault = param.matchConstraintDefaultHeight;
            layout3.widthMax = param.matchConstraintMaxWidth;
            layout3.heightMax = param.matchConstraintMaxHeight;
            layout3.widthMin = param.matchConstraintMinWidth;
            layout3.heightMin = param.matchConstraintMinHeight;
            layout3.widthPercent = param.matchConstraintPercentWidth;
            layout3.heightPercent = param.matchConstraintPercentHeight;
            layout3.mConstraintTag = param.constraintTag;
            layout3.goneTopMargin = param.goneTopMargin;
            Layout layout4 = this.layout;
            layout4.goneBottomMargin = param.goneBottomMargin;
            layout4.goneLeftMargin = param.goneLeftMargin;
            layout4.goneRightMargin = param.goneRightMargin;
            layout4.goneStartMargin = param.goneStartMargin;
            layout4.goneEndMargin = param.goneEndMargin;
            layout4.goneBaselineMargin = param.goneBaselineMargin;
            layout4.mWrapBehavior = param.wrapBehaviorInParent;
            if (Build.VERSION.SDK_INT >= 17) {
                layout4.endMargin = param.getMarginEnd();
        ...
        public void applyTo(ConstraintLayout.LayoutParams param) {
            ...
            param.baselineToTop = layout2.baselineToTop;
            param.baselineToBottom = layout2.baselineToBottom;
            ...
            Layout layout3 = this.layout;
            param.circleConstraint = layout3.circleConstraint;
            param.circleRadius = layout3.circleRadius;
            param.circleAngle = layout3.circleAngle;
            param.dimensionRatio = layout3.dimensionRatio;
            param.editorAbsoluteX = layout3.editorAbsoluteX;
            param.editorAbsoluteY = layout3.editorAbsoluteY;
            param.verticalWeight = layout3.verticalWeight;
            param.horizontalWeight = layout3.horizontalWeight;
            param.verticalChainStyle = layout3.verticalChainStyle;
            param.horizontalChainStyle = layout3.horizontalChainStyle;
            param.constrainedWidth = layout3.constrainedWidth;
            param.constrainedHeight = layout3.constrainedHeight;
            param.matchConstraintDefaultWidth = layout3.widthDefault;
            param.matchConstraintDefaultHeight = layout3.heightDefault;
            param.matchConstraintMaxWidth = layout3.widthMax;
            param.matchConstraintMaxHeight = layout3.heightMax;
            param.matchConstraintMinWidth = layout3.widthMin;
            param.matchConstraintMinHeight = layout3.heightMin;
            param.matchConstraintPercentWidth = layout3.widthPercent;
            param.matchConstraintPercentHeight = layout3.heightPercent;
            param.orientation = layout3.orientation;
            param.guidePercent = layout3.guidePercent;
            param.guideBegin = layout3.guideBegin;
            param.guideEnd = layout3.guideEnd;
            param.width = layout3.mWidth;
            Layout layout4 = this.layout;
            param.height = layout4.mHeight;
            String str = layout4.mConstraintTag;
            if (str != null) {
                param.constraintTag = str;
            }
            param.wrapBehaviorInParent = layout4.mWrapBehavior;
            if (Build.VERSION.SDK_INT >= 17) {
                param.setMarginStart(layout4.startMargin);
    ...
    public void applyToInternal(ConstraintLayout constraintLayout, boolean applyPostLayout) {
                    ...
                    if (constraint != null) {
                        ...
                        if (i2 >= 17) {
                            ...
                            if (i2 >= 21) {
                                ...
                                Transform transform2 = constraint.transform;
                                if (transform2.applyElevation) {
                                    view.setElevation(transform2.elevation);
                                }
                            }
                        }
                    }
        ...
        while (it.hasNext()) {
            ...
            if (constraint2 != null) {
                if (constraint2.layout.mHelperType == 1) {
                    ...
                    constraintLayout2.addView(barrier2, param2);
                }
        ...
        for (int i3 = 0; i3 < count; i3++) {
            View view2 = constraintLayout2.getChildAt(i3);
            if (view2 instanceof ConstraintHelper) {
                ((ConstraintHelper) view2).applyLayoutFeaturesInConstraintSet(constraintLayout2);
            }
        }
    }
    ...
    public void load(android.content.Context r11, org.xmlpull.v1.XmlPullParser r12) {
        /*
            ...
            r0 = 0
            r1 = 0
            int r2 = r12.getEventType()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
        L_0x0006:
            r3 = 1
            ...
            }     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
        L_0x0010:
            goto L_0x01cf
        L_0x0012:
            java.lang.String r8 = r12.getName()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r0 = r8
            java.util.Locale r8 = java.util.Locale.ROOT     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            java.lang.String r8 = r0.toLowerCase(r8)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            int r9 = r8.hashCode()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            switch(r9) {
        ...
        L_0x0025:
            ...
            boolean r3 = r8.equals(r3)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
        ...
        L_0x0039:
            ...
            boolean r4 = r8.equals(r4)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
        ...
        L_0x0050:
            goto L_0x005f
        L_0x0051:
            java.util.HashMap<java.lang.Integer, androidx.constraintlayout.widget.ConstraintSet$Constraint> r3 = r10.mConstraints     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            int r4 = r1.mViewId     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            java.lang.Integer r4 = java.lang.Integer.valueOf(r4)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r3.put(r4, r1)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r1 = 0
            goto L_0x005f
        L_0x005e:
            return
        ...
        L_0x0062:
            java.lang.String r8 = r12.getName()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r0 = r8
            int r8 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            switch(r8) {
        ...
        L_0x0070:
            java.lang.String r4 = "Constraint"
            boolean r4 = r0.equals(r4)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
        ...
        L_0x0086:
            ...
            boolean r5 = r0.equals(r5)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
        ...
        L_0x00de:
            ...
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r3 = r1.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r11, r12, r3)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            goto L_0x01c9
        L_0x00e7:
            java.lang.RuntimeException r3 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r4.append(r5)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            int r5 = r12.getLineNumber()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r4.append(r5)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            java.lang.String r4 = r4.toString()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r3.<init>(r4)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            throw r3     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
        L_0x0100:
            if (r1 == 0) goto L_0x010d
            androidx.constraintlayout.widget.ConstraintSet$Motion r3 = r1.motion     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r3.fillFromAttributeList(r11, r4)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            goto L_0x01c9
        L_0x010d:
            java.lang.RuntimeException r3 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
        ...
        L_0x0126:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Layout r3 = r1.layout     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r3.fillFromAttributeList(r11, r4)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            goto L_0x01c9
        L_0x0133:
        ...
        L_0x014c:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Transform r3 = r1.transform     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r3.fillFromAttributeList(r11, r4)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            goto L_0x01c9
        L_0x0159:
        ...
        L_0x0172:
            ...
            androidx.constraintlayout.widget.ConstraintSet$PropertySet r3 = r1.propertySet     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r3.fillFromAttributeList(r11, r4)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            goto L_0x01c9
        L_0x017e:
        ...
        L_0x0197:
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r4 = r10.fillFromAttributeList(r11, r4, r7)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r1 = r4
            androidx.constraintlayout.widget.ConstraintSet$Layout r4 = r1.layout     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r4.mHelperType = r3     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            goto L_0x01c9
        L_0x01a5:
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r4 = r10.fillFromAttributeList(r11, r4, r7)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r1 = r4
            androidx.constraintlayout.widget.ConstraintSet$Layout r4 = r1.layout     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r4.mIsGuideline = r3     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r4.mApply = r3     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            goto L_0x01c9
        L_0x01b5:
            android.util.AttributeSet r4 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r3 = r10.fillFromAttributeList(r11, r4, r3)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r1 = r3
            goto L_0x01c9
        L_0x01bf:
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r12)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r3 = r10.fillFromAttributeList(r11, r3, r7)     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r1 = r3
        L_0x01c9:
            goto L_0x01cf
        L_0x01ca:
            java.lang.String r3 = r12.getName()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
        L_0x01cf:
            int r3 = r12.next()     // Catch:{ XmlPullParserException -> 0x01dc, IOException -> 0x01d7 }
            r2 = r3
            goto L_0x0006
        L_0x01d6:
            goto L_0x01e0
        ...
        for (int i = 0; i < N; i++) {
            ...
            switch (overrideMapToConstant.get(attr)) {
                ...
                case 37:
                    ...
                    break;
                case 38:
                    int resourceId = typedArray.getResourceId(attr, constraint.mViewId);
                ...
                case 85:
                    ...
                    break;
                case 86:
                    int i2 = typedArray.peekValue(attr).type;
                    if (i2 != 1) {
                        if (i2 != 3) {
                            Motion motion = constraint.motion;
                            motion.mQuantizeInterpolatorType = typedArray.getInteger(attr, motion.mQuantizeInterpolatorID);
                ...
                case 98:
                    if (!MotionLayout.IS_IN_EDIT_MODE) {
                        ...
                        int resourceId2 = typedArray.getResourceId(attr, constraint.mViewId);
    ...
    private void populateConstraint(Context ctx, Constraint c, TypedArray a, boolean override) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            switch (mapToConstant.get(attr)) {
                case 1:
                    Layout layout = constraint.layout;
                    layout.baselineToBaseline = lookupID(typedArray, attr, layout.baselineToBaseline);
                    break;
                case 2:
                    Layout layout2 = constraint.layout;
                    layout2.bottomMargin = typedArray.getDimensionPixelSize(attr, layout2.bottomMargin);
                    break;
                case 3:
                    Layout layout3 = constraint.layout;
                    layout3.bottomToBottom = lookupID(typedArray, attr, layout3.bottomToBottom);
                    break;
                case 4:
                    Layout layout4 = constraint.layout;
                    layout4.bottomToTop = lookupID(typedArray, attr, layout4.bottomToTop);
                    break;
                case 5:
                ...
                case 6:
                    Layout layout5 = constraint.layout;
                    layout5.editorAbsoluteX = typedArray.getDimensionPixelOffset(attr, layout5.editorAbsoluteX);
                    break;
                case 7:
                    Layout layout6 = constraint.layout;
                    layout6.editorAbsoluteY = typedArray.getDimensionPixelOffset(attr, layout6.editorAbsoluteY);
                    break;
                case 8:
                    if (Build.VERSION.SDK_INT < 17) {
                        break;
                        ...
                        Layout layout7 = constraint.layout;
                        layout7.endMargin = typedArray.getDimensionPixelSize(attr, layout7.endMargin);
                        break;
                    }
                case 9:
                    Layout layout8 = constraint.layout;
                    layout8.endToEnd = lookupID(typedArray, attr, layout8.endToEnd);
                    break;
                case 10:
                    Layout layout9 = constraint.layout;
                    layout9.endToStart = lookupID(typedArray, attr, layout9.endToStart);
                    break;
                case 11:
                    Layout layout10 = constraint.layout;
                    layout10.goneBottomMargin = typedArray.getDimensionPixelSize(attr, layout10.goneBottomMargin);
                    break;
                case 12:
                    Layout layout11 = constraint.layout;
                    layout11.goneEndMargin = typedArray.getDimensionPixelSize(attr, layout11.goneEndMargin);
                    break;
                case 13:
                    Layout layout12 = constraint.layout;
                    layout12.goneLeftMargin = typedArray.getDimensionPixelSize(attr, layout12.goneLeftMargin);
                    break;
                case 14:
                    Layout layout13 = constraint.layout;
                    layout13.goneRightMargin = typedArray.getDimensionPixelSize(attr, layout13.goneRightMargin);
                    break;
                case 15:
                    Layout layout14 = constraint.layout;
                    layout14.goneStartMargin = typedArray.getDimensionPixelSize(attr, layout14.goneStartMargin);
                    break;
                case 16:
                    Layout layout15 = constraint.layout;
                    layout15.goneTopMargin = typedArray.getDimensionPixelSize(attr, layout15.goneTopMargin);
                    break;
                case 17:
                    Layout layout16 = constraint.layout;
                    layout16.guideBegin = typedArray.getDimensionPixelOffset(attr, layout16.guideBegin);
                    break;
                case 18:
                    Layout layout17 = constraint.layout;
                    layout17.guideEnd = typedArray.getDimensionPixelOffset(attr, layout17.guideEnd);
                    break;
                case 19:
                    Layout layout18 = constraint.layout;
                    layout18.guidePercent = typedArray.getFloat(attr, layout18.guidePercent);
                    break;
                case 20:
                    Layout layout19 = constraint.layout;
                    layout19.horizontalBias = typedArray.getFloat(attr, layout19.horizontalBias);
                    break;
                case 21:
                    Layout layout20 = constraint.layout;
                    layout20.mHeight = typedArray.getLayoutDimension(attr, layout20.mHeight);
                    break;
                case 22:
                    PropertySet propertySet = constraint.propertySet;
                    propertySet.visibility = typedArray.getInt(attr, propertySet.visibility);
                ...
                case 23:
                    ...
                    layout21.mWidth = typedArray.getLayoutDimension(attr, layout21.mWidth);
                    break;
                case 24:
                    Layout layout22 = constraint.layout;
                    layout22.leftMargin = typedArray.getDimensionPixelSize(attr, layout22.leftMargin);
                    break;
                case 25:
                    Layout layout23 = constraint.layout;
                    layout23.leftToLeft = lookupID(typedArray, attr, layout23.leftToLeft);
                    break;
                case 26:
                    Layout layout24 = constraint.layout;
                    layout24.leftToRight = lookupID(typedArray, attr, layout24.leftToRight);
                    break;
                case 27:
                    Layout layout25 = constraint.layout;
                    layout25.orientation = typedArray.getInt(attr, layout25.orientation);
                    break;
                case 28:
                    Layout layout26 = constraint.layout;
                    layout26.rightMargin = typedArray.getDimensionPixelSize(attr, layout26.rightMargin);
                    break;
                case 29:
                    Layout layout27 = constraint.layout;
                    layout27.rightToLeft = lookupID(typedArray, attr, layout27.rightToLeft);
                    break;
                case 30:
                    Layout layout28 = constraint.layout;
                    layout28.rightToRight = lookupID(typedArray, attr, layout28.rightToRight);
                    break;
                case 31:
                    if (Build.VERSION.SDK_INT < 17) {
                        break;
                        ...
                        layout29.startMargin = typedArray.getDimensionPixelSize(attr, layout29.startMargin);
                        break;
                    }
                case 32:
                    Layout layout30 = constraint.layout;
                    layout30.startToEnd = lookupID(typedArray, attr, layout30.startToEnd);
                    break;
                case 33:
                    Layout layout31 = constraint.layout;
                    layout31.startToStart = lookupID(typedArray, attr, layout31.startToStart);
                    break;
                case 34:
                    Layout layout32 = constraint.layout;
                    layout32.topMargin = typedArray.getDimensionPixelSize(attr, layout32.topMargin);
                    break;
                case 35:
                    Layout layout33 = constraint.layout;
                    layout33.topToBottom = lookupID(typedArray, attr, layout33.topToBottom);
                    break;
                case 36:
                    Layout layout34 = constraint.layout;
                    layout34.topToTop = lookupID(typedArray, attr, layout34.topToTop);
                    break;
                case 37:
                    Layout layout35 = constraint.layout;
                    layout35.verticalBias = typedArray.getFloat(attr, layout35.verticalBias);
                    break;
                case 38:
                    constraint.mViewId = typedArray.getResourceId(attr, constraint.mViewId);
                    break;
                case 39:
                    ...
                    layout36.horizontalWeight = typedArray.getFloat(attr, layout36.horizontalWeight);
                    break;
                case 40:
                    Layout layout37 = constraint.layout;
                    layout37.verticalWeight = typedArray.getFloat(attr, layout37.verticalWeight);
                    break;
                case 41:
                    Layout layout38 = constraint.layout;
                    layout38.horizontalChainStyle = typedArray.getInt(attr, layout38.horizontalChainStyle);
                    break;
                case 42:
                    Layout layout39 = constraint.layout;
                    layout39.verticalChainStyle = typedArray.getInt(attr, layout39.verticalChainStyle);
                    break;
                case 43:
                    PropertySet propertySet3 = constraint.propertySet;
                    propertySet3.alpha = typedArray.getFloat(attr, propertySet3.alpha);
                    break;
                case 44:
                    if (Build.VERSION.SDK_INT < 21) {
                        break;
                        ...
                        Transform transform = constraint.transform;
                        transform.applyElevation = true;
                        transform.elevation = typedArray.getDimension(attr, transform.elevation);
                        break;
                    }
                case 45:
                    Transform transform2 = constraint.transform;
                    transform2.rotationX = typedArray.getFloat(attr, transform2.rotationX);
                    break;
                case 46:
                    Transform transform3 = constraint.transform;
                    transform3.rotationY = typedArray.getFloat(attr, transform3.rotationY);
                    break;
                case 47:
                    Transform transform4 = constraint.transform;
                    transform4.scaleX = typedArray.getFloat(attr, transform4.scaleX);
                    break;
                case 48:
                    Transform transform5 = constraint.transform;
                    transform5.scaleY = typedArray.getFloat(attr, transform5.scaleY);
                    break;
                case 49:
                    Transform transform6 = constraint.transform;
                    transform6.transformPivotX = typedArray.getDimension(attr, transform6.transformPivotX);
                    break;
                case 50:
                    Transform transform7 = constraint.transform;
                    transform7.transformPivotY = typedArray.getDimension(attr, transform7.transformPivotY);
                    break;
                case 51:
                    Transform transform8 = constraint.transform;
                    transform8.translationX = typedArray.getDimension(attr, transform8.translationX);
                    break;
                case 52:
                    Transform transform9 = constraint.transform;
                    transform9.translationY = typedArray.getDimension(attr, transform9.translationY);
                    break;
                case 53:
                    if (Build.VERSION.SDK_INT < 21) {
                        break;
                        ...
                        transform10.translationZ = typedArray.getDimension(attr, transform10.translationZ);
                        break;
                    }
                case 54:
                    Layout layout40 = constraint.layout;
                    layout40.widthDefault = typedArray.getInt(attr, layout40.widthDefault);
                    break;
                case 55:
                    Layout layout41 = constraint.layout;
                    layout41.heightDefault = typedArray.getInt(attr, layout41.heightDefault);
                    break;
                case 56:
                    Layout layout42 = constraint.layout;
                    layout42.widthMax = typedArray.getDimensionPixelSize(attr, layout42.widthMax);
                    break;
                case 57:
                    Layout layout43 = constraint.layout;
                    layout43.heightMax = typedArray.getDimensionPixelSize(attr, layout43.heightMax);
                    break;
                case 58:
                    Layout layout44 = constraint.layout;
                    layout44.widthMin = typedArray.getDimensionPixelSize(attr, layout44.widthMin);
                    break;
                case 59:
                    Layout layout45 = constraint.layout;
                    layout45.heightMin = typedArray.getDimensionPixelSize(attr, layout45.heightMin);
                    break;
                case 60:
                    Transform transform11 = constraint.transform;
                    transform11.rotation = typedArray.getFloat(attr, transform11.rotation);
                    break;
                case 61:
                    Layout layout46 = constraint.layout;
                    layout46.circleConstraint = lookupID(typedArray, attr, layout46.circleConstraint);
                    break;
                case 62:
                    Layout layout47 = constraint.layout;
                    layout47.circleRadius = typedArray.getDimensionPixelSize(attr, layout47.circleRadius);
                    break;
                case 63:
                    Layout layout48 = constraint.layout;
                    layout48.circleAngle = typedArray.getFloat(attr, layout48.circleAngle);
                    break;
                case 64:
                    Motion motion = constraint.motion;
                    motion.mAnimateRelativeTo = lookupID(typedArray, attr, motion.mAnimateRelativeTo);
                    break;
                case 65:
                    if (typedArray.peekValue(attr).type != 3) {
                ...
                case 67:
                    Motion motion2 = constraint.motion;
                    motion2.mPathRotate = typedArray.getFloat(attr, motion2.mPathRotate);
                    break;
                case 68:
                    PropertySet propertySet4 = constraint.propertySet;
                    propertySet4.mProgress = typedArray.getFloat(attr, propertySet4.mProgress);
                    break;
                case 69:
                ...
                case 72:
                    ...
                    layout49.mBarrierDirection = typedArray.getInt(attr, layout49.mBarrierDirection);
                    break;
                case 73:
                    Layout layout50 = constraint.layout;
                    layout50.mBarrierMargin = typedArray.getDimensionPixelSize(attr, layout50.mBarrierMargin);
                    break;
                case 74:
                ...
                case 75:
                    ...
                    layout51.mBarrierAllowsGoneWidgets = typedArray.getBoolean(attr, layout51.mBarrierAllowsGoneWidgets);
                    break;
                case 76:
                    Motion motion3 = constraint.motion;
                    motion3.mPathMotionArc = typedArray.getInt(attr, motion3.mPathMotionArc);
                    break;
                case 77:
                ...
                case 78:
                    ...
                    propertySet5.mVisibilityMode = typedArray.getInt(attr, propertySet5.mVisibilityMode);
                    break;
                case 79:
                    Motion motion4 = constraint.motion;
                    motion4.mMotionStagger = typedArray.getFloat(attr, motion4.mMotionStagger);
                    break;
                case 80:
                    Layout layout52 = constraint.layout;
                    layout52.constrainedWidth = typedArray.getBoolean(attr, layout52.constrainedWidth);
                    break;
                case 81:
                    Layout layout53 = constraint.layout;
                    layout53.constrainedHeight = typedArray.getBoolean(attr, layout53.constrainedHeight);
                    break;
                case 82:
                    Motion motion5 = constraint.motion;
                    motion5.mAnimateCircleAngleTo = typedArray.getInteger(attr, motion5.mAnimateCircleAngleTo);
                    break;
                case 83:
                    Transform transform12 = constraint.transform;
                    transform12.transformPivotTarget = lookupID(typedArray, attr, transform12.transformPivotTarget);
                    break;
                case 84:
                    Motion motion6 = constraint.motion;
                    motion6.mQuantizeMotionSteps = typedArray.getInteger(attr, motion6.mQuantizeMotionSteps);
                    break;
                case 85:
                    Motion motion7 = constraint.motion;
                    motion7.mQuantizeMotionPhase = typedArray.getFloat(attr, motion7.mQuantizeMotionPhase);
                    break;
                case 86:
                    int i2 = typedArray.peekValue(attr).type;
                    if (i2 != 1) {
                        if (i2 != 3) {
                            ...
                            motion8.mQuantizeInterpolatorType = typedArray.getInteger(attr, motion8.mQuantizeInterpolatorID);
                            break;
                        } else {
                            constraint.motion.mQuantizeInterpolatorString = typedArray.getString(attr);
                            if (constraint.motion.mQuantizeInterpolatorString.indexOf("/") <= 0) {
                ...
                case 91:
                    ...
                    layout54.baselineToTop = lookupID(typedArray, attr, layout54.baselineToTop);
                    break;
                case 92:
                    Layout layout55 = constraint.layout;
                    layout55.baselineToBottom = lookupID(typedArray, attr, layout55.baselineToBottom);
                    break;
                case 93:
                    Layout layout56 = constraint.layout;
                    layout56.baselineMargin = typedArray.getDimensionPixelSize(attr, layout56.baselineMargin);
                    break;
                case 94:
                    Layout layout57 = constraint.layout;
                    layout57.goneBaselineMargin = typedArray.getDimensionPixelSize(attr, layout57.goneBaselineMargin);
                    break;
                case 95:
                ...
                case 97:
                    ...
                    layout58.mWrapBehavior = typedArray.getInt(attr, layout58.mWrapBehavior);
                    break;
                default:
                    Log.w(TAG, "Unknown attribute 0x" + Integer.toHexString(attr) + "   " + mapToConstant.get(attr));
                    break;
    ...
    public class WriteXmlEngine {
        ...
        WriteXmlEngine(Writer writer2, ConstraintLayout layout2, int flags2) {
            this.writer = writer2;
            this.layout = layout2;
        ...
        private void writeBoolen(String dimString, boolean val, boolean def) {
            if (val != def) {
                Writer writer2 = this.writer;
        ...
        private void writeEnum(String dimString, int val, String[] types, int def) {
            if (val != def) {
                Writer writer2 = this.writer;
        ...
        private void writeDimension(String dimString, int dim, int def) {
            if (dim != def) {
                Writer writer2 = this.writer;
        ...
        private void writeBaseDimension(String dimString, int dim, int def) {
            if (dim == def) {
                return;
            }
            if (dim == -2) {
        ...
        /* access modifiers changed from: package-private */
        public void writeXmlConstraint(String str, int leftToLeft) {
            if (leftToLeft != -1) {
                Writer writer2 = this.writer;
        ...
        /* access modifiers changed from: package-private */
        public void writeConstraint(String my, int leftToLeft, String other, int margin, int goneMargin) {
            if (leftToLeft != -1) {
                Writer writer2 = this.writer;
        ...
        /* access modifiers changed from: package-private */
        public void writeCircle(int circleConstraint, float circleAngle, int circleRadius) {
        ...
        /* access modifiers changed from: package-private */
        public void writeVariable(String name, float value, float def) {
            if (value != def) {
                Writer writer2 = this.writer;
        ...
        /* access modifiers changed from: package-private */
        public void writeVariable(String name, String value, String def) {
        ...
        public void writeVariable(String name, int[] value) {
            if (value != null) {
                ...
                while (i < value.length) {
                    Writer writer3 = this.writer;
                    StringBuilder sb = new StringBuilder();
                    sb.append(i == 0 ? Constants.ARRAY_TYPE : ", ");
    ...
    public class WriteJsonEngine {
        ...
        WriteJsonEngine(Writer writer2, ConstraintLayout layout2, int flags2) {
            this.writer = writer2;
            this.layout = layout2;
            this.context = layout2.getContext();
            this.flags = flags2;
        ...
        private void writeDimension(String dimString, int dim, int dimDefault, float dimPercent, int dimMin, int dimMax, boolean constrainedDim) {
            if (dim == 0) {
        ...
        /* access modifiers changed from: package-private */
        public void writeVariable(String name, float value) {
            if (value != -1.0f) {
                Writer writer2 = this.writer;
                writer2.write(SPACE + name);
                Writer writer3 = this.writer;
        ...
        /* access modifiers changed from: package-private */
        public void writeVariable(String name, boolean value, boolean def) {
            if (value != def) {
                Writer writer2 = this.writer;
                writer2.write(SPACE + name);
                Writer writer3 = this.writer;
