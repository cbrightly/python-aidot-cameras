...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:122:0x01e6  */
        ...
        /* JADX WARNING: Removed duplicated region for block: B:134:0x0204 A[RETURN] */
        /* JADX WARNING: Removed duplicated region for block: B:135:0x0205  */
        ...
        public final void measure(androidx.constraintlayout.core.widgets.ConstraintWidget r29, androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.Measure r30) {
            ...
            L_0x004a:
                goto L_0x00c1
            L_0x004c:
                int r14 = r0.layoutWidthSpec
                int r8 = android.view.ViewGroup.getChildMeasureSpec(r14, r11, r5)
            ...
            L_0x0074:
                int r15 = r2.measureStrategy
                r17 = r8
                int r8 = androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.Measure.USE_GIVEN_DIMENSIONS
                if (r15 == r8) goto L_0x008f
                if (r14 == 0) goto L_0x008f
                if (r14 == 0) goto L_0x0082
                if (r5 != 0) goto L_0x008f
            L_0x0082:
                boolean r8 = r12 instanceof androidx.constraintlayout.widget.Placeholder
                if (r8 != 0) goto L_0x008f
                boolean r8 = r29.isResolvedHorizontally()
            ...
            L_0x00a5:
                ...
                int r14 = r29.getHorizontalMargin()
                int r14 = r14 + r11
                r15 = -1
            ...
            L_0x02cb:
                r27 = r3
            L_0x02cd:
                if (r7 != r9) goto L_0x02da
                if (r10 == r11) goto L_0x02d2
                goto L_0x02da
            L_0x02d2:
                r0 = r9
                r8 = r21
    ...
    private void setWidgetBaseline(ConstraintWidget widget, LayoutParams layoutParams, SparseArray<ConstraintWidget> idToWidget, int baselineTarget, ConstraintAnchor.Type type) {
        ...
        if (target != null && view != null && (view.getLayoutParams() instanceof LayoutParams)) {
            ...
            widget.getAnchor(type2).connect(target.getAnchor(type), layoutParams.baselineMargin, layoutParams.goneBaselineMargin, true);
    ...
    public void resolveMeasuredDimension(int widthMeasureSpec, int heightMeasureSpec, int measuredWidth, int measuredHeight, boolean isWidthMeasuredTooSmall, boolean isHeightMeasuredTooSmall) {
        ...
        int heightPadding = measurer.paddingHeight;
        int resolvedWidthSize = ViewGroup.resolveSizeAndState(measuredWidth + measurer.paddingWidth, widthMeasureSpec, 0);
        int resolvedHeightSize = ViewGroup.resolveSizeAndState(measuredHeight + heightPadding, heightMeasureSpec, 0 << 16);
    ...
    public void setSelfDimensionBehaviour(ConstraintWidgetContainer layout, int widthMode, int widthSize, int heightMode, int heightSize) {
        Measurer measurer = this.mMeasurer;
        int heightPadding = measurer.paddingHeight;
        int widthPadding = measurer.paddingWidth;
