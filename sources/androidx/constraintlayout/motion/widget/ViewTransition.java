...
public class ViewTransition {
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, View... views) {
        ...
        if (!this.mDisabled) {
            ...
            MotionScene.Transition tmpTransition = new MotionScene.Transition(-1, motionLayout.mScene, i6, i);
    ...
    /* renamed from: lambda$applyTransition$0 */
    public /* synthetic */ void a(View[] views) {
        if (this.mSetsTag != -1) {
            for (View view : views) {
