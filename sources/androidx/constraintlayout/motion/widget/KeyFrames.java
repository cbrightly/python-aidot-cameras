                ...
                switch (eventType) {
                    ...
                    case 2:
                        ...
                        if (!sKeyMakers.containsKey(tagName)) {
                            if (!tagName.equalsIgnoreCase("CustomAttribute")) {
                                if (!(!tagName.equalsIgnoreCase("CustomMethod") || key == null || (hashMap = key.mCustomConstraints) == null)) {
                                    ConstraintAttribute.parse(context, parser, hashMap);
                                    break;
                                }
                            } else if (!(key == null || (hashMap2 = key.mCustomConstraints) == null)) {
