...
public class DesignTool implements ProxyInterface {
    ...
    public void getAnimationRectangles(Object view, float[] path) {
        ...
        if (motionScene != null) {
            int frames = motionScene.getDuration() / 16;
    ...
    public void setState(String id) {
        ...
        if (this.mLastStartState != id) {
            ...
            int rscId = motionLayout.lookUpConstraintId(id);
    ...
    public void setTransition(String start, String end) {
        ...
        int startId = motionLayout.lookUpConstraintId(start);
    ...
    public void setKeyFrame(Object view, int position, String name, Object value) {
        ...
        if (motionScene != null) {
            ...
            MotionLayout motionLayout = this.mMotionLayout;
            motionLayout.mTransitionGoalPosition = ((float) position) / 100.0f;
    ...
    public boolean setKeyFramePosition(Object view, int position, int type, float x, float y) {
        ...
        if (motionLayout.mScene != null) {
            ...
            int position2 = (int) (motionLayout2.mTransitionPosition * 100.0f);
            if (motionController != null && motionLayout2.mScene.hasKeyFramePosition((View) view, position2)) {
    ...
    public Object getKeyframe(Object view, int type, int position) {
        ...
        MotionLayout motionLayout = this.mMotionLayout;
        return motionLayout.mScene.getKeyFrame(motionLayout.getContext(), type, target, position);
    }
    ...
    public void dumpConstraintSet(String set) {
        ...
        int setId = motionLayout.lookUpConstraintId(set);
