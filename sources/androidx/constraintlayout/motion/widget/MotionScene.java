...
public class MotionScene {
    ...
    /* access modifiers changed from: private */
    public int mDefaultDuration = BaseResp.ERR_MSG_SEND_FAIL;
    ...
    public static class Transition {
        ...
        /* access modifiers changed from: private */
        public int mDuration = BaseResp.ERR_MSG_SEND_FAIL;
        /* access modifiers changed from: private */
        public int mId = -1;
        /* access modifiers changed from: private */
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public boolean isTransitionViable(Transition current, MotionLayout tl) {
                ...
                if (from != -1) {
                    int i = tl.mCurrentState;
                    if (i == from || i == dest) {
                        return true;
                    }
                    return false;
                } else if (tl.mCurrentState != dest) {
                    return true;
                } else {
                    return false;
                }
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray a) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == R.styleable.Transition_constraintSetEnd) {
                    ...
                    int i3 = a.getInt(attr, this.mDuration);
                    this.mDuration = i3;
                    if (i3 < 8) {
                        this.mDuration = 8;
                    }
    ...
    private int parseConstraintSet(android.content.Context r18, org.xmlpull.v1.XmlPullParser r19) {
        ...
        L_0x0074:
            ...
            r5 = 3
            switch(r15) {
                case -768416914: goto L_0x00ad;
                case 3317767: goto L_0x00a2;
                case 3387192: goto L_0x0097;
