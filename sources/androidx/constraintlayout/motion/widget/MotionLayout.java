...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void enableTransition(int transitionID, boolean enable) {
        ...
        if (t == motionScene.mCurrentTransition) {
    ...
    public void setState(TransitionState newState) {
        ...
        if (newState != transitionState || this.mCurrentState != -1) {
            ...
            if (oldState == transitionState2 && newState == transitionState2) {
    ...
    public static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f31me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f31me.tracker = VelocityTracker.obtain();
            return f31me;
        }
    ...
    public class DecelerateInterpolator extends MotionInterpolator {
        ...
        public float getInterpolation(float time) {
            ...
            if (pos > 0.0f) {
                ...
                return this.currentP + ((pos * time) - (((f * time) * time) / 2.0f));
            }
            float f2 = this.maxA;
            if ((-pos) / f2 < time) {
                time = (-pos) / f2;
            }
            MotionLayout.this.mLastVelocity = (f2 * time) + pos;
            return this.currentP + (pos * time) + (((f2 * time) * time) / 2.0f);
        }
    ...
    public class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                String str = cName + Constants.ARRAY_TYPE + i + "] ";
                ...
                Log.v(MotionLayout.TAG, str + JustifyTextView.TWO_CHINESE_BLANK + name + " " + child + " " + a4);
            }
        ...
        public void measure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int width = motionLayout3.mStartWrapWidth;
            int height = motionLayout3.mStartWrapHeight;
            int i = motionLayout3.mWidthMeasureMode;
            if (i == Integer.MIN_VALUE || i == 0) {
                int i2 = motionLayout3.mStartWrapWidth;
                width = (int) (((float) i2) + (motionLayout3.mPostInterpolationPosition * ((float) (motionLayout3.mEndWrapWidth - i2))));
            }
            int i3 = motionLayout3.mHeightMeasureMode;
            if (i3 == Integer.MIN_VALUE || i3 == 0) {
                int i4 = motionLayout3.mStartWrapHeight;
                height = (int) (((float) i4) + (motionLayout3.mPostInterpolationPosition * ((float) (motionLayout3.mEndWrapHeight - i4))));
            }
        ...
        private void computeStartEndSize(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (motionLayout.mCurrentState == motionLayout.getStartState()) {
                ...
                motionLayout2.resolveSystem(constraintWidgetContainer, optimisationLevel, (constraintSet == null || constraintSet.mRotate == 0) ? widthMeasureSpec : heightMeasureSpec, (constraintSet == null || constraintSet.mRotate == 0) ? heightMeasureSpec : widthMeasureSpec);
                ConstraintSet constraintSet2 = this.mStart;
                if (constraintSet2 != null) {
                    MotionLayout motionLayout3 = MotionLayout.this;
                    ConstraintWidgetContainer constraintWidgetContainer2 = this.mLayoutStart;
                    int i = constraintSet2.mRotate;
                    motionLayout3.resolveSystem(constraintWidgetContainer2, optimisationLevel, i == 0 ? widthMeasureSpec : heightMeasureSpec, i == 0 ? heightMeasureSpec : widthMeasureSpec);
                    return;
                }
                return;
            }
            ...
            if (constraintSet3 != null) {
                ...
                int i2 = constraintSet3.mRotate;
                motionLayout4.resolveSystem(constraintWidgetContainer3, optimisationLevel, i2 == 0 ? widthMeasureSpec : heightMeasureSpec, i2 == 0 ? heightMeasureSpec : widthMeasureSpec);
            }
            MotionLayout motionLayout5 = MotionLayout.this;
            ConstraintWidgetContainer constraintWidgetContainer4 = this.mLayoutEnd;
            ConstraintSet constraintSet4 = this.mEnd;
            motionLayout5.resolveSystem(constraintWidgetContainer4, optimisationLevel, (constraintSet4 == null || constraintSet4.mRotate == 0) ? widthMeasureSpec : heightMeasureSpec, (constraintSet4 == null || constraintSet4.mRotate == 0) ? heightMeasureSpec : widthMeasureSpec);
        }
            ...
            while (i2 < n) {
                ...
                if (motionController2 == null) {
                    ...
                    if (this.mStart != null) {
                        ...
                        int access$2100 = motionLayout.mPreRotateWidth;
    ...
    public void requestLayout() {
        ...
        if (!this.mMeasureDuringTransition && this.mCurrentState == -1 && (motionScene = this.mScene) != null && (transition = motionScene.mCurrentTransition) != null) {
            int mode = transition.getLayoutDuringTransition();
            if (mode != 0) {
                if (mode == 2) {
                    int n = getChildCount();
                    for (int i = 0; i < n; i++) {
    ...
    public void updateStateAnimate(int stateId, ConstraintSet set, int duration) {
        if (this.mScene != null && this.mCurrentState == stateId) {
            ...
            MotionScene.Transition tmpTransition = new MotionScene.Transition(-1, this.mScene, i, stateId);
