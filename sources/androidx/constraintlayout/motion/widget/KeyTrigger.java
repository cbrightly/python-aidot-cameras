...
public class KeyTrigger extends Key {
    ...
    public void setValue(java.lang.String r2, java.lang.Object r3) {
        /*
            ...
            switch(r0) {
                ...
                case -966421266: goto L_0x0079;
                case -786670827: goto L_0x006e;
                case -648752941: goto L_0x0063;
                case -638126837: goto L_0x0059;
                case -76025313: goto L_0x004e;
                case -9754574: goto L_0x0042;
    ...
    public void conditionallyFire(float pos, View child) {
        ...
        View call = this.mTriggerReceiver == Key.UNSET ? child : ((MotionLayout) child.getParent()).findViewById(this.mTriggerReceiver);
        if (fireNegative) {
    ...
    private void fireCustom(String str, View view) {
        ...
        for (String name : this.mCustomConstraints.keySet()) {
            ...
            if ((callAll || lowerCase.matches(str)) && (custom = this.mCustomConstraints.get(name)) != null) {
                ...
                switch (mAttrMap.get(attr)) {
                    ...
                    case 7:
                        if (!MotionLayout.IS_IN_EDIT_MODE) {
                            ...
                            int resourceId = a.getResourceId(attr, c.mTargetId);
                    ...
                    case 8:
                        int integer = a.getInteger(attr, c.mFramePosition);
                        c.mFramePosition = integer;
                        float unused5 = c.mFireThreshold = (((float) integer) + 0.5f) / 100.0f;
                        break;
                    case 9:
