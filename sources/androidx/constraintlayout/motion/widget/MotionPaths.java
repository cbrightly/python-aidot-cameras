...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void getCenter(double p, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        ...
        if (motionController != null) {
            ...
            float angle2 = angle;
            float angle3 = dangle;
            float v_x2 = (float) ((((double) rx) + (((double) v_y2) * Math.sin((double) angle2))) - ((double) (v_width / 2.0f)));
        ...
        while (true) {
            ...
            if (i2 < dArr2.length) {
                ...
                if (motionController != null) {
                    ...
                    float f7 = rx;
                    float angle2 = angle;
                    float angle3 = path_rotate;
                    float pos_x = (float) ((d4 + (((double) radius) * Math.sin((double) angle2))) - ((double) (v_width3 / 2.0f)));
                    float pos_y = (float) ((((double) ry) - (((double) radius) * Math.cos((double) angle2))) - ((double) (v_height2 / 2.0f)));
                    float dradius2 = dradius;
                    float[] fArr2 = vel;
                    float f8 = v_y5;
                    v_height = v_height2;
                    float dangle3 = dangle2;
                    dangle = v_width3;
                    float dpos_x = (float) (((double) v_y5) + (((double) dradius2) * Math.sin((double) angle2)) + (((double) radius) * Math.cos((double) angle2) * ((double) dangle3)));
                    float f9 = dradius2;
                    float dv_width2 = dv_width;
                    float dpos_y = (float) ((((double) dry) - (((double) dradius2) * Math.cos((double) angle2))) + (((double) radius) * Math.sin((double) angle2) * ((double) dangle3)));
                    float dv_x2 = dpos_x;
                    float dv_y2 = dpos_y;
                    v_x = pos_x;
                    float v_y6 = pos_y;
                    ...
                    if (!Float.isNaN(angle3)) {
                        float f10 = radius;
                        float path_rotate2 = angle3;
                        float path_rotate3 = angle2;
                        float f11 = ry;
                        float f12 = dpos_x;
                        float f13 = dpos_y;
                        view2 = view;
                        view2.setRotation((float) (((double) path_rotate2) + Math.toDegrees(Math.atan2((double) dv_y2, (double) dv_x2))));
                    } else {
                        float f14 = ry;
                        float f15 = dpos_x;
                        float f16 = dpos_y;
                    ...
                    if (!Float.isNaN(path_rotate)) {
                        float f19 = dv_width3;
                        view2.setRotation((float) (((double) 0.0f) + ((double) path_rotate) + Math.toDegrees(Math.atan2((double) (dv_y3 + (dv_height3 / 2.0f)), (double) (dv_x3 + (dv_width3 / 2.0f))))));
                    }
                    v_y = v_y7;
                    float f20 = dv_y3;
                    float f21 = dv_x3;
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                if (angle != 0.0f) {
                    ...
                    float f6 = v_y;
                    float v_x3 = angle;
                    float rotation = v_width;
                    float f7 = v_height;
                    float sin = (float) Math.sin(Math.toRadians((double) v_x3));
                    float cos = (float) Math.cos(Math.toRadians((double) v_x3));
                    float f8 = cx;
                    float f9 = cy;
                    float f10 = x1;
                    float f11 = y1;
