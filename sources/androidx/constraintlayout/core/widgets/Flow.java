...
public class Flow extends VirtualLayout {
    ...
    public void measure(int r24, int r25, int r26, int r27) {
        ...
        L_0x007a:
            ...
            int r1 = r1 - r19
            androidx.constraintlayout.core.widgets.ConstraintWidget[] r0 = new androidx.constraintlayout.core.widgets.ConstraintWidget[r1]
            r1 = 0
            r4 = 0
        L_0x0084:
    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (i3 != 0) {
            ...
            boolean needInternalMeasure = horizontalDimensionBehaviour == dimensionBehaviour || getVerticalDimensionBehaviour() == dimensionBehaviour;
