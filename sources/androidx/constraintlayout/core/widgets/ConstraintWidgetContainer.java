...
public class ConstraintWidgetContainer extends WidgetContainer {
        ...
        if (LinearSystem.USE_DEPENDENCY_ORDERING) {
            ...
            for (int i5 = 0; i5 < count; i5++) {
                ...
                if (widget6 instanceof ConstraintWidgetContainer) {
                    ConstraintWidget.DimensionBehaviour[] dimensionBehaviourArr = widget6.mListDimensionBehaviors;
    ...
    public static boolean measure(int level, ConstraintWidget widget, BasicMeasure.Measurer measurer, BasicMeasure.Measure measure, int measureStrategy) {
        ...
        boolean horizontalMatchConstraints = dimensionBehaviour == dimensionBehaviour2;
        boolean verticalMatchConstraints = measure.verticalBehavior == dimensionBehaviour2;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:138:0x02e6  */
    /* JADX WARNING: Removed duplicated region for block: B:140:0x02f5  */
    /* JADX WARNING: Removed duplicated region for block: B:152:0x0335  */
    /* JADX WARNING: Removed duplicated region for block: B:155:0x033b  */
    /* JADX WARNING: Removed duplicated region for block: B:175:0x033f A[SYNTHETIC] */
    ...
    public void layout() {
        ...
        L_0x0048:
            ...
            int r14 = r10.mMatchConstraintDefaultWidth
        ...
        L_0x009e:
            ...
            androidx.constraintlayout.core.widgets.analyzer.BasicMeasure$Measurer r10 = r23.getMeasurer()
        ...
        L_0x0122:
            ...
            r14 = 0
        L_0x0127:
            if (r14 >= r3) goto L_0x013f
            java.util.ArrayList<androidx.constraintlayout.core.widgets.ConstraintWidget> r15 = r1.mChildren
        ...
        L_0x014a:
            ...
            int r14 = r0 + 1
            androidx.constraintlayout.core.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x0200 }
            r0.reset()     // Catch:{ Exception -> 0x0200 }
            r23.resetChains()     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x0200 }
            r1.createObjectVariables(r0)     // Catch:{ Exception -> 0x0200 }
            r0 = 0
        L_0x015c:
            if (r0 >= r3) goto L_0x016f
            java.util.ArrayList<androidx.constraintlayout.core.widgets.ConstraintWidget> r15 = r1.mChildren     // Catch:{ Exception -> 0x0200 }
            java.lang.Object r15 = r15.get(r0)     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.widgets.ConstraintWidget r15 = (androidx.constraintlayout.core.widgets.ConstraintWidget) r15     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.LinearSystem r6 = r1.mSystem     // Catch:{ Exception -> 0x0200 }
            r15.createObjectVariables(r6)     // Catch:{ Exception -> 0x0200 }
            int r0 = r0 + 1
            r6 = 2
            goto L_0x015c
        L_0x016f:
            androidx.constraintlayout.core.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x0200 }
            boolean r0 = r1.addChildrenToSolver(r0)     // Catch:{ Exception -> 0x0200 }
            r11 = r0
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.verticalWrapMin     // Catch:{ Exception -> 0x0200 }
            if (r0 == 0) goto L_0x0196
            java.lang.Object r0 = r0.get()     // Catch:{ Exception -> 0x0200 }
            if (r0 == 0) goto L_0x0196
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.verticalWrapMin     // Catch:{ Exception -> 0x0200 }
            java.lang.Object r0 = r0.get()     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r0 = (androidx.constraintlayout.core.widgets.ConstraintAnchor) r0     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.LinearSystem r15 = r1.mSystem     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r6 = r1.mTop     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.SolverVariable r6 = r15.createObjectVariable(r6)     // Catch:{ Exception -> 0x0200 }
            r1.addMinWrap(r0, r6)     // Catch:{ Exception -> 0x0200 }
            r0 = 0
            r1.verticalWrapMin = r0     // Catch:{ Exception -> 0x0200 }
        L_0x0196:
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.verticalWrapMax     // Catch:{ Exception -> 0x0200 }
            ...
            androidx.constraintlayout.core.widgets.ConstraintAnchor r0 = (androidx.constraintlayout.core.widgets.ConstraintAnchor) r0     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.LinearSystem r6 = r1.mSystem     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r15 = r1.mBottom     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.SolverVariable r6 = r6.createObjectVariable(r15)     // Catch:{ Exception -> 0x0200 }
            r1.addMaxWrap(r0, r6)     // Catch:{ Exception -> 0x0200 }
            r0 = 0
            r1.verticalWrapMax = r0     // Catch:{ Exception -> 0x0200 }
        L_0x01b6:
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.horizontalWrapMin     // Catch:{ Exception -> 0x0200 }
            ...
            androidx.constraintlayout.core.widgets.ConstraintAnchor r0 = (androidx.constraintlayout.core.widgets.ConstraintAnchor) r0     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.LinearSystem r6 = r1.mSystem     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r15 = r1.mLeft     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.SolverVariable r6 = r6.createObjectVariable(r15)     // Catch:{ Exception -> 0x0200 }
            r1.addMinWrap(r0, r6)     // Catch:{ Exception -> 0x0200 }
            r0 = 0
            r1.horizontalWrapMin = r0     // Catch:{ Exception -> 0x0200 }
        L_0x01d6:
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.horizontalWrapMax     // Catch:{ Exception -> 0x0200 }
            ...
            androidx.constraintlayout.core.widgets.ConstraintAnchor r0 = (androidx.constraintlayout.core.widgets.ConstraintAnchor) r0     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.LinearSystem r6 = r1.mSystem     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r15 = r1.mRight     // Catch:{ Exception -> 0x0200 }
            androidx.constraintlayout.core.SolverVariable r6 = r6.createObjectVariable(r15)     // Catch:{ Exception -> 0x0200 }
            r1.addMaxWrap(r0, r6)     // Catch:{ Exception -> 0x0200 }
            r0 = 0
            r1.horizontalWrapMax = r0     // Catch:{ Exception -> 0x0200 }
        L_0x01f6:
            if (r11 == 0) goto L_0x01fd
            androidx.constraintlayout.core.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x0200 }
            r0.minimize()     // Catch:{ Exception -> 0x0200 }
        L_0x01fd:
            r19 = r10
            goto L_0x021c
        L_0x0200:
        ...
        L_0x027e:
            ...
            if (r5 != r10) goto L_0x02a2
            int r11 = r23.getWidth()
            if (r11 >= r0) goto L_0x02a2
            r1.setWidth(r0)
        ...
        L_0x02f3:
            ...
            if (r11 != r15) goto L_0x0316
            if (r4 <= 0) goto L_0x0316
            int r11 = r23.getWidth()
            if (r11 <= r4) goto L_0x0316
            r11 = 1
            r1.mWidthMeasuredTooSmall = r11
            r9 = 1
            androidx.constraintlayout.core.widgets.ConstraintWidget$DimensionBehaviour[] r11 = r1.mListDimensionBehaviors
            androidx.constraintlayout.core.widgets.ConstraintWidget$DimensionBehaviour r20 = androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.FIXED
            r17 = 0
            r11[r17] = r20
            r1.setWidth(r4)
            r0 = 1
