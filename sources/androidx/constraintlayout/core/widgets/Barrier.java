...
public class Barrier extends HelperWidget {
    ...
    public void addToSolver(LinearSystem system, boolean optimize) {
        ...
        if (i3 >= 0 && i3 < 4) {
            ConstraintAnchor position = constraintAnchorArr[i3];
            if (!this.resolved) {
                allSolved();
            }
            if (this.resolved) {
                ...
                for (int i8 = 0; i8 < this.mWidgetsCount; i8++) {
                    ...
                    if (this.mAllowsGoneWidget || widget2.allowedInBarrier()) {
                        ...
                        ConstraintAnchor[] constraintAnchorArr3 = widget2.mListAnchors;
                        int i9 = this.mBarrierType;
                        constraintAnchorArr3[i9].mSolverVariable = target;
                        int margin = 0;
                        if (constraintAnchorArr3[i9].mTarget != null && constraintAnchorArr3[i9].mTarget.mOwner == this) {
                            margin = 0 + constraintAnchorArr3[i9].mMargin;
                        }
                        if (i9 == 0 || i9 == 2) {
    ...
    public boolean allSolved() {
        ...
        while (true) {
            ...
            if (this.mAllowsGoneWidget || widget.allowedInBarrier()) {
                int i3 = this.mBarrierType;
                if ((i3 == 0 || i3 == 1) && !widget.isResolvedHorizontally()) {
                    hasAllWidgetsResolved = false;
                } else {
                    int i4 = this.mBarrierType;
                    if ((i4 == 2 || i4 == 3) && !widget.isResolvedVertically()) {
                        hasAllWidgetsResolved = false;
                    }
                }
            }
        ...
        for (int i5 = 0; i5 < this.mWidgetsCount; i5++) {
            ConstraintWidget widget2 = this.mWidgets[i5];
            if (this.mAllowsGoneWidget || widget2.allowedInBarrier()) {
                if (!initialized) {
                    int i6 = this.mBarrierType;
                    if (i6 == 0) {
