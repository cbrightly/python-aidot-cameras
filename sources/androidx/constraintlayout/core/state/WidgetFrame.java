...
public class WidgetFrame {
    ...
    public static void interpolate(int parentWidth, int parentHeight, WidgetFrame frame, WidgetFrame start, WidgetFrame end, Transition transition, float progress) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (firstPosition != null) {
                int i5 = frameNumber;
                startX4 = (int) (firstPosition.x * ((float) i));
                endX = endX3;
                startX2 = parentHeight;
                interpolateStartFrame2 = firstPosition.frame;
                startY3 = (int) (firstPosition.y * ((float) startX2));
            } else {
                startX2 = parentHeight;
                int i6 = frameNumber;
                endX = endX3;
            ...
            if (lastPosition != null) {
                ...
                endX2 = (int) (lastPosition.x * ((float) i));
                endY = (int) (lastPosition.y * ((float) startX2));
    ...
    public void addCustomColor(String name2, int color) {
        setCustomAttribute(name2, 902, color);
    }
    ...
    public boolean setValue(java.lang.String r4, androidx.constraintlayout.core.parser.CLElement r5) {
        /*
            r3 = this;
            int r0 = r4.hashCode()
            r1 = 1
    ...
    public void parseCustom(CLElement custom) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (vStr.matches("#[0-9a-fA-F]+")) {
                setCustomAttribute(k.content(), 902, Integer.parseInt(vStr.substring(1), 16));
