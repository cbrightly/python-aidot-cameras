        ...
        if (target != null) {
            ...
            switch (iArr[type.ordinal()]) {
                case 1:
                    ...
                    widget.getAnchor(type2).connect(target.getAnchor(type2), this.mMarginLeft, this.mMarginLeftGone, false);
                    return;
                case 2:
                ...
                case 4:
                    ...
                    widget.getAnchor(type3).connect(target.getAnchor(type3), this.mMarginRight, this.mMarginRightGone, false);
                    return;
                case 5:
                    ConstraintAnchor.Type type4 = ConstraintAnchor.Type.LEFT;
                    widget.getAnchor(type4).connect(target.getAnchor(type4), this.mMarginStart, this.mMarginStartGone, false);
                    return;
                case 6:
                ...
                case 8:
                    ...
                    widget.getAnchor(type5).connect(target.getAnchor(type5), this.mMarginEnd, this.mMarginEndGone, false);
                    return;
                case 9:
                    ConstraintAnchor.Type type6 = ConstraintAnchor.Type.TOP;
                    widget.getAnchor(type6).connect(target.getAnchor(type6), this.mMarginTop, this.mMarginTopGone, false);
                    return;
                case 10:
                ...
                case 12:
                    ...
                    widget.getAnchor(type7).connect(target.getAnchor(type7), this.mMarginBottom, this.mMarginBottomGone, false);
                    return;
                case 13:
        ...
        if (this.mConstraintWidget != null) {
            ...
            if (hashMap != null) {
                for (String key2 : hashMap.keySet()) {
                    this.mConstraintWidget.frame.setCustomAttribute(key2, 902, this.mCustomColors.get(key2).intValue());
                }
            }
            HashMap<String, Float> hashMap2 = this.mCustomFloats;
            if (hashMap2 != null) {
                for (String key3 : hashMap2.keySet()) {
                    this.mConstraintWidget.frame.setCustomAttribute(key3, 901, this.mCustomFloats.get(key3).floatValue());
                }
            }
        }
    }
