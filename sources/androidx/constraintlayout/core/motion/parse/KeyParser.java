                ...
                if (id != -1) {
                    switch (dtype.get(id)) {
                        ...
                        case 2:
                            ...
                            printStream.println("parse " + type + " INT_MASK > " + value.getInt());
                            break;
                        case 4:
                            bundle.add(id, value.getFloat());
                            PrintStream printStream2 = System.out;
                            printStream2.println("parse " + type + " FLOAT_MASK > " + value.getFloat());
                            break;
                        case 8:
                            bundle.add(id, value.content());
                            PrintStream printStream3 = System.out;
                            printStream3.println("parse " + type + " STRING_MASK > " + value.content());
                            break;
                    }
                } else {
                    PrintStream printStream4 = System.err;
                    printStream4.println("unknown type " + type);
                }
            }
