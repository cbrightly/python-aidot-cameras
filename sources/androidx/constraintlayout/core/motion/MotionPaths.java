...
public class MotionPaths implements Comparable<MotionPaths> {
        ...
        while (true) {
            ...
            if (i2 < dArr2.length) {
                ...
                if (motion != null) {
                    ...
                    float[] fArr2 = pos;
                    float angle = v_y5;
                    float angle2 = path_rotate2;
                    float pos_x = (float) ((d4 + (((double) radius) * Math.sin((double) angle))) - ((double) (v_width4 / 2.0f)));
                    float pos_y = (float) ((((double) ry) - (((double) radius) * Math.cos((double) angle))) - ((double) (v_height2 / 2.0f)));
                    float dradius2 = dradius;
                    v_width = v_width4;
                    v_height = v_height2;
                    float f7 = drx;
                    ...
                    if (!Float.isNaN(angle2)) {
                        ...
                        path_rotate = dv_y2;
                        motionWidget = view;
                        motionWidget.setRotationZ((float) (((double) angle2) + Math.toDegrees(Math.atan2((double) dv_y2, (double) dv_x2))));
                    } else {
                        float f13 = dpos_y;
                        float f14 = angle;
                        float f15 = radius;
    ...
    public void applyParameters(MotionWidget c) {
        ...
        MotionWidget.Motion motion = c.motion;
