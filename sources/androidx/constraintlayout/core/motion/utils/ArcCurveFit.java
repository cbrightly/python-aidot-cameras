...
public class ArcCurveFit extends CurveFit {
    ...
    public void getPos(double t, double[] v) {
        if (this.mExtrapolate) {
            ...
            if (t < arcArr[0].mTime1) {
                double t0 = arcArr[0].mTime1;
                double dt = t - arcArr[0].mTime1;
                if (arcArr[0].linear) {
                    v[0] = arcArr[0].getLinearX(t0) + (this.mArcs[0].getLinearDX(t0) * dt);
                    v[1] = this.mArcs[0].getLinearY(t0) + (this.mArcs[0].getLinearDY(t0) * dt);
                    return;
                }
                arcArr[0].setPoint(t0);
                v[0] = this.mArcs[0].getX() + (this.mArcs[0].getDX() * dt);
                v[1] = this.mArcs[0].getY() + (this.mArcs[0].getDY() * dt);
                return;
            } else if (t > arcArr[arcArr.length - 1].mTime2) {
                double t02 = arcArr[arcArr.length - 1].mTime2;
                double dt2 = t - t02;
                int p = arcArr.length - 1;
                if (arcArr[p].linear) {
                    v[0] = arcArr[p].getLinearX(t02) + (this.mArcs[p].getLinearDX(t02) * dt2);
            ...
            if (t < arcArr2[0].mTime1) {
                t = arcArr2[0].mTime1;
            }
            if (t > arcArr2[arcArr2.length - 1].mTime2) {
        ...
        while (true) {
            ...
            if (t > arcArr3[i].mTime2) {
                ...
                v[0] = arcArr3[i].getLinearX(t);
                v[1] = this.mArcs[i].getLinearY(t);
                return;
            } else {
                arcArr3[i].setPoint(t);
    ...
    public void getPos(double t, float[] v) {
        if (this.mExtrapolate) {
            ...
            if (t < arcArr[0].mTime1) {
                ...
                double dt = t - arcArr[0].mTime1;
                if (arcArr[0].linear) {
                    v[0] = (float) (arcArr[0].getLinearX(t0) + (this.mArcs[0].getLinearDX(t0) * dt));
                ...
                int p = arcArr.length - 1;
                if (arcArr[p].linear) {
                    v[0] = (float) (arcArr[p].getLinearX(t02) + (this.mArcs[p].getLinearDX(t02) * dt2));
            ...
            if (t < arcArr2[0].mTime1) {
                t = arcArr2[0].mTime1;
            } else if (t > arcArr2[arcArr2.length - 1].mTime2) {
                t = arcArr2[arcArr2.length - 1].mTime2;
            }
        }
        int i = 0;
        while (true) {
            ...
            if (t > arcArr3[i].mTime2) {
                ...
                v[0] = (float) arcArr3[i].getLinearX(t);
    ...
    public void getSlope(double t, double[] v) {
        ...
        if (t < arcArr[0].mTime1) {
            ...
            t = arcArr[arcArr.length - 1].mTime2;
        }
        int i = 0;
        while (true) {
            Arc[] arcArr2 = this.mArcs;
    ...
    public double getPos(double t, int j) {
        if (this.mExtrapolate) {
            ...
            if (t < arcArr[0].mTime1) {
                ...
                if (!arcArr[0].linear) {
                    ...
                    return arcArr[0].getLinearX(t0) + (this.mArcs[0].getLinearDX(t0) * dt);
                } else {
                    return arcArr[0].getLinearY(t0) + (this.mArcs[0].getLinearDY(t0) * dt);
                }
            } else if (t > arcArr[arcArr.length - 1].mTime2) {
                double t02 = arcArr[arcArr.length - 1].mTime2;
                double dt2 = t - t02;
        ...
        while (true) {
            ...
            if (t > arcArr3[i].mTime2) {
                ...
                return arcArr3[i].getLinearX(t);
            } else {
                return arcArr3[i].getLinearY(t);
            }
        }
    }
    ...
    public double getSlope(double t, int j) {
        ...
        while (true) {
            ...
            if (t > arcArr2[i].mTime2) {
                ...
                return arcArr2[i].getLinearDX(t);
            } else {
                return arcArr2[i].getLinearDY(t);
            }
        }
    }
