...
public abstract class KeyCycleOscillator {
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            ...
            str = str + Constants.ARRAY_TYPE + wp.mPosition + " , " + df.format((double) wp.mValue) + "] ";
        }
        return str;
    }
    ...
    public void setup(float pathLength) {
        ...
        if (count != 0) {
            ...
            while (it.hasNext()) {
                ...
                this.mCycleOscillator.setPoint(i2, wp.mPosition, f, f3, f7, f6);
                i = i2 + 1;
                c = 1;
            }
