...
public class CLElement {
    ...
    protected long end = DefaultAuthCallbacks.CREDENTIALS_NEVER_EXPIRE;
    private int line;
    ...
    public void setEnd(long end2) {
        if (this.end == DefaultAuthCallbacks.CREDENTIALS_NEVER_EXPIRE) {
            this.end = end2;
            if (CLParser.DEBUG) {
    ...
    public String toString() {
        long j = this.start;
        long j2 = this.end;
        if (j > j2 || j2 == DefaultAuthCallbacks.CREDENTIALS_NEVER_EXPIRE) {
    ...
    public boolean isDone() {
        return this.end != DefaultAuthCallbacks.CREDENTIALS_NEVER_EXPIRE;
    }
