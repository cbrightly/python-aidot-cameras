...
public class SupportMenuInflater extends MenuInflater {
    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attrs) {
            ...
            if (a.hasValue(i)) {
                this.itemCheckable = a.getBoolean(i, false) ? 1 : 0;
            } else {
            ...
            if (a.hasValue(i2)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(a.getInt(i2, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i3 = R.styleable.MenuItem_iconTint;
            if (a.hasValue(i3)) {
                this.itemIconTintList = a.getColorStateList(i3);
            } else {
