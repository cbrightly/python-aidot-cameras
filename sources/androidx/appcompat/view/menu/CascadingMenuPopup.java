...
public final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
        ...
        public void onItemHoverEnter(@NonNull final MenuBuilder menu, @NonNull final MenuItem item) {
            ...
            if (menuIndex != -1) {
                ...
                CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new Runnable() {
                    public void run() {
                        CascadingMenuInfo cascadingMenuInfo = nextInfo;
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        int menuWidth = MenuPopup.measureIndividualMenuWidth(adapter, (ViewGroup) null, this.mContext, this.mMenuMaxWidth);
    ...
    private android.view.View findParentViewForSubmenu(@androidx.annotation.NonNull androidx.appcompat.view.menu.CascadingMenuPopup.CascadingMenuInfo r11, @androidx.annotation.NonNull androidx.appcompat.view.menu.MenuBuilder r12) {
        /*
            r10 = this;
