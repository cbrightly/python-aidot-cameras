...
public class TwilightManager {
    ...
    static TwilightManager getInstance(@NonNull Context context) {
        if (sInstance == null) {
            ...
            sInstance = new TwilightManager(context2, (LocationManager) context2.getSystemService(FirebaseAnalytics.Param.LOCATION));
        }
        return sInstance;
    }
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(now - CostTimeUtil.DAY, location.getLatitude(), location.getLongitude());
