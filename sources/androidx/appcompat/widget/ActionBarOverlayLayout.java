...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public WindowInsets onApplyWindowInsets(@NonNull WindowInsets in) {
        ...
        WindowInsetsCompat inset = insets.inset(rect.left, rect.top, rect.right, rect.bottom);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (topInset2 >= 21 && !this.mLastInnerInsets.equals(this.mInnerInsets)) {
        ...
        } else if (topInset2 < 21 && !this.mLastInnerInsetsRect.equals(this.mInnerInsetsRect)) {
