...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (views.mText2 != null) {
            ...
            if (TextUtils.isEmpty(text2)) {
                TextView textView = views.mText1;
                if (textView != null) {
                    textView.setSingleLine(false);
                    views.mText1.setMaxLines(2);
                }
            } else {
                TextView textView2 = views.mText1;
                if (textView2 != null) {
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Uri.Builder uriBuilder = new Uri.Builder().scheme(FirebaseAnalytics.Param.CONTENT).authority(authority).query("").fragment("");
