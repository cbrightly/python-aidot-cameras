...
public class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, iArr, defStyleAttr, 0);
        TextView textView = this.mTextView;
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), iArr, attrs, a, defStyleAttr, 0);
        int i = R.styleable.AppCompatTextView_autoSizeTextType;
        if (a.hasValue(i)) {
            this.mAutoSizeTextType = a.getInt(i, 0);
        }
        int i2 = R.styleable.AppCompatTextView_autoSizeStepGranularity;
        if (a.hasValue(i2)) {
            autoSizeStepGranularityInPx = a.getDimension(i2, -1.0f);
        }
        int i3 = R.styleable.AppCompatTextView_autoSizeMinTextSize;
        if (a.hasValue(i3)) {
