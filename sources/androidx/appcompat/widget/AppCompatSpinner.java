...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.Nullable android.util.AttributeSet r8, int r9, int r10, android.content.res.Resources.Theme r11) {
        ...
        L_0x003b:
            ...
            r2 = 0
            int[] r3 = ATTRS_ANDROID_SPINNERMODE     // Catch:{ Exception -> 0x0058 }
            android.content.res.TypedArray r3 = r7.obtainStyledAttributes(r8, r3, r9, r1)     // Catch:{ Exception -> 0x0058 }
            r2 = r3
            boolean r3 = r2.hasValue(r1)     // Catch:{ Exception -> 0x0058 }
            if (r3 == 0) goto L_0x0051
            int r3 = r2.getInt(r1, r1)     // Catch:{ Exception -> 0x0058 }
            r10 = r3
        L_0x0051:
        L_0x0052:
            r2.recycle()
        ...
        L_0x0058:
            ...
            android.util.Log.i(r4, r5, r3)     // Catch:{ all -> 0x0056 }
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
            ...
            setOnItemClickListener(new AdapterView.OnItemClickListener(AppCompatSpinner.this) {
                public void onItemClick(AdapterView<?> adapterView, View v, int position, long id) {
                    ...
                    if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                        ...
                        AppCompatSpinner.this.performItemClick(v, position, dropdownPopup.mAdapter.getItemId(position));
                    }
        ...
        public void computeContentWidth() {
            ...
            if (i2 == -2) {
                int contentWidth = appCompatSpinner.compatMeasureContentWidth((SpinnerAdapter) this.mAdapter, getBackground());
