...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, iArr, defStyle, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attrs, attributesArray, defStyle, 0);
        ...
        int i = R.id.image;
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(i);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(i);
            ...
            switch (((ActivityChooserViewAdapter) parent.getAdapter()).getItemViewType(position)) {
                case 0:
                    ...
                    if (!activityChooserView.mIsSelectingDefaultActivity) {
                        Intent launchIntent = ActivityChooserView.this.mAdapter.getDataModel().chooseActivity(activityChooserView.mAdapter.getShowDefaultActivity() ? position : position + 1);
                        ...
                        activityChooserView.mAdapter.getDataModel().setDefaultActivity(position);
                        return;
                    } else {
                        return;
                    }
