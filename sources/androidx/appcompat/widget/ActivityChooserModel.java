...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public Intent chooseActivity(int index) {
        synchronized (this.mInstanceLock) {
            ...
            ensureConsistentState();
            ActivityInfo activityInfo = this.mActivities.get(index).resolveInfo.activityInfo;
            ComponentName chosenName = new ComponentName(activityInfo.packageName, activityInfo.name);
    ...
    public void setDefaultActivity(int index) {
        ...
        synchronized (this.mInstanceLock) {
            ...
            ActivityInfo activityInfo = newDefaultActivity.resolveInfo.activityInfo;
            addHistoricalRecord(new HistoricalRecord(new ComponentName(activityInfo.packageName, activityInfo.name), System.currentTimeMillis(), weight));
        }
    }
    ...
    public static final class HistoricalRecord {
        ...
        public String toString() {
            return Constants.ARRAY_TYPE + "; activity:" + this.activity + "; time:" + this.time + "; weight:" + new BigDecimal((double) this.weight) + "]";
        }
    }
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            return Constants.ARRAY_TYPE + "resolveInfo:" + this.resolveInfo.toString() + "; weight:" + new BigDecimal((double) this.weight) + "]";
        }
    }
    ...
    public static final class DefaultSorter implements ActivitySorter {
        ...
        public void sort(Intent intent, List<ActivityResolveInfo> activities, List<HistoricalRecord> historicalRecords) {
            ...
            for (int i = 0; i < activityCount; i++) {
                ...
                ActivityInfo activityInfo = activity.resolveInfo.activityInfo;
                componentNameToActivityMap.put(new ComponentName(activityInfo.packageName, activityInfo.name), activity);
            }
    ...
    private void readHistoricalDataImpl() {
        ...
        L_0x0023:
            ...
            java.util.List<androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord> r5 = r12.mHistoricalRecords     // Catch:{ XmlPullParserException -> 0x00ad, IOException -> 0x008f }
        ...
        L_0x004a:
            ...
            androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r11 = new androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord     // Catch:{ XmlPullParserException -> 0x00ad, IOException -> 0x008f }
    ...
    public final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r18) {
            /*
                ...
                r8 = 0
                r9 = 0
                androidx.appcompat.widget.ActivityChooserModel r10 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x0112 }
            ...
            L_0x0036:
                ...
                androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r13 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r13     // Catch:{ IllegalArgumentException -> 0x00db, IllegalStateException -> 0x00b5, IOException -> 0x008f, all -> 0x0089 }
            ...
            L_0x008f:
                ...
                r16 = r5
            L_0x0092:
                java.lang.String r2 = androidx.appcompat.widget.ActivityChooserModel.LOG_TAG     // Catch:{ all -> 0x0104 }
                ...
                androidx.appcompat.widget.ActivityChooserModel r3 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ all -> 0x0104 }
