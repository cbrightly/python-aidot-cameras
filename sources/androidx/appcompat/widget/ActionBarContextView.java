...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            ...
            int maxHeight = this.mContentHeight;
            if (maxHeight <= 0) {
            ...
            if (view2 != null) {
                ...
                int i2 = lp2.width;
                int customWidthMode = i2 != -2 ? 1073741824 : Integer.MIN_VALUE;
                ...
                int i4 = widthMode;
                this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(customWidth, customWidthMode), View.MeasureSpec.makeMeasureSpec(i3 >= 0 ? Math.min(i3, height) : height, customHeightMode));
            }
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (view == null || view.getVisibility() == 8) {
            ...
            int x3 = AbsActionBarView.next(x2, startMargin, isLayoutRtl);
        ...
        if (actionMenuView != null) {
            int x6 = x5 + positionChild(actionMenuView, x5, y, contentHeight, !isLayoutRtl);
        }
    }
