...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public void onRestoreInstanceState(Parcelable state) {
        int i;
        MenuItem item;
        if ((state instanceof SavedState) && (i = ((SavedState) state).openSubMenuId) > 0 && (item = this.mMenu.findItem(i)) != null) {
    ...
    public class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu, View anchorView) {
            ...
            if (!((MenuItemImpl) subMenu.getItem()).isActionButton()) {
                ...
                setAnchorView(view == null ? (View) ActionMenuPresenter.this.mMenuView : view);
            }
            setPresenterCallback(ActionMenuPresenter.this.mPopupPresenterCallback);
        }
