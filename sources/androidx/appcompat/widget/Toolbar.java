...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context2, attrs, iArr, defStyleAttr, 0);
        ...
        titleMargin = a.hasValue(i) ? a.getDimensionPixelOffset(i, titleMargin) : titleMargin;
        ...
        if (a.hasValue(i3)) {
            setTitleTextColor(a.getColorStateList(i3));
        }
        int i4 = R.styleable.Toolbar_subtitleTextColor;
        if (a.hasValue(i4)) {
            setSubtitleTextColor(a.getColorStateList(i4));
        }
        int i5 = R.styleable.Toolbar_menu;
        if (a.hasValue(i5)) {
            int i6 = marginStart;
            inflateMenu(a.getResourceId(i5, 0));
        }
        a.recycle();
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (!(expandedActionViewMenuPresenter == null || (menuItemImpl = expandedActionViewMenuPresenter.mCurrentExpandedItem) == null)) {
            state.expandedMenuItemId = menuItemImpl.getItemId();
        }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        int i = ss.expandedMenuItemId;
        if (!(i == 0 || this.mExpandedMenuPresenter == null || menu == null || (item = menu.findItem(i)) == null)) {
    ...
    public void onLayout(boolean r34, int r35, int r36, int r37, int r38) {
        ...
        L_0x0170:
            ...
            switch(r4) {
                case 48: goto L_0x01a4;
                case 80: goto L_0x0193;
        ...
        L_0x01d8:
            ...
            int r2 = r2 - r14
            r14 = 0
            int r17 = java.lang.Math.max(r14, r2)
            int r10 = r10 - r17
            r27 = r1
            int r1 = -r2
        ...
        L_0x0221:
            ...
            r14.layout(r5, r4, r6, r7)
            int r14 = r0.mTitleMarginEnd
            int r6 = r6 - r14
            int r14 = r2.bottomMargin
            int r4 = r7 + r14
        L_0x0249:
        ...
        L_0x0262:
            ...
            r2 = r12[r1]
            int r14 = r14 - r2
            int r2 = java.lang.Math.max(r1, r14)
            int r2 = r29 + r2
            int r5 = -r14
        ...
        L_0x0314:
            ...
            int r13 = r7 - r8
            int r14 = r13 + r5
            if (r13 >= r2) goto L_0x0332
            r13 = r2
            goto L_0x0337
        L_0x0332:
            if (r14 <= r10) goto L_0x0337
            int r15 = r14 - r10
            int r13 = r13 - r15
        L_0x0337:
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (expandedActionParent != toolbar3) {
                ...
                lp.gravity = 8388611 | (toolbar4.mButtonGravity & 112);
                lp.mViewType = 2;
                toolbar4.mExpandedActionView.setLayoutParams(lp);
