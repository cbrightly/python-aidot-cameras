...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(R.attr.actionBarPopupTheme, tv2, true) || tv2.resourceId == 0) {
            this.mPopupContext = context;
        } else {
            this.mPopupContext = new ContextThemeWrapper(context, tv2.resourceId);
        }
    }
