...
public final class ResourceManagerInternal {
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (dr2 != null) {
            dr2.setChangingConfigurations(tv2.changingConfigurations);
    ...
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(@androidx.annotation.NonNull android.content.Context r13, @androidx.annotation.DrawableRes int r14) {
        /*
            r12 = this;
        ...
        L_0x0074:
            ...
            androidx.collection.SparseArrayCompat<java.lang.String> r9 = r12.mKnownDrawableIdTags     // Catch:{ Exception -> 0x00a6 }
            r9.append(r14, r3)     // Catch:{ Exception -> 0x00a6 }
            androidx.collection.SimpleArrayMap<java.lang.String, androidx.appcompat.widget.ResourceManagerInternal$InflateDelegate> r9 = r12.mDelegates     // Catch:{ Exception -> 0x00a6 }
            java.lang.Object r9 = r9.get(r3)     // Catch:{ Exception -> 0x00a6 }
            androidx.appcompat.widget.ResourceManagerInternal$InflateDelegate r9 = (androidx.appcompat.widget.ResourceManagerInternal.InflateDelegate) r9     // Catch:{ Exception -> 0x00a6 }
            if (r9 == 0) goto L_0x0093
            android.content.res.Resources$Theme r11 = r13.getTheme()     // Catch:{ Exception -> 0x00a6 }
            android.graphics.drawable.Drawable r11 = r9.createFromXmlInner(r13, r7, r8, r11)     // Catch:{ Exception -> 0x00a6 }
            r6 = r11
        L_0x0093:
            if (r6 == 0) goto L_0x009d
            int r11 = r0.changingConfigurations     // Catch:{ Exception -> 0x00a6 }
            r6.setChangingConfigurations(r11)     // Catch:{ Exception -> 0x00a6 }
            r12.addDrawableToCache(r13, r4, r6)     // Catch:{ Exception -> 0x00a6 }
        L_0x009d:
            goto L_0x00ae
        L_0x009e:
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized android.graphics.drawable.Drawable getCachedDrawable(@androidx.annotation.NonNull android.content.Context r5, long r6) {
        /*
            r4 = this;
            monitor-enter(r4)
    ...
    static void tintDrawable(Drawable drawable, TintInfo tint, int[] state) {
        if (!DrawableUtils.canSafelyMutateDrawable(drawable) || drawable.mutate() == drawable) {
            boolean z = tint.mHasTintList;
            if (z || tint.mHasTintMode) {
                drawable.setColorFilter(createTintFilter(z ? tint.mTintList : null, tint.mHasTintMode ? tint.mTintMode : DEFAULT_MODE, state));
            } else {
