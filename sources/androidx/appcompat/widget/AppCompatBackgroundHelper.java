...
public class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.saveAttributeDataForStyleable(view, view.getContext(), iArr, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        try {
            int i = R.styleable.ViewBackgroundHelper_android_background;
            if (a.hasValue(i)) {
                this.mBackgroundResId = a.getResourceId(i, -1);
            ...
            if (a.hasValue(i2)) {
                ViewCompat.setBackgroundTintList(this.mView, a.getColorStateList(i2));
            }
            int i3 = R.styleable.ViewBackgroundHelper_backgroundTintMode;
            if (a.hasValue(i3)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(i3, -1), (PorterDuff.Mode) null));
            }
        } finally {
            a.recycle();
        }
