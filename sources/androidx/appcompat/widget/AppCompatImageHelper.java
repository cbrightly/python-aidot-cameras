...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.saveAttributeDataForStyleable(imageView, imageView.getContext(), iArr, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        try {
            ...
            int i = R.styleable.AppCompatImageView_tint;
            if (a.hasValue(i)) {
                ImageViewCompat.setImageTintList(this.mView, a.getColorStateList(i));
            }
            int i2 = R.styleable.AppCompatImageView_tintMode;
            if (a.hasValue(i2)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(i2, -1), (PorterDuff.Mode) null));
            }
        } finally {
            a.recycle();
        }
