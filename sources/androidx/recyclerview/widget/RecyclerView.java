...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attributeSet, iArr, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attrs, a, defStyleAttr, 0);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, iArr2, i, 0);
            int i2 = descendantFocusability;
            ViewCompat.saveAttributeDataForStyleable(this, context, iArr2, attrs, a2, defStyleAttr, 0);
    ...
    private void nestedScrollByInternal(int x, int y, @Nullable MotionEvent motionEvent, int type) {
        ...
        if (layoutManager == null) {
            ...
            scrollByInternal(i2, i, motionEvent, type);
            GapWorker gapWorker = this.mGapWorker;
            if (!(gapWorker == null || (x == 0 && y == 0))) {
                gapWorker.postFromTraversal(this, x, y);
            }
    ...
    public boolean scrollByInternal(int r21, int r22, android.view.MotionEvent r23, int r24) {
        /*
            r20 = this;
            r8 = r20
            r9 = r21
            ...
            r2 = 0
            r3 = 0
            r20.consumePendingUpdateOperations()
        ...
        L_0x00ad:
            r20.considerReleasingGlowsOnScroll(r21, r22)
        L_0x00b0:
            r2 = r19
        ...
        L_0x00be:
            boolean r1 = r20.awakenScrollBars()
    ...
    /* access modifiers changed from: package-private */
    public void smoothScrollBy(@Px int dx, @Px int dy, @Nullable Interpolator interpolator, int duration, boolean withNestedScrolling) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutSuppressed) {
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (!canRunFocusFailure || !(direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int absDir = direction == 2 ? NeedPermissionEvent.PER_IPC_ALBUM_PERM : 33;
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        this.mState.mRunSimpleAnimations = this.mFirstLayoutComplete && this.mItemAnimator != null && ((z = this.mDataSetHasChangedAfterLayout) || animationTypeSupported || this.mLayout.mRequestedSimpleAnimations) && (!z || this.mAdapter.hasStableIds());
        State state = this.mState;
    ...
    private View findNextViewToFocus() {
        ...
        State state = this.mState;
        int startFocusSearchIndex = state.mFocusedItemPosition;
    ...
    private void dispatchLayoutStep1() {
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            boolean didStructureChange = state2.mStructureChanged;
    ...
    public void offsetPositionRecordsForMove(int from, int to) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (holder != null && (i = holder.mPosition) >= start && i <= end) {
                if (i == from) {
    ...
    public void viewRangeUpdate(int positionStart, int itemCount, Object payload) {
        ...
        int positionEnd = positionStart + itemCount;
        for (int i2 = 0; i2 < childCount; i2++) {
            View child = this.mChildHelper.getUnfilteredChildAt(i2);
            ViewHolder holder = getChildViewHolderInt(child);
            if (holder != null && !holder.shouldIgnore() && (i = holder.mPosition) >= positionStart && i < positionEnd) {
                holder.addFlags(2);
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if ((smoothScroller2 != null && smoothScroller2.isPendingInitialRun()) || !doneScrolling) {
                    ...
                    if (gapWorker != null) {
                        gapWorker.postFromTraversal(recyclerView7, consumedX, consumedY);
                    }
                } else {
                    if (RecyclerView.this.getOverScrollMode() != 2) {
        ...
        private int computeScrollDuration(int dx, int dy) {
            ...
            RecyclerView recyclerView = RecyclerView.this;
            return Math.min((int) (((((float) (horizontal ? absDx : absDy)) / ((float) (horizontal ? recyclerView.getWidth() : recyclerView.getHeight()))) + 1.0f) * 300.0f), 2000);
        }
    ...
    public void repositionShadowingViews() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (!(holder == null || (viewHolder = holder.mShadowingHolder) == null)) {
                View shadowingView = viewHolder.itemView;
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static void clearNestedRecyclerViewIfNotNested(@androidx.annotation.NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder r3) {
        /*
    ...
    public final class Recycler {
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (holder2 == null) {
                ...
                if (holder2 == null) {
                    ...
                    RecyclerView recyclerView = RecyclerView.this;
                    ViewHolder holder3 = recyclerView.mAdapter.createViewHolder(recyclerView, type);
            ...
            if (fromScrapOrHiddenOrCache && !RecyclerView.this.mState.isPreLayout() && holder.hasAnyOfTheFlags(8192)) {
                ...
                if (RecyclerView.this.mState.mRunSimpleAnimations) {
                    RecyclerView recyclerView2 = RecyclerView.this;
                    RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(holder, recyclerView2.mItemAnimator.recordPreLayoutInformation(recyclerView2.mState, holder, ItemAnimator.buildAdapterChangeFlagsForAnimations(holder) | 4096, holder.getUnmodifiedPayloads()));
                }
            }
            boolean bound = false;
        ...
        public void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                ...
                if ((adapter != null && transientStatePreventsRecycling && adapter.onFailedToRecycleView(holder)) || holder.isRecyclable()) {
    ...
    public static abstract class ViewHolder {
        ...
        public final int getBindingAdapterPosition() {
            ...
            int globalPosition;
            if (this.mBindingAdapter == null || (recyclerView = this.mOwnerRecyclerView) == null || (rvAdapter = recyclerView.getAdapter()) == null || (globalPosition = this.mOwnerRecyclerView.getAdapterPositionInRecyclerView(this)) == -1) {
                return -1;
            }
    ...
    public static abstract class SmoothScroller {
        ...
        public void onAnimation(int dx, int dy) {
            ...
            if (this.mPendingInitialRun && this.mTargetView == null && this.mLayoutManager != null && (pointF = computeScrollVectorForPosition(this.mTargetPosition)) != null) {
                float f = pointF.x;
