...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v7, resolved type: androidx.work.impl.utils.futures.AbstractFuture$SynchronizedHelper} */
    ...
    static {
        /*
            ...
            log = r1
            r1 = 0
            androidx.work.impl.utils.futures.AbstractFuture$SafeAtomicHelper r8 = new androidx.work.impl.utils.futures.AbstractFuture$SafeAtomicHelper     // Catch:{ all -> 0x0052 }
            java.lang.Class<java.lang.Thread> r2 = java.lang.Thread.class
            java.lang.String r3 = "thread"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r3 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r0, r2, r3)     // Catch:{ all -> 0x0052 }
            java.lang.String r2 = "next"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r4 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r0, r0, r2)     // Catch:{ all -> 0x0052 }
            ...
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r2, r0, r5)     // Catch:{ all -> 0x0052 }
            ...
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r6 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r0, r2, r6)     // Catch:{ all -> 0x0052 }
            java.lang.Class<androidx.work.impl.utils.futures.AbstractFuture> r0 = androidx.work.impl.utils.futures.AbstractFuture.class
            java.lang.Class<java.lang.Object> r2 = java.lang.Object.class
            java.lang.String r7 = "value"
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r7 = java.util.concurrent.atomic.AtomicReferenceFieldUpdater.newUpdater(r0, r2, r7)     // Catch:{ all -> 0x0052 }
            r2 = r8
            r2.<init>(r3, r4, r5, r6, r7)     // Catch:{ all -> 0x0052 }
            r0 = r8
            goto L_0x005a
        L_0x0052:
            r0 = move-exception
    ...
    public final V get(long timeout, TimeUnit unit) {
        ...
        if (!Thread.interrupted()) {
            ...
            String timeUnit2 = unit.toString();
            Locale locale = Locale.ROOT;
            String unitString = timeUnit2.toLowerCase(locale);
            String message = "Waited " + j + " " + unit.toString().toLowerCase(locale);
            if (remainingNanos + 1000 < 0) {
                ...
                long remainingNanos2 = overWaitNanos - timeUnit.toNanos(overWaitUnits);
    ...
    /* JADX WARNING: type inference failed for: r6v6, types: [java.util.concurrent.Future, com.google.common.util.concurrent.ListenableFuture<? extends V>] */
    /* JADX WARNING: Multi-variable type inference failed */
