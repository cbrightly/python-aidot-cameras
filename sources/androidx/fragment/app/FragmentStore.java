...
public class FragmentStore {
    ...
    public void setNonConfig(@NonNull FragmentManagerViewModel nonConfig) {
    ...
    /* access modifiers changed from: package-private */
    public void restoreAddedFragments(@Nullable List<String> added) {
        this.mAdded.clear();
        if (added != null) {
    ...
    /* access modifiers changed from: package-private */
    public void makeActive(@NonNull FragmentStateManager newlyActive) {
    ...
    /* access modifiers changed from: package-private */
    public void makeInactive(@NonNull FragmentStateManager newlyInactive) {
    ...
    /* access modifiers changed from: package-private */
    public boolean containsActiveFragment(@NonNull String who) {
        return this.mActive.get(who) != null;
    }

    /* access modifiers changed from: package-private */
    @Nullable
    public FragmentStateManager getFragmentStateManager(@NonNull String who) {
    ...
    /* access modifiers changed from: package-private */
    public int findFragmentIndexInContainer(@NonNull Fragment f) {
        View view;
        View view2;
        ...
        for (int i = fragmentIndex - 1; i >= 0; i--) {
            ...
            if (underFragment.mContainer == container && (view2 = underFragment.mView) != null) {
                return container.indexOfChild(view2) + 1;
            }
        }
        for (int i2 = fragmentIndex + 1; i2 < this.mAdded.size(); i2++) {
            Fragment overFragment = this.mAdded.get(i2);
            if (overFragment.mContainer == container && (view = overFragment.mView) != null) {
