...
public final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord bse) {
        ...
        if (bse.mAddToBackStack) {
            ...
            while (opNum < numOps) {
                ...
                int[] iArr = this.mOps;
                int pos3 = pos2 + 1;
                iArr[pos2] = op.mEnterAnim;
                int pos4 = pos3 + 1;
                iArr[pos3] = op.mExitAnim;
                int pos5 = pos4 + 1;
                iArr[pos4] = op.mPopEnterAnim;
                iArr[pos5] = op.mPopExitAnim;
    ...
    public BackStackRecord instantiate(FragmentManager fm) {
        ...
        while (pos < this.mOps.length) {
            ...
            if (fWho != null) {
                op.mFragment = fm.findActiveFragment(fWho);
            } else {
                op.mFragment = null;
            }
            ...
            int pos7 = pos5 + 1;
            int pos8 = iArr[pos5];
            op.mPopEnterAnim = pos8;
            int i = iArr[pos7];
            op.mPopExitAnim = i;
            bse.mEnterAnim = pos4;
            bse.mExitAnim = pos6;
            bse.mPopEnterAnim = pos8;
            bse.mPopExitAnim = i;
            bse.addOp(op);
            num++;
            pos = pos7 + 1;
