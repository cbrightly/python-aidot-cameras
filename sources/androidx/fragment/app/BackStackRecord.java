...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    BackStackRecord(@androidx.annotation.NonNull androidx.fragment.app.FragmentManager r3) {
        /*
            r2 = this;
    ...
    public int commitInternal(boolean allowStateLoss) {
        if (!this.mCommitted) {
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                dump(JustifyTextView.TWO_CHINESE_BLANK, pw);
                pw.close();
            }
    ...
    public boolean interactsWith(int containerId) {
        ...
        while (true) {
            ...
            Fragment fragment = this.mOps.get(opNum).mFragment;
            if (fragment != null) {
            ...
            if (!(container == 0 || container == lastContainer)) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        Fragment fragment2 = record.mOps.get(thoseOpIndex).mFragment;
            ...
            switch (op.mCmd) {
                ...
                case 6:
                    ...
                    if (fragment != oldPrimaryNav) {
                        ...
                        this.mOps.add(opNum, new FragmentTransaction.Op(9, fragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    }
