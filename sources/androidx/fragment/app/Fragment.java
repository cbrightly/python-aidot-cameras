...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void setInitialSavedState(@Nullable SavedState state) {
        Bundle bundle;
        if (this.mFragmentManager == null) {
            if (state == null || (bundle = state.mState) == null) {
                bundle = null;
            }
    ...
    public void callStartTransitionListener(boolean calledDirectly) {
        ...
        if (animationInfo == null) {
            ...
            OnStartEnterTransitionListener listener2 = animationInfo.mStartEnterTransitionListener;
    ...
    public void dump(@NonNull String prefix, @Nullable FileDescriptor fd, @NonNull PrintWriter writer, @Nullable String[] args) {
        ...
        fragmentManager.dump(prefix + JustifyTextView.TWO_CHINESE_BLANK, fd, writer, args);
    }
    ...
    public void setOnStartEnterTransitionListener(OnStartEnterTransitionListener listener) {
        ensureAnimationInfo();
        AnimationInfo animationInfo = this.mAnimationInfo;
        OnStartEnterTransitionListener onStartEnterTransitionListener = animationInfo.mStartEnterTransitionListener;
        if (listener != onStartEnterTransitionListener) {
            if (listener == null || onStartEnterTransitionListener == null) {
                if (animationInfo.mEnterTransitionPostponed) {
                    animationInfo.mStartEnterTransitionListener = listener;
                }
                if (listener != null) {
    ...
    /* access modifiers changed from: package-private */
    public void setSharedElementNames(@Nullable ArrayList<String> sharedElementSourceNames, @Nullable ArrayList<String> sharedElementTargetNames) {
        ensureAnimationInfo();
        AnimationInfo animationInfo = this.mAnimationInfo;
        animationInfo.mSharedElementSourceNames = sharedElementSourceNames;
        animationInfo.mSharedElementTargetNames = sharedElementTargetNames;
    }
    ...
    @MainThread
    @NonNull
    public final <I, O> ActivityResultLauncher<I> registerForActivityResult(@NonNull ActivityResultContract<I, O> contract, @NonNull final ActivityResultRegistry registry, @NonNull ActivityResultCallback<O> callback) {
        return prepareCallInternal(contract, new Function<Void, ActivityResultRegistry>() {
            public ActivityResultRegistry apply(Void input) {
                return registry;
            }
    ...
    @NonNull
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> contract, @NonNull Function<Void, ActivityResultRegistry> registryProvider, @NonNull ActivityResultCallback<O> callback) {
        if (this.mState <= 1) {
    ...
    private void registerOnPreAttachListener(@NonNull OnPreAttachedListener callback) {
        if (this.mState >= 0) {
