...
public class FragmentTransition {
    ...
    private static ArrayMap<String, String> calculateNameOverrides(int containerId, ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) {
        ...
        for (int recordNum = endIndex - 1; recordNum >= startIndex; recordNum--) {
            ...
            if (record.interactsWith(containerId)) {
                ...
                ArrayList<String> arrayList = record.mSharedElementSourceNames;
                if (arrayList != null) {
    ...
    private static void configureTransitionsReordered(@NonNull ViewGroup container, FragmentContainerTransition fragments, View nonExistentView, ArrayMap<String, String> nameOverrides, Callback callback) {
    ...
    private static void configureTransitionsOrdered(@NonNull ViewGroup container, FragmentContainerTransition fragments, View nonExistentView, ArrayMap<String, String> nameOverrides, Callback callback) {
        Object exitTransition;
    ...
    static View getInEpicenterView(ArrayMap<String, View> inSharedElements, FragmentContainerTransition fragments, Object enterTransition, boolean inIsPop) {
        ...
        String targetName;
        BackStackRecord inTransaction = fragments.lastInTransaction;
        if (enterTransition == null || inSharedElements == null || (arrayList = inTransaction.mSharedElementSourceNames) == null || arrayList.isEmpty()) {
            return null;
        }
        if (inIsPop) {
    ...
    private static void setOutEpicenter(FragmentTransitionImpl impl, Object sharedElementTransition, Object exitTransition, ArrayMap<String, View> outSharedElements, boolean outIsPop, BackStackRecord outTransaction) {
        String sourceName;
        ArrayList<String> arrayList = outTransaction.mSharedElementSourceNames;
    ...
    private static void addToFirstInLastOut(BackStackRecord transaction, FragmentTransaction.Op op, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isPop, boolean isReorderedTransaction) {
        ...
        if (fragment != null && (containerId = fragment.mContainerId) != 0) {
            ...
            switch (z ? INVERSE_OPS[op2.mCmd] : op2.mCmd) {
                ...
                case 6:
                    if (isReorderedTransaction) {
                        if (fragment.mAdded || (view = fragment.mView) == null || view.getVisibility() != 0 || fragment.mPostponedAlpha < 0.0f) {
                            z2 = false;
                        }
                        setFirstOut = z2;
                    } else {
