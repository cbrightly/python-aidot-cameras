...
public abstract class Visibility extends Transition {
    ...
    private VisibilityInfo getVisibilityChangeInfo(TransitionValues startValues, TransitionValues endValues) {
        ...
        if (startValues != null && endValues != null) {
            int i = visInfo.mStartVisibility;
            int i2 = visInfo.mEndVisibility;
            if (i == i2 && visInfo.mStartParent == visInfo.mEndParent) {
                return visInfo;
            }
            if (i != i2) {
                if (i == 0) {
    ...
    public Animator onDisappear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        if (savedOverlayView != null) {
            ...
            if (!needOverlayForStartView) {
                ...
                View view3 = endView;
                TransitionValues transitionValues3 = startParentValues;
                if (!getVisibilityChangeInfo(startParentValues, getMatchedTransitionValues(startParent, true)).mVisibilityChange) {
                ...
                if (animator == null) {
                    ...
                    addListener(new TransitionListenerAdapter() {
                        ...
                        public void onTransitionEnd(@NonNull Transition transition) {
                            startView.setTag(R.id.save_overlay_view, (Object) null);
                            ViewGroupUtils.getOverlay(overlayHost).remove(finalOverlayView);
