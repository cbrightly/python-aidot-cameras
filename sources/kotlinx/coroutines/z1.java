...
public interface z1 extends g.b {
    ...
    @NotNull
    f1 m(boolean z, boolean z2, @NotNull kotlin.jvm.functions.l<? super Throwable, x> lVar);
    ...
    @NotNull
    f1 t(@NotNull kotlin.jvm.functions.l<? super Throwable, x> lVar);

    @l(k = 3, mv = {1, 6, 0}, xi = 48)
    /* compiled from: Job.kt */
    public static final class a {
        public static <R> R b(@NotNull z1 z1Var, R initial, @NotNull p<? super R, ? super g.b, ? extends R> operation) {
            return g.b.a.a(z1Var, initial, operation);
        }

        @Nullable
        public static <E extends g.b> E c(@NotNull z1 z1Var, @NotNull g.c<E> key) {
            return g.b.a.b(z1Var, key);
        }

        @NotNull
        public static g e(@NotNull z1 z1Var, @NotNull g.c<?> key) {
            return g.b.a.c(z1Var, key);
        }

        @NotNull
        public static g f(@NotNull z1 z1Var, @NotNull g context) {
        ...
        public static /* synthetic */ f1 d(z1 z1Var, boolean z, boolean z2, kotlin.jvm.functions.l lVar, int i, Object obj) {
            if (obj == null) {
                if ((i & 1) != 0) {
                    z = false;
                }
