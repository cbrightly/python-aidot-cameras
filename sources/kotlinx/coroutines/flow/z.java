...
public final class z {
    ...
    /* access modifiers changed from: private */
    @NotNull
    public static final f0 b = new f0("PENDING");

    @NotNull
    public static final <T> q<T> a(T value) {
        return new y(value == null ? n.a : value);
    }

    @NotNull
    public static final <T> c<T> d(@NotNull x<? extends T> $this$fuseStateFlow, @NotNull g context, int capacity, @NotNull h onBufferOverflow) {
        boolean z = true;
        if (s0.a()) {
            if ((capacity != -1 ? 1 : 0) == 0) {
        ...
        if ((z || capacity == -2) && onBufferOverflow == h.DROP_OLDEST) {
            return $this$fuseStateFlow;
        }
        return v.e($this$fuseStateFlow, context, capacity, onBufferOverflow);
    }
}
