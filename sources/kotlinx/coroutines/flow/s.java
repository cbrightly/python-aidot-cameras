...
public final class s<T> implements x<T>, k<T>, k {
    @Nullable
    private final z1 c;
    private final /* synthetic */ x<T> d;

    @Nullable
    public Object a(@NotNull d<? super T> dVar, @NotNull d<?> dVar2) {
        return this.d.a(dVar, dVar2);
    }
    ...
    public s(@NotNull x<? extends T> flow, @Nullable z1 job) {
        this.c = job;
        this.d = flow;
    }
