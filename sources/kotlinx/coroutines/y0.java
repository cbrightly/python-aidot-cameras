...
public interface y0 {
    void j(long j, @NotNull n<? super x> nVar);

    @NotNull
    f1 l(long j, @NotNull Runnable runnable, @NotNull g gVar);

    @l(k = 3, mv = {1, 6, 0}, xi = 48)
    /* compiled from: Delay.kt */
    public static final class a {
        @NotNull
        public static f1 a(@NotNull y0 y0Var, long timeMillis, @NotNull Runnable block, @NotNull g context) {
            return v0.a().l(timeMillis, block, context);
        }
    }
}
