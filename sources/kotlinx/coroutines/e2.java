...
public final /* synthetic */ class e2 {
    ...
    public static /* synthetic */ z b(z1 z1Var, int i, Object obj) {
        if ((i & 1) != 0) {
            z1Var = null;
        }
        return c2.a(z1Var);
    ...
    @NotNull
    public static final f1 g(@NotNull z1 $this$disposeOnCompletion, @NotNull f1 handle) {
        return $this$disposeOnCompletion.t(new h1(handle));
    }

    public static /* synthetic */ void d(g gVar, CancellationException cancellationException, int i, Object obj) {
        if ((i & 1) != 0) {
            cancellationException = null;
        }
        c2.c(gVar, cancellationException);
    }

    public static final void c(@NotNull g $this$cancel, @Nullable CancellationException cause) {
        z1 z1Var = (z1) $this$cancel.get(z1.g);
        if (z1Var != null) {
            z1Var.c(cause);
        }
    }

    public static final void i(@NotNull z1 $this$ensureActive) {
        if (!$this$ensureActive.isActive()) {
            throw $this$ensureActive.n();
        }
    }

    public static final void h(@NotNull g $this$ensureActive) {
        z1 z1Var = (z1) $this$ensureActive.get(z1.g);
        if (z1Var != null) {
            c2.j(z1Var);
        }
    }

    public static /* synthetic */ void f(g gVar, CancellationException cancellationException, int i, Object obj) {
        if ((i & 1) != 0) {
            cancellationException = null;
        }
        c2.e(gVar, cancellationException);
    }

    public static final void e(@NotNull g $this$cancelChildren, @Nullable CancellationException cause) {
        h<z1> $this$forEach$iv;
        z1 z1Var = (z1) $this$cancelChildren.get(z1.g);
        if (z1Var != null && ($this$forEach$iv = z1Var.getChildren()) != null) {
            for (z1 it : $this$forEach$iv) {
                it.c(cause);
            }
        }
    }
