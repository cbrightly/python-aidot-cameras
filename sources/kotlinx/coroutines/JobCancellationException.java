...
public final class JobCancellationException extends CancellationException implements g0<JobCancellationException> {
    ...
    public JobCancellationException(@NotNull String message, @Nullable Throwable cause, @NotNull z1 job2) {
        super(message);
        this.job = job2;
        if (cause != null) {
            initCause(cause);
    ...
    public boolean equals(@Nullable Object other) {
        return other == this || ((other instanceof JobCancellationException) && k.a(((JobCancellationException) other).getMessage(), getMessage()) && k.a(((JobCancellationException) other).job, this.job) && k.a(((JobCancellationException) other).getCause(), getCause()));
    }
