...
public final class n1 {
    ...
    @NotNull
    public static final f0 a = new f0("REMOVED_TASK");
    /* access modifiers changed from: private */
    @NotNull
    public static final f0 b = new f0("CLOSED_EMPTY");

    public static final long c(long timeMillis) {
        if (timeMillis <= 0) {
            return 0;
        }
        if (timeMillis >= 9223372036854L) {
            return DefaultAuthCallbacks.CREDENTIALS_NEVER_EXPIRE;
        }
        return Time.NANOS_IN_A_MILLISECOND * timeMillis;
    }
}
