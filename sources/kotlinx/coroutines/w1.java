...
public final class w1 extends l {
    @NotNull
    private final kotlin.jvm.functions.l<Throwable, x> c;
    ...
    public w1(@NotNull kotlin.jvm.functions.l<? super Throwable, x> handler) {
        this.c = handler;
    }
    ...
    public String toString() {
        return "InvokeOnCancel[" + t0.a(this.c) + '@' + t0.b(this) + ']';
    }
}
