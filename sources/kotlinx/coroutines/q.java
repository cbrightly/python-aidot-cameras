...
public final class q {
    @NotNull
    public static final <T> o<T> b(@NotNull d<? super T> delegate) {
        if (!(delegate instanceof i)) {
            return new o<>(delegate, 1);
        }
        o it = ((i) delegate).l();
        if (it == null || !it.I()) {
            it = null;
        ...
        if (it == null) {
            return new o<>(delegate, 2);
        }
        return it;
    }

    public static final void c(@NotNull n<?> $this$removeOnCancellation, @NotNull s node) {
        $this$removeOnCancellation.f(new p2(node));
    }

    public static final void a(@NotNull n<?> $this$disposeOnCancellation, @NotNull f1 handle) {
        $this$disposeOnCancellation.f(new g1(handle));
    }
}
