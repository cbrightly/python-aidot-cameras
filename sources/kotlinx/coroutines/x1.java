...
public final class x1 extends a2 {
    private static final /* synthetic */ AtomicIntegerFieldUpdater x = AtomicIntegerFieldUpdater.newUpdater(x1.class, "_invoked");
    @NotNull
    private volatile /* synthetic */ int _invoked = 0;
    @NotNull
    private final kotlin.jvm.functions.l<Throwable, x> y;
    ...
    public x1(@NotNull kotlin.jvm.functions.l<? super Throwable, x> handler) {
        this.y = handler;
    }
