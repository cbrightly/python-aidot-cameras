...
public interface a0<E> {
    @Nullable
    Object D(E e, @NotNull d<? super x> dVar);

    boolean F();

    boolean d(@Nullable Throwable th);

    void k(@NotNull kotlin.jvm.functions.l<? super Throwable, x> lVar);
    ...
    public static final class a {
        public static /* synthetic */ boolean a(a0 a0Var, Throwable th, int i, Object obj) {
            if (obj == null) {
                if ((i & 1) != 0) {
                    th = null;
                }
        ...
        public static <E> boolean b(@NotNull a0<? super E> a0Var, E element) {
            Object result = a0Var.p(element);
            if (l.j(result)) {
                return true;
            }
