...
public final class q<E> extends d<E> {
    ...
    public q(@NotNull g parentContext, @NotNull i<E> channel, @NotNull p<? super f<E>, ? super d<? super x>, ? extends Object> block) {
        super(parentContext, channel, false);
        this.q = b.b(block, this, this);
    }
    ...
    @Nullable
    public Object D(E element, @NotNull d<? super x> $completion) {
        start();
        Object D = super.D(element, $completion);
        return D == c.d() ? D : x.a;
    }
