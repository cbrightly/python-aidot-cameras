...
public interface i<E> extends a0<E>, w<E> {
    @NotNull
    ...
    public static final class a {
        @Nullable
        public static <E> E a(@NotNull i<E> iVar) {
            return w.a.a(iVar);
        }

        @Nullable
        public static <E> Object b(@NotNull i<E> iVar, @NotNull d<? super E> $completion) {
            return w.a.b(iVar, $completion);
        }
    }
    ...
    public static final class b {
        ...
        private static final int b = g0.b("kotlinx.coroutines.channels.defaultBuffer", 64, 1, 2147483646);
