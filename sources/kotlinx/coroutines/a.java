...
public abstract class a<T> extends g2 implements z1, d<T>, o0 {
    @NotNull
    private final g d;

    public a(@NotNull g parentContext, boolean initParentJob, boolean active) {
        super(active);
        if (initParentJob) {
    ...
    @NotNull
    public String X() {
        return k.l(t0.a(this), " was cancelled");
    }

    /* access modifiers changed from: protected */
    public final void B0(@Nullable Object state) {
        if (state instanceof b0) {
            S0(((b0) state).b, ((b0) state).a());
        } else {
            T0(state);
        }
    }
    ...
    public final void resumeWith(@NotNull Object result) {
        Object state = u0(e0.d(result, (kotlin.jvm.functions.l) null, 1, (Object) null));
        if (state != h2.b) {
            R0(state);
        }
    }
    ...
    public final void n0(@NotNull Throwable exception) {
        l0.a(this.d, exception);
    }

    @NotNull
    public String w0() {
        String coroutineName = h0.b(this.d);
        if (coroutineName == null) {
            return super.w0();
        }
        return StringUtil.DOUBLE_QUOTE + coroutineName + "\":" + super.w0();
    }

    public final <R> void U0(@NotNull q0 start, R receiver, @NotNull p<? super R, ? super d<? super T>, ? extends Object> block) {
