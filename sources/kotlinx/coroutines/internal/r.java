...
public final class r {
    @NotNull
    private static final Object a = new f0("CONDITION_FALSE");
    @NotNull
    private static final Object b = new f0("LIST_EMPTY");
    ...
    @NotNull
    public static final s b(@NotNull Object $this$unwrap) {
        s sVar = null;
        b0 b0Var = $this$unwrap instanceof b0 ? (b0) $this$unwrap : null;
        if (b0Var != null) {
            sVar = b0Var.a;
        }
        return sVar == null ? (s) $this$unwrap : sVar;
    }
}
