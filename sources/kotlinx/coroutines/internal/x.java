...
public final class x {
    ...
    @NotNull
    public static final k2 e(@NotNull v $this$tryCreateDispatcher, @NotNull List<? extends v> factories) {
        try {
            return $this$tryCreateDispatcher.createDispatcher(factories);
        } catch (Throwable cause) {
            return a(cause, $this$tryCreateDispatcher.hintOnError());
        }
    }

    public static final boolean c(@NotNull k2 $this$isMissing) {
        return $this$isMissing.W() instanceof y;
    }

    static /* synthetic */ y b(Throwable th, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            th = null;
        }
        if ((i & 2) != 0) {
    ...
    private static final y a(Throwable cause, String errorHint) {
        if (a) {
            return new y(cause, errorHint);
        }
        if (cause == null) {
            d();
