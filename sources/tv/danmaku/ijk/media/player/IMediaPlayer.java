...
public interface IMediaPlayer {
    ...
    public interface OnVideoFrameListener {
        void onVideoFrameRefresh(IMediaPlayer iMediaPlayer, IjkVideoFrame ijkVideoFrame);
    }

    public interface OnVideoRadarDataListener {
        void onRadarDataCallback(IMediaPlayer iMediaPlayer, byte[] bArr);
    }
    ...
    void setOnVideoRadarDataListener(OnVideoRadarDataListener onVideoRadarDataListener);
