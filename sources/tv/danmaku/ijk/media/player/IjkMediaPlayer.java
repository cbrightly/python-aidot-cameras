...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private static final int MEDIA_DISPLAY_IMG = 1001;
    private static final int MEDIA_ERROR = 100;
    private static final int MEDIA_FRAME_INFO = 300;
    private static final int MEDIA_INFO = 200;
    private static final int MEDIA_NOP = 0;
    private static final int MEDIA_PLAYBACK_COMPLETE = 2;
    private static final int MEDIA_PREPARED = 1;
    private static final int MEDIA_RADAR_DATA = 1002;
    ...
    public native int cancelExecuteCmd();

    public native int capture(String str);

    public native int executeCmd(String str);
    ...
    public void setDataSource(android.content.Context r10, android.net.Uri r11, java.util.Map<java.lang.String, java.lang.String> r12) {
        ...
        L_0x0014:
            ...
            if (r1 == 0) goto L_0x003c
            int r1 = android.media.RingtoneManager.getDefaultType(r11)
            android.net.Uri r11 = android.media.RingtoneManager.getActualDefaultRingtoneUri(r10, r1)
            if (r11 == 0) goto L_0x0034
            goto L_0x003c
        L_0x0034:
            java.io.FileNotFoundException r1 = new java.io.FileNotFoundException
            java.lang.String r2 = "Failed to resolve default ringtone"
            r1.<init>(r2)
            throw r1
        L_0x003c:
            r1 = 0
            android.content.ContentResolver r2 = r10.getContentResolver()     // Catch:{ SecurityException -> 0x0085, IOException -> 0x007e, all -> 0x0077 }
            java.lang.String r3 = "r"
            android.content.res.AssetFileDescriptor r3 = r2.openAssetFileDescriptor(r11, r3)     // Catch:{ SecurityException -> 0x0085, IOException -> 0x007e, all -> 0x0077 }
            r1 = r3
        ...
        L_0x004f:
            return
        L_0x0050:
            long r3 = r1.getDeclaredLength()     // Catch:{ SecurityException -> 0x0085, IOException -> 0x007e, all -> 0x0077 }
            r5 = 0
            int r3 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r3 >= 0) goto L_0x0062
            java.io.FileDescriptor r3 = r1.getFileDescriptor()     // Catch:{ SecurityException -> 0x0085, IOException -> 0x007e, all -> 0x0077 }
            r9.setDataSource((java.io.FileDescriptor) r3)     // Catch:{ SecurityException -> 0x0085, IOException -> 0x007e, all -> 0x0077 }
            goto L_0x0072
        L_0x0062:
            java.io.FileDescriptor r4 = r1.getFileDescriptor()     // Catch:{ SecurityException -> 0x0085, IOException -> 0x007e, all -> 0x0077 }
            long r5 = r1.getStartOffset()     // Catch:{ SecurityException -> 0x0085, IOException -> 0x007e, all -> 0x0077 }
            long r7 = r1.getDeclaredLength()     // Catch:{ SecurityException -> 0x0085, IOException -> 0x007e, all -> 0x0077 }
            r3 = r9
            r3.setDataSource((java.io.FileDescriptor) r4, (long) r5, (long) r7)     // Catch:{ SecurityException -> 0x0085, IOException -> 0x007e, all -> 0x0077 }
        L_0x0072:
            r1.close()
            return
        L_0x0077:
        ...
        L_0x0089:
            ...
            r9.setDataSource((java.lang.String) r2, (java.util.Map<java.lang.String, java.lang.String>) r12)
            return
        */
    ...
    public void setWakeMode(Context context, int mode) {
        ...
        PowerManager.WakeLock newWakeLock = ((PowerManager) context.getSystemService("power")).newWakeLock(536870912 | mode, IjkMediaPlayer.class.getName());
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 100:
                    ...
                    DebugLog.e(access$100, "Error (" + msg.arg1 + "," + msg.arg2 + ")");
                ...
                case 200:
                    ...
                    return;
                case 1001:
                    player.notifyOnVideoFrameRefresh(new IjkVideoFrame(msg.arg1, msg.arg2, (byte[]) msg.obj));
                    return;
                case 1002:
                    player.notifyOnVideRadarData((byte[]) msg.obj);
                    return;
                case 10001:
                ...
                default:
                    ...
                    DebugLog.e(access$1002, "Unknown message type " + msg.what);
                    return;
            }
        }
    }
    ...
    public static class DefaultMediaCodecSelector implements OnMediaCodecSelectListener {
        ...
        public String onMediaCodecSelect(IMediaPlayer mp, String mimeType, int profile, int level) {
            ...
            int i = 2;
            Log.i(IjkMediaPlayer.TAG, String.format(Locale.US, "onSelectCodec: mime=%s, profile=%d, level=%d", new Object[]{str, Integer.valueOf(profile), Integer.valueOf(level)}));
                ...
                if (!codecInfo.isEncoder() && (types = codecInfo.getSupportedTypes()) != null) {
                    ...
                    while (i3 < length) {
                        ...
                        if (!TextUtils.isEmpty(type)) {
                            ...
                            Log.d(access$100, String.format(locale, "    mime: %s", new Object[]{type}));
                            if (type.equalsIgnoreCase(str) && (candidate = IjkMediaCodecInfo.setupCandidate(codecInfo, str)) != null) {
                                candidateCodecList.add(candidate);
                                String access$1002 = IjkMediaPlayer.TAG;
                                Object[] objArr = new Object[i];
                                objArr[0] = codecInfo.getName();
                                objArr[1] = Integer.valueOf(candidate.mRank);
                                Log.i(access$1002, String.format(locale, "candidate codec: %s rank=%d", objArr));
                                candidate.dumpProfileLevels(str);
                            }
                        }
                        i3++;
                        i = 2;
