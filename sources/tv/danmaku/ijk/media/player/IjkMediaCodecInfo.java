...
public class IjkMediaCodecInfo {
    ...
    public static IjkMediaCodecInfo setupCandidate(MediaCodecInfo codecInfo, String mimeType) {
        ...
        int rank;
        int rank2;
        if (codecInfo == null || (i = Build.VERSION.SDK_INT) < 16) {
            return null;
        }
    ...
    public void dumpProfileLevels(String mimeType) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            try {
                ...
                int maxProfile = 0;
                int maxLevel = 0;
                if (!(caps == null || (codecProfileLevelArr = caps.profileLevels) == null)) {
                    for (MediaCodecInfo.CodecProfileLevel profileLevel : codecProfileLevelArr) {
