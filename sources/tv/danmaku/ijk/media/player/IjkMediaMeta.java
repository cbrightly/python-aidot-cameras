...
public class IjkMediaMeta {
    ...
    public String getDurationInline() {
        long secs = (this.mDurationUS + KinesisVideoProducer.READY_TIMEOUT_IN_MILLISECONDS) / Time.NANOS_IN_A_MILLISECOND;
        long mins = secs / 60;
    ...
    public static class IjkStreamMeta {
        ...
        public String getResolutionInline() {
            ...
            if (this.mSarNum <= 0 || this.mSarDen <= 0) {
                return String.format(Locale.US, "%d x %d", new Object[]{Integer.valueOf(i), Integer.valueOf(this.mHeight)});
            }
        ...
        public String getFpsInline() {
            ...
            return String.valueOf(((float) i2) / ((float) i));
        }
