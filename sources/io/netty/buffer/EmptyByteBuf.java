...
public final class EmptyByteBuf extends ByteBuf {
    ...
    static {
        ...
        try {
            if (PlatformDependent.hasUnsafe()) {
                emptyByteBufferAddress = PlatformDependent.directBufferAddress(allocateDirect);
            }
        } catch (Throwable th) {
        }
    ...
    public EmptyByteBuf(ByteBufAllocator alloc2) {
        this(alloc2, ByteOrder.BIG_ENDIAN);
    }

    private EmptyByteBuf(ByteBufAllocator alloc2, ByteOrder order2) {
        if (alloc2 != null) {
            this.alloc = alloc2;
            this.order = order2;
            StringBuilder sb = new StringBuilder();
            sb.append(StringUtil.simpleClassName((Object) this));
            sb.append(order2 == ByteOrder.BIG_ENDIAN ? "BE" : "LE");
    ...
    public ByteBuf order(ByteOrder endianness) {
        if (endianness == null) {
            ...
            EmptyByteBuf swapped2 = this.swapped;
            if (swapped2 != null) {
                return swapped2;
            }
            EmptyByteBuf emptyByteBuf = new EmptyByteBuf(alloc(), endianness);
            EmptyByteBuf swapped3 = emptyByteBuf;
            this.swapped = emptyByteBuf;
            return swapped3;
        }
    }
