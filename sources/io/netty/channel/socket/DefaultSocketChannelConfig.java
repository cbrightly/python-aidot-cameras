...
public class DefaultSocketChannelConfig extends DefaultChannelConfig implements SocketChannelConfig {
    ...
    public DefaultSocketChannelConfig(SocketChannel channel, Socket javaSocket2) {
        super(channel);
        if (javaSocket2 != null) {
    ...
    public SocketChannelConfig setAllowHalfClosure(boolean allowHalfClosure2) {
        this.allowHalfClosure = allowHalfClosure2;
        return this;
    }
