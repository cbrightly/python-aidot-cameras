...
public abstract class BaseLinkedAtomicQueue<E> extends BaseLinkedAtomicQueuePad2<E> {
    ...
    /* access modifiers changed from: protected */
    public E getSingleConsumerNodeValue(LinkedQueueAtomicNode<E> currConsumerNode, LinkedQueueAtomicNode<E> nextNode) {
    ...
    public int drain(MessagePassingQueue.Consumer<E> c) {
        ...
        do {
            ...
            result += (long) drained;
            if (drained != 4096 || result > 2147479551) {
            }
            int drained2 = drain(c, 4096);
            result += (long) drained2;
            break;
