...
public final class ReplayingDecoderByteBuf extends ByteBuf {
    ...
    ReplayingDecoderByteBuf(ByteBuf buffer2) {
        setCumulation(buffer2);
    }

    /* access modifiers changed from: package-private */
    public void setCumulation(ByteBuf buffer2) {
        this.buffer = buffer2;
    }
    ...
    public int compareTo(ByteBuf buffer2) {
        reject();
        return 0;
    }
    ...
    public ByteBuf order(ByteOrder endianness) {
        if (endianness == null) {
            ...
            SwappedByteBuf swapped2 = this.swapped;
            if (swapped2 != null) {
                return swapped2;
            }
            SwappedByteBuf swappedByteBuf = new SwappedByteBuf(this);
            SwappedByteBuf swapped3 = swappedByteBuf;
    ...
    public String toString() {
        return StringUtil.simpleClassName((Object) this) + '(' + "ridx=" + readerIndex() + ", widx=" + writerIndex() + ')';
    }
