...
public final class ZlibCodecFactory {
    ...
    static {
        InternalLogger instance = InternalLoggerFactory.getInstance((Class<?>) ZlibCodecFactory.class);
        logger = instance;
        boolean z = SystemPropertyUtil.getBoolean("io.netty.noJdkZlibDecoder", PlatformDependent.javaVersion() < 7);
        noJdkZlibDecoder = z;
        instance.debug("-Dio.netty.noJdkZlibDecoder: {}", (Object) Boolean.valueOf(z));
        boolean z2 = SystemPropertyUtil.getBoolean("io.netty.noJdkZlibEncoder", false);
        noJdkZlibEncoder = z2;
        instance.debug("-Dio.netty.noJdkZlibEncoder: {}", (Object) Boolean.valueOf(z2));
    }
