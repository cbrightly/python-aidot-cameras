...
public final class ReferenceCountedOpenSslClientContext extends ReferenceCountedOpenSslContext {
    ...
    public static final InternalLogger logger = InternalLoggerFactory.getInstance((Class<?>) ReferenceCountedOpenSslClientContext.class);
            ...
            try {
                if (OpenSsl.useKeyManagerFactory()) {
                    ...
                    if (keyManagerFactory != null) {
                        X509KeyManager keyManager = ReferenceCountedOpenSslContext.chooseX509KeyManager(keyManagerFactory.getKeyManagers());
                        SSLContext.setCertRequestedCallback(ctx, new OpenSslCertificateRequestedCallback(engineMap, ReferenceCountedOpenSslContext.useExtendedKeyManager(keyManager) ? new OpenSslExtendedKeyMaterialManager((X509ExtendedKeyManager) keyManager, keyPassword) : new OpenSslKeyMaterialManager(keyManager, keyPassword)));
                    }
                ...
                X509TrustManager manager = ReferenceCountedOpenSslContext.chooseTrustManager(trustManagerFactory.getTrustManagers());
    ...
    public static final class OpenSslCertificateRequestedCallback implements CertificateRequestedCallback {
        ...
        OpenSslCertificateRequestedCallback(OpenSslEngineMap engineMap2, OpenSslKeyMaterialManager keyManagerHolder2) {
            this.engineMap = engineMap2;
            this.keyManagerHolder = keyManagerHolder2;
        }
