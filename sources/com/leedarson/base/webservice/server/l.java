...
/* compiled from: PageControllerIndexHandler */
public final class l extends c {
    public static ChangeQuickRedirect changeQuickRedirect;
    private Object l;

    public l(Object host, b mapping, a addition, com.yanzhenjie.andserver.framework.cross.a crossOrigin) {
    ...
    public com.yanzhenjie.andserver.framework.view.c g(com.yanzhenjie.andserver.http.c request, d dVar) {
        PatchProxyResult proxy = PatchProxy.proxy(new Object[]{request, dVar}, this, changeQuickRedirect, false, 976, new Class[]{com.yanzhenjie.andserver.http.c.class, d.class}, com.yanzhenjie.andserver.framework.view.c.class);
        ...
        return new com.yanzhenjie.andserver.framework.view.b(false, ((h) this.l).c());
    }
}
