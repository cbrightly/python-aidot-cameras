...
/* compiled from: FileControllerDeviceLogUpLoadHandler */
public final class g extends c {
    public static ChangeQuickRedirect changeQuickRedirect;
    private Object l;

    public g(Object host, b mapping, a addition, com.yanzhenjie.andserver.framework.cross.a crossOrigin) {
    ...
    public com.yanzhenjie.andserver.framework.view.c g(com.yanzhenjie.andserver.http.c request, d dVar) {
        PatchProxyResult proxy = PatchProxy.proxy(new Object[]{request, dVar}, this, changeQuickRedirect, false, 972, new Class[]{com.yanzhenjie.andserver.http.c.class, d.class}, com.yanzhenjie.andserver.framework.view.c.class);
        ...
        com.yanzhenjie.andserver.http.multipart.c multiRequest = null;
        if (request instanceof com.yanzhenjie.andserver.http.multipart.c) {
            multiRequest = (com.yanzhenjie.andserver.http.multipart.c) request;
        }
        if (httpMethod.allowBody()) {
            f requestBody = request.z();
        }
        Map<String, String> d = d(httpPath);
        com.yanzhenjie.andserver.http.multipart.b param0 = null;
        if (multiRequest != null) {
            param0 = multiRequest.a("file");
        }
        if (param0 != null) {
            return new com.yanzhenjie.andserver.framework.view.b(true, ((e) this.l).a(param0));
        }
