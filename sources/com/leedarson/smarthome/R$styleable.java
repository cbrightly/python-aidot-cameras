...
public final class R$styleable {
    ...
    public static final int[] DkDropDownMenu = {R.attr.dk_dddividerColor, R.attr.dk_dddividerHeight, R.attr.dk_ddmaskColor, R.attr.dk_ddmenuBackgroundColor, R.attr.dk_ddmenuIconOrientation, R.attr.dk_ddmenuSelectedIcon, R.attr.dk_ddmenuTextSize, R.attr.dk_ddmenuUnselectedIcon, R.attr.dk_ddtextSelectedColor, R.attr.dk_ddtextUnselectedColor, R.attr.dk_ddunderlineColor};
    ...
    public static final int[] DownloadProgressButton = {R.attr.progress_border_color, R.attr.progress_btn_background_color, R.attr.progress_btn_background_second_color, R.attr.progress_btn_ball_style, R.attr.progress_btn_border_width, R.attr.progress_btn_radius, R.attr.progress_btn_text_color, R.attr.progress_btn_text_cover_color};
    public static final int DownloadProgressButton_progress_border_color = 0;
    ...
    public static final int DownloadProgressButton_progress_btn_ball_style = 3;
    public static final int DownloadProgressButton_progress_btn_border_width = 4;
    ...
    public static final int[] GradientPTZCtrlView = {R.attr.bgColor, R.attr.gptz_bmp_margin, R.attr.gptz_bmp_size, R.attr.gptz_stroke_width, R.attr.iconColor, R.attr.strokeColor};
    public static final int GradientPTZCtrlView_bgColor = 0;
    public static final int GradientPTZCtrlView_gptz_bmp_margin = 1;
    public static final int GradientPTZCtrlView_gptz_bmp_size = 2;
    public static final int GradientPTZCtrlView_gptz_stroke_width = 3;
    public static final int GradientPTZCtrlView_iconColor = 4;
    public static final int GradientPTZCtrlView_strokeColor = 5;
    public static final int[] HomeTitleBar = {R.attr.dkIcon, R.attr.dkTitle};
    public static final int HomeTitleBar_dkIcon = 0;
    public static final int HomeTitleBar_dkTitle = 1;
    public static final int[] IJKPlayBackPlayerView = {R.attr.surface_type};
    public static final int IJKPlayBackPlayerView_surface_type = 0;
    ...
    public static final int[] LabelTextView = {R.attr.dkLabel, R.attr.dkMaxLines, R.attr.dkText};
    ...
    public static final int[] LiveCameraView = {R.attr.viewMode};
    public static final int LiveCameraView_viewMode = 0;
    ...
    public static final int[] LogTitleBar = {R.attr.dkBack, R.attr.dkIcon, R.attr.dkTitle};
    ...
    public static final int[] PTZCtrlView = {R.attr.ptz_bmp_margin, R.attr.ptz_bmp_size, R.attr.ptz_stroke_width};
    public static final int PTZCtrlView_ptz_bmp_margin = 0;
    public static final int PTZCtrlView_ptz_bmp_size = 1;
    public static final int PTZCtrlView_ptz_stroke_width = 2;
    ...
    public static final int[] TitleBar = {R.attr.backButton, R.attr.barStyle, R.attr.dkLeftIcon, R.attr.dkLeftText, R.attr.dkRightIcon, R.attr.dkRightSubIcon, R.attr.dkRightText, R.attr.dkTitle, R.attr.dkTitleBackground, R.attr.dkTitleColor, R.attr.leftBackground, R.attr.leftColor, R.attr.leftIcon, R.attr.leftSize, R.attr.leftTitle, R.attr.lineColor, R.attr.lineSize, R.attr.lineVisible, R.attr.rightBackground, R.attr.rightColor, R.attr.rightIcon, R.attr.rightSize, R.attr.rightTitle, R.attr.title, R.attr.titleColor, R.attr.titleSize};
    ...
    public static final int[] ViewfinderView = {R.attr.cornerColor, R.attr.cornerRectHeight, R.attr.cornerRectWidth, R.attr.dkCornerColor, R.attr.dkFrameColor, R.attr.dkLabelText, R.attr.dkLabelTextColor, R.attr.dkLabelTextSize, R.attr.dkLaserColor, R.attr.dkMaskColor, R.attr.dkResultColor, R.attr.dkResultPointColor, R.attr.frameColor, R.attr.frameHeight, R.attr.frameLineWidth, R.attr.frameRatio, R.attr.frameWidth, R.attr.gridColumn, R.attr.gridHeight, R.attr.inner_corner_color, R.attr.inner_corner_length, R.attr.inner_corner_width, R.attr.inner_height, R.attr.inner_margintop, R.attr.inner_scan_bitmap, R.attr.inner_scan_iscircle, R.attr.inner_scan_speed, R.attr.inner_width, R.attr.labelText, R.attr.labelTextColor, R.attr.labelTextLocation, R.attr.labelTextPadding, R.attr.labelTextSize, R.attr.laserColor, R.attr.laserStyle, R.attr.maskColor, R.attr.resultPointColor, R.attr.scannerAnimationDelay, R.attr.scannerLineHeight, R.attr.scannerLineMoveDistance, R.attr.showResultPoint};
    ...
    public static final int[] WeekCalendar = {R.attr.cornerMarkBg, R.attr.daysSelectedBackground, R.attr.daysSelectedTextColor, R.attr.daysTextColor, R.attr.daysTextSize, R.attr.hideTodayName, R.attr.isCornerMark, R.attr.isShowMonth, R.attr.monthBackgroundColor, R.attr.monthTextColor, R.attr.nextArrowBg, R.attr.preArrowBg, R.attr.todayTextColor, R.attr.weekBackgroundColor, R.attr.weekTextColor, R.attr.weekTextSize};
    public static final int WeekCalendar_cornerMarkBg = 0;
    public static final int WeekCalendar_daysSelectedBackground = 1;
    public static final int WeekCalendar_daysSelectedTextColor = 2;
    public static final int WeekCalendar_daysTextColor = 3;
    public static final int WeekCalendar_daysTextSize = 4;
    public static final int WeekCalendar_hideTodayName = 5;
    public static final int WeekCalendar_isCornerMark = 6;
    public static final int WeekCalendar_isShowMonth = 7;
    public static final int WeekCalendar_monthBackgroundColor = 8;
    public static final int WeekCalendar_monthTextColor = 9;
    public static final int WeekCalendar_nextArrowBg = 10;
    public static final int WeekCalendar_preArrowBg = 11;
    public static final int WeekCalendar_todayTextColor = 12;
    public static final int WeekCalendar_weekBackgroundColor = 13;
    public static final int WeekCalendar_weekTextColor = 14;
    public static final int WeekCalendar_weekTextSize = 15;
    public static final int[] dk_multi_line_radio_group = {R.attr.default_button, R.attr.max_in_row, R.attr.radio_buttons};
