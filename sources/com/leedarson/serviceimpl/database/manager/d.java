...
public class d {
    ...
    public static String b(Object object) {
        PatchProxyResult proxy = PatchProxy.proxy(new Object[]{object}, (Object) null, changeQuickRedirect, true, 7866, new Class[]{Object.class}, String.class);
    ...
    public class a implements JsonSerializer<Double> {
        ...
        public /* bridge */ /* synthetic */ JsonElement serialize(Object obj, Type type, JsonSerializationContext jsonSerializationContext) {
            PatchProxyResult proxy = PatchProxy.proxy(new Object[]{obj, type, jsonSerializationContext}, this, changeQuickRedirect, false, 7871, new Class[]{Object.class, Type.class, JsonSerializationContext.class}, JsonElement.class);
        ...
        public JsonElement a(Double src, Type type, JsonSerializationContext jsonSerializationContext) {
            ...
            PatchProxyResult proxy = PatchProxy.proxy(new Object[]{src, type, jsonSerializationContext}, this, changeQuickRedirect2, false, 7870, new Class[]{Double.class, Type.class, JsonSerializationContext.class}, JsonElement.class);
            if (proxy.isSupported) {
    ...
    public static LinkedTreeMap a(String jsonData) {
        PatchProxyResult proxy = PatchProxy.proxy(new Object[]{jsonData}, (Object) null, changeQuickRedirect, true, 7869, new Class[]{String.class}, LinkedTreeMap.class);
        if (proxy.isSupported) {
