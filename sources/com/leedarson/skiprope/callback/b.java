...
public abstract class b implements BleC075Service.CommonBleCallback {
    ...
    public void onWriteSuccess(int current, int total, byte[] justWrite, String callbackKey, String str) {
        ...
        if (!PatchProxy.proxy(objArr, this, changeQuickRedirect2, false, 9509, new Class[]{cls2, cls2, byte[].class, cls, cls}, Void.TYPE).isSupported) {
    ...
    public void onWriteFailure(Exception exception, String callbackKey, String str, int i) {
        ...
        ChangeQuickRedirect changeQuickRedirect2 = changeQuickRedirect;
        if (!PatchProxy.proxy(objArr, this, changeQuickRedirect2, false, 9510, new Class[]{Exception.class, cls, cls, Integer.TYPE}, Void.TYPE).isSupported) {
