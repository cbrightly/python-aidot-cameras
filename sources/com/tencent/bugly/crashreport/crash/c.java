...
public final class c {
    ...
    private c(int i2, Context context, w wVar, boolean z, BuglyStrategy.a aVar, o oVar, String str) {
        ...
        this.q = a2;
        this.v = wVar;
        b bVar = new b(i2, a2, u.a(), p.a(), this.u, aVar, oVar);
        this.p = bVar;
        com.tencent.bugly.crashreport.common.info.a a3 = com.tencent.bugly.crashreport.common.info.a.a(a2);
        this.s = new e(a2, bVar, this.u, a3);
        w wVar2 = wVar;
        NativeCrashHandler instance = NativeCrashHandler.getInstance(a2, a3, bVar, this.u, wVar2, z, str);
        this.t = instance;
        a3.D = instance;
        this.w = new b(a2, this.u, a3, wVar2, bVar);
    }
