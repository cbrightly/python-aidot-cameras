...
public class SceneDeleteMessage extends GenericMessage {
    ...
    public static SceneDeleteMessage I(int address, int appKeyIndex, int sceneNumber, boolean ack, int rspMax) {
        ...
        PatchProxyResult proxy = PatchProxy.proxy(objArr, (Object) null, changeQuickRedirect2, true, 12758, new Class[]{cls, cls, cls, Boolean.TYPE, cls}, SceneDeleteMessage.class);
        if (proxy.isSupported) {
            return (SceneDeleteMessage) proxy.result;
        }
    ...
    public int k() {
        return (this.u ? Opcode.SCENE_DEL : Opcode.SCENE_DEL_NOACK).value;
    }
