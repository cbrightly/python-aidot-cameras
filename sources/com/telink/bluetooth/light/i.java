...
public enum i {
    ...
    private i(byte value2, @Nullable String info2) {
        this.value = value2;
        this.info = info2;
    }

    public static i valueOf(byte value2) {
        PatchProxyResult proxy = PatchProxy.proxy(new Object[]{new Byte(value2)}, (Object) null, changeQuickRedirect, true, 13834, new Class[]{Byte.TYPE}, i.class);
        if (proxy.isSupported) {
            return (i) proxy.result;
        }
        byte value3 = (byte) (value2 & 255);
        for (i opcode : values()) {
            if (opcode.getValue() == value3) {
                return opcode;
            }
        }
        return null;
