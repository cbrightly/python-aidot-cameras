...
public class JsonPolicyReader {
    ...
    private Statement statementOf(AwsJsonReader reader2) {
    ...
    private List<Action> actionsOf(AwsJsonReader reader2) {
    ...
    private List<Resource> resourcesOf(AwsJsonReader reader2) {
    ...
    private List<Principal> principalOf(AwsJsonReader reader2) {
    ...
    private List<Condition> conditionsOf(AwsJsonReader reader2) {
    ...
    private void convertConditionRecord(List<Condition> conditions, String conditionType, AwsJsonReader reader2) {
        reader2.beginObject();
        while (reader2.hasNext()) {
            String name = reader2.nextName();
