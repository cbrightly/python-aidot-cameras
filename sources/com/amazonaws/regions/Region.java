...
public final class Region {
    ...
    public <T extends AmazonWebServiceClient> T createClient(Class<T> serviceClass, AWSCredentialsProvider credentials, ClientConfiguration config) {
        ...
        Class<ClientConfiguration> cls2 = ClientConfiguration.class;
        if (credentials == null && config == null) {
            ...
            client = (AmazonWebServiceClient) serviceClass.getConstructor(new Class[]{cls2}).newInstance(new Object[]{config});
        } else if (config == null) {
            client = (AmazonWebServiceClient) serviceClass.getConstructor(new Class[]{cls}).newInstance(new Object[]{credentials});
        } else {
            client = (AmazonWebServiceClient) serviceClass.getConstructor(new Class[]{cls, cls2}).newInstance(new Object[]{credentials, config});
        }
