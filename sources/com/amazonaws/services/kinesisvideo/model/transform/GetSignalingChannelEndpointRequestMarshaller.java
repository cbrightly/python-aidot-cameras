...
public class GetSignalingChannelEndpointRequestMarshaller implements Marshaller<Request<GetSignalingChannelEndpointRequest>, GetSignalingChannelEndpointRequest> {
    public Request<GetSignalingChannelEndpointRequest> marshall(GetSignalingChannelEndpointRequest getSignalingChannelEndpointRequest) {
        if (getSignalingChannelEndpointRequest != null) {
            Request<GetSignalingChannelEndpointRequest> request = new DefaultRequest<>(getSignalingChannelEndpointRequest, "AWSKinesisVideo");
            request.setHttpMethod(HttpMethodName.POST);
            request.setResourcePath("/getSignalingChannelEndpoint");
            try {
