...
public class AWSSecurityTokenServiceClient extends AmazonWebServiceClient implements AWSSecurityTokenService {
    ...
    public AssumeRoleResult assumeRole(AssumeRoleRequest assumeRoleRequest) {
        ...
        try {
            ...
            AssumeRoleResult awsResponse = response.getAwsResponse();
    ...
    public AssumeRoleWithSAMLResult assumeRoleWithSAML(AssumeRoleWithSAMLRequest assumeRoleWithSAMLRequest) {
        ExecutionContext executionContext = createExecutionContext((AmazonWebServiceRequest) assumeRoleWithSAMLRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        AWSRequestMetrics.Field field = AWSRequestMetrics.Field.ClientExecuteTime;
        awsRequestMetrics.startEvent((MetricType) field);
        ...
        try {
            ...
            AssumeRoleWithSAMLResult awsResponse = response.getAwsResponse();
            awsRequestMetrics.endEvent((MetricType) field);
            endClientExecution(awsRequestMetrics, request, response);
            return awsResponse;
        } catch (Throwable th) {
    ...
    public AssumeRoleWithWebIdentityResult assumeRoleWithWebIdentity(AssumeRoleWithWebIdentityRequest assumeRoleWithWebIdentityRequest) {
        ...
        try {
            ...
            AssumeRoleWithWebIdentityResult awsResponse = response.getAwsResponse();
            awsRequestMetrics.endEvent((MetricType) field);
            endClientExecution(awsRequestMetrics, request, response);
            return awsResponse;
        } catch (Throwable th) {
    ...
    public DecodeAuthorizationMessageResult decodeAuthorizationMessage(DecodeAuthorizationMessageRequest decodeAuthorizationMessageRequest) {
        ExecutionContext executionContext = createExecutionContext((AmazonWebServiceRequest) decodeAuthorizationMessageRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        AWSRequestMetrics.Field field = AWSRequestMetrics.Field.ClientExecuteTime;
        awsRequestMetrics.startEvent((MetricType) field);
        ...
        try {
            ...
            DecodeAuthorizationMessageResult awsResponse = response.getAwsResponse();
            awsRequestMetrics.endEvent((MetricType) field);
            endClientExecution(awsRequestMetrics, request, response);
            return awsResponse;
        } catch (Throwable th) {
    ...
    public GetAccessKeyInfoResult getAccessKeyInfo(GetAccessKeyInfoRequest getAccessKeyInfoRequest) {
        ExecutionContext executionContext = createExecutionContext((AmazonWebServiceRequest) getAccessKeyInfoRequest);
        AWSRequestMetrics awsRequestMetrics = executionContext.getAwsRequestMetrics();
        AWSRequestMetrics.Field field = AWSRequestMetrics.Field.ClientExecuteTime;
        awsRequestMetrics.startEvent((MetricType) field);
        ...
        try {
            ...
            request.setAWSRequestMetrics(awsRequestMetrics);
            response = invoke(request, new GetAccessKeyInfoResultStaxUnmarshaller(), executionContext);
            GetAccessKeyInfoResult awsResponse = response.getAwsResponse();
            awsRequestMetrics.endEvent((MetricType) field);
            endClientExecution(awsRequestMetrics, request, response);
            return awsResponse;
        } catch (Throwable th) {
    ...
    public GetCallerIdentityResult getCallerIdentity(GetCallerIdentityRequest getCallerIdentityRequest) {
        ...
        try {
            ...
            GetCallerIdentityResult awsResponse = response.getAwsResponse();
            awsRequestMetrics.endEvent((MetricType) field);
            endClientExecution(awsRequestMetrics, request, response);
            return awsResponse;
        } catch (Throwable th) {
    ...
    public GetFederationTokenResult getFederationToken(GetFederationTokenRequest getFederationTokenRequest) {
        ...
        try {
            ...
            GetFederationTokenResult awsResponse = response.getAwsResponse();
            awsRequestMetrics.endEvent((MetricType) field);
            endClientExecution(awsRequestMetrics, request, response);
            return awsResponse;
        } catch (Throwable th) {
    ...
    public GetSessionTokenResult getSessionToken(GetSessionTokenRequest getSessionTokenRequest) {
        ...
        try {
            ...
            GetSessionTokenResult awsResponse = response.getAwsResponse();
            awsRequestMetrics.endEvent((MetricType) field);
            endClientExecution(awsRequestMetrics, request, response);
            return awsResponse;
        } catch (Throwable th) {
