...
public class GetFederationTokenResult implements Serializable {
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = ((((1 * 31) + (getCredentials() == null ? 0 : getCredentials().hashCode())) * 31) + (getFederatedUser() == null ? 0 : getFederatedUser().hashCode())) * 31;
        if (getPackedPolicySize() != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if ((other.getFederatedUser() == null) ^ (getFederatedUser() == null)) {
            return false;
        }
