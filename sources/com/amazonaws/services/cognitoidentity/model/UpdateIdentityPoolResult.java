...
public class UpdateIdentityPoolResult implements Serializable {
    ...
    public UpdateIdentityPoolResult withIdentityPoolId(String identityPoolId2) {
        this.identityPoolId = identityPoolId2;
        return this;
    }
    ...
    public UpdateIdentityPoolResult withIdentityPoolName(String identityPoolName2) {
        this.identityPoolName = identityPoolName2;
        return this;
    }
    ...
    public UpdateIdentityPoolResult withAllowUnauthenticatedIdentities(Boolean allowUnauthenticatedIdentities2) {
        this.allowUnauthenticatedIdentities = allowUnauthenticatedIdentities2;
        return this;
    }
    ...
    public UpdateIdentityPoolResult withAllowClassicFlow(Boolean allowClassicFlow2) {
        this.allowClassicFlow = allowClassicFlow2;
        return this;
    }
    ...
    public UpdateIdentityPoolResult withSupportedLoginProviders(Map<String, String> supportedLoginProviders2) {
        this.supportedLoginProviders = supportedLoginProviders2;
        return this;
    }
    ...
    public UpdateIdentityPoolResult withDeveloperProviderName(String developerProviderName2) {
        this.developerProviderName = developerProviderName2;
        return this;
    }
    ...
    public UpdateIdentityPoolResult withOpenIdConnectProviderARNs(String... openIdConnectProviderARNs2) {
    ...
    public UpdateIdentityPoolResult withOpenIdConnectProviderARNs(Collection<String> openIdConnectProviderARNs2) {
    ...
    public UpdateIdentityPoolResult withCognitoIdentityProviders(CognitoIdentityProvider... cognitoIdentityProviders2) {
    ...
    public UpdateIdentityPoolResult withCognitoIdentityProviders(Collection<CognitoIdentityProvider> cognitoIdentityProviders2) {
    ...
    public UpdateIdentityPoolResult withSamlProviderARNs(String... samlProviderARNs2) {
    ...
    public UpdateIdentityPoolResult withSamlProviderARNs(Collection<String> samlProviderARNs2) {
    ...
    public UpdateIdentityPoolResult withIdentityPoolTags(Map<String, String> identityPoolTags2) {
        this.identityPoolTags = identityPoolTags2;
        return this;
    }

    public UpdateIdentityPoolResult addIdentityPoolTagsEntry(String key, String value) {
