...
public class CreateIdentityPoolRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public CreateIdentityPoolRequest withIdentityPoolName(String identityPoolName2) {
        this.identityPoolName = identityPoolName2;
        return this;
    }
    ...
    public CreateIdentityPoolRequest withAllowUnauthenticatedIdentities(Boolean allowUnauthenticatedIdentities2) {
        this.allowUnauthenticatedIdentities = allowUnauthenticatedIdentities2;
        return this;
    }
    ...
    public CreateIdentityPoolRequest withAllowClassicFlow(Boolean allowClassicFlow2) {
        this.allowClassicFlow = allowClassicFlow2;
        return this;
    }
    ...
    public CreateIdentityPoolRequest withSupportedLoginProviders(Map<String, String> supportedLoginProviders2) {
        this.supportedLoginProviders = supportedLoginProviders2;
        return this;
    }
    ...
    public CreateIdentityPoolRequest withDeveloperProviderName(String developerProviderName2) {
        this.developerProviderName = developerProviderName2;
        return this;
    }
    ...
    public CreateIdentityPoolRequest withOpenIdConnectProviderARNs(String... openIdConnectProviderARNs2) {
    ...
    public CreateIdentityPoolRequest withOpenIdConnectProviderARNs(Collection<String> openIdConnectProviderARNs2) {
    ...
    public CreateIdentityPoolRequest withCognitoIdentityProviders(CognitoIdentityProvider... cognitoIdentityProviders2) {
    ...
    public CreateIdentityPoolRequest withCognitoIdentityProviders(Collection<CognitoIdentityProvider> cognitoIdentityProviders2) {
    ...
    public CreateIdentityPoolRequest withSamlProviderARNs(String... samlProviderARNs2) {
    ...
    public CreateIdentityPoolRequest withSamlProviderARNs(Collection<String> samlProviderARNs2) {
    ...
    public CreateIdentityPoolRequest withIdentityPoolTags(Map<String, String> identityPoolTags2) {
        this.identityPoolTags = identityPoolTags2;
        return this;
    }
    ...
    public int hashCode() {
        ...
        int i4;
        int i5 = 0;
        int hashCode = ((1 * 31) + (getIdentityPoolName() == null ? 0 : getIdentityPoolName().hashCode())) * 31;
        if (getAllowUnauthenticatedIdentities() == null) {
            i = 0;
        } else {
