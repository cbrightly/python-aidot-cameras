...
public class UpdateIdentityPoolRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public UpdateIdentityPoolRequest withIdentityPoolId(String identityPoolId2) {
        this.identityPoolId = identityPoolId2;
        return this;
    }
    ...
    public UpdateIdentityPoolRequest withIdentityPoolName(String identityPoolName2) {
        this.identityPoolName = identityPoolName2;
        return this;
    }
    ...
    public UpdateIdentityPoolRequest withAllowUnauthenticatedIdentities(Boolean allowUnauthenticatedIdentities2) {
        this.allowUnauthenticatedIdentities = allowUnauthenticatedIdentities2;
        return this;
    }
    ...
    public UpdateIdentityPoolRequest withAllowClassicFlow(Boolean allowClassicFlow2) {
        this.allowClassicFlow = allowClassicFlow2;
        return this;
    }
    ...
    public UpdateIdentityPoolRequest withSupportedLoginProviders(Map<String, String> supportedLoginProviders2) {
        this.supportedLoginProviders = supportedLoginProviders2;
        return this;
    }
    ...
    public UpdateIdentityPoolRequest withDeveloperProviderName(String developerProviderName2) {
        this.developerProviderName = developerProviderName2;
        return this;
    }
    ...
    public UpdateIdentityPoolRequest withOpenIdConnectProviderARNs(String... openIdConnectProviderARNs2) {
    ...
    public UpdateIdentityPoolRequest withOpenIdConnectProviderARNs(Collection<String> openIdConnectProviderARNs2) {
    ...
    public UpdateIdentityPoolRequest withCognitoIdentityProviders(CognitoIdentityProvider... cognitoIdentityProviders2) {
    ...
    public UpdateIdentityPoolRequest withCognitoIdentityProviders(Collection<CognitoIdentityProvider> cognitoIdentityProviders2) {
    ...
    public UpdateIdentityPoolRequest withSamlProviderARNs(String... samlProviderARNs2) {
    ...
    public UpdateIdentityPoolRequest withSamlProviderARNs(Collection<String> samlProviderARNs2) {
    ...
    public UpdateIdentityPoolRequest withIdentityPoolTags(Map<String, String> identityPoolTags2) {
        this.identityPoolTags = identityPoolTags2;
        return this;
    }
