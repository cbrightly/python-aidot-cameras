...
public class IdentityDescription implements Serializable {
    ...
    public IdentityDescription withIdentityId(String identityId2) {
        this.identityId = identityId2;
        return this;
    }
    ...
    public IdentityDescription withLogins(String... logins2) {
        if (getLogins() == null) {
    ...
    public IdentityDescription withLogins(Collection<String> logins2) {
        setLogins(logins2);
        return this;
    }
    ...
    public IdentityDescription withCreationDate(Date creationDate2) {
        this.creationDate = creationDate2;
        return this;
    }
    ...
    public IdentityDescription withLastModifiedDate(Date lastModifiedDate2) {
        this.lastModifiedDate = lastModifiedDate2;
        return this;
    }
