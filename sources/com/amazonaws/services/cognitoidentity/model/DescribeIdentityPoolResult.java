...
public class DescribeIdentityPoolResult implements Serializable {
    ...
    public DescribeIdentityPoolResult withIdentityPoolId(String identityPoolId2) {
        this.identityPoolId = identityPoolId2;
        return this;
    }
    ...
    public DescribeIdentityPoolResult withIdentityPoolName(String identityPoolName2) {
        this.identityPoolName = identityPoolName2;
        return this;
    }
    ...
    public DescribeIdentityPoolResult withAllowUnauthenticatedIdentities(Boolean allowUnauthenticatedIdentities2) {
        this.allowUnauthenticatedIdentities = allowUnauthenticatedIdentities2;
        return this;
    }
    ...
    public DescribeIdentityPoolResult withAllowClassicFlow(Boolean allowClassicFlow2) {
        this.allowClassicFlow = allowClassicFlow2;
        return this;
    }
    ...
    public DescribeIdentityPoolResult withSupportedLoginProviders(Map<String, String> supportedLoginProviders2) {
        this.supportedLoginProviders = supportedLoginProviders2;
        return this;
    }
    ...
    public DescribeIdentityPoolResult withDeveloperProviderName(String developerProviderName2) {
        this.developerProviderName = developerProviderName2;
        return this;
    }
    ...
    public DescribeIdentityPoolResult withOpenIdConnectProviderARNs(String... openIdConnectProviderARNs2) {
    ...
    public DescribeIdentityPoolResult withOpenIdConnectProviderARNs(Collection<String> openIdConnectProviderARNs2) {
    ...
    public DescribeIdentityPoolResult withCognitoIdentityProviders(CognitoIdentityProvider... cognitoIdentityProviders2) {
    ...
    public DescribeIdentityPoolResult withCognitoIdentityProviders(Collection<CognitoIdentityProvider> cognitoIdentityProviders2) {
    ...
    public DescribeIdentityPoolResult withSamlProviderARNs(String... samlProviderARNs2) {
    ...
    public DescribeIdentityPoolResult withSamlProviderARNs(Collection<String> samlProviderARNs2) {
    ...
    public DescribeIdentityPoolResult withIdentityPoolTags(Map<String, String> identityPoolTags2) {
        this.identityPoolTags = identityPoolTags2;
        return this;
    }
