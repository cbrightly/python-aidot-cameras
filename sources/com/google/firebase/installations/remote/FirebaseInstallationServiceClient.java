...
public class FirebaseInstallationServiceClient {
    ...
    public FirebaseInstallationServiceClient(@NonNull Context context2, @NonNull Provider<HeartBeatController> heartBeatProvider2) {
        this.context = context2;
        this.heartBeatProvider = heartBeatProvider2;
    }

    @NonNull
    public InstallationResponse createFirebaseInstallation(@NonNull String apiKey, @Nullable String fid, @NonNull String projectID, @NonNull String appId, @Nullable String iidToken) {
    ...
    private void writeFIDCreateRequestBodyToOutputStream(HttpURLConnection httpURLConnection, @Nullable String fid, @NonNull String appId) {
    ...
    private static JSONObject buildCreateFirebaseInstallationRequestBody(@Nullable String fid, @NonNull String appId) {
        try {
            ...
            firebaseInstallationData.put("sdkVersion", (Object) "a:17.1.3");
    ...
    private static JSONObject buildGenerateAuthTokenRequestBody() {
        try {
            ...
            sdkVersionData.put("sdkVersion", (Object) "a:17.1.3");
            JSONObject firebaseInstallationData = new JSONObject();
    ...
    @NonNull
    public void deleteFirebaseInstallation(@NonNull String apiKey, @NonNull String fid, @NonNull String projectID, @NonNull String refreshToken) {
    ...
    @NonNull
    public TokenResult generateAuthToken(@NonNull String apiKey, @NonNull String fid, @NonNull String projectID, @NonNull String refreshToken) {
        if (this.requestLimiter.isRequestAllowed()) {
