...
public final class AutoValue_PersistedInstallationEntry extends PersistedInstallationEntry {
    ...
    private AutoValue_PersistedInstallationEntry(@Nullable String firebaseInstallationId2, PersistedInstallation.RegistrationStatus registrationStatus2, @Nullable String authToken2, @Nullable String refreshToken2, long expiresInSecs2, long tokenCreationEpochInSecs2, @Nullable String fisError2) {
    ...
    public static final class Builder extends PersistedInstallationEntry.Builder {
        ...
        public PersistedInstallationEntry.Builder setAuthToken(@Nullable String authToken2) {
            this.authToken = authToken2;
            return this;
        }

        public PersistedInstallationEntry.Builder setRefreshToken(@Nullable String refreshToken2) {
            this.refreshToken = refreshToken2;
            return this;
        }
        ...
        public PersistedInstallationEntry.Builder setFisError(@Nullable String fisError2) {
            this.fisError = fisError2;
            return this;
        }
