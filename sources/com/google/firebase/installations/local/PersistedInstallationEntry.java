...
public abstract class PersistedInstallationEntry {
    ...
    @NonNull
    public PersistedInstallationEntry withRegisteredFid(@NonNull String fid, @NonNull String refreshToken, long creationTime, @Nullable String authToken, long authTokenExpiration) {
