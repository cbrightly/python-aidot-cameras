...
public final class FirebaseAnalytics {
    ...
    @Keep
    @Nullable
    public static zzik getScionFrontendApiImplementation(Context context, @Nullable Bundle extraParams) {
        zzef zzg = zzef.zzg(context, (String) null, (String) null, (String) null, extraParams);
        if (zzg == null) {
            return null;
        }
        return new zzd(zzg);
    ...
    public void logEvent(@Size(max = 40, min = 1) @NonNull String name, @Nullable Bundle params) {
        this.zzb.zzy(name, params);
    }
    ...
    public void setAnalyticsCollectionEnabled(boolean enabled) {
        this.zzb.zzL(Boolean.valueOf(enabled));
    }
    ...
    public void setUserProperty(@Size(max = 24, min = 1) @NonNull String name, @Size(max = 36) @Nullable String value) {
        this.zzb.zzO((String) null, name, value, false);
    }
}
