...
public final class WakeLockHolder {
    ...
    static android.content.ComponentName startWakefulService(@androidx.annotation.NonNull android.content.Context r6, @androidx.annotation.NonNull android.content.Intent r7) {
        /*
            java.lang.Object r0 = syncObject
            monitor-enter(r0)
            checkAndInitWakeLock(r6)     // Catch:{ all -> 0x0022 }
            boolean r1 = isWakefulIntent(r7)     // Catch:{ all -> 0x0022 }
            r2 = 1
            setAsWakefulIntent(r7, r2)     // Catch:{ all -> 0x0022 }
            android.content.ComponentName r2 = r6.startService(r7)     // Catch:{ all -> 0x0022 }
        ...
        L_0x0017:
            ...
            com.google.android.gms.stats.WakeLock r3 = wakeLock     // Catch:{ all -> 0x0022 }
            long r4 = WAKE_LOCK_ACQUIRE_TIMEOUT_MILLIS     // Catch:{ all -> 0x0022 }
            r3.acquire(r4)     // Catch:{ all -> 0x0022 }
        L_0x0020:
            monitor-exit(r0)     // Catch:{ all -> 0x0022 }
            return r2
        L_0x0022:
    ...
    static void sendWakefulServiceIntent(Context context, WithinAppServiceConnection connection, Intent intent) {
        synchronized (syncObject) {
            ...
            connection.sendIntent(intent).addOnCompleteListener(new c0(intent));
        }
    }
