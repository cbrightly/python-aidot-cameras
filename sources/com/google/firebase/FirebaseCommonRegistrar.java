...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        result.add(LibraryVersionComponent.fromContext(TARGET_SDK, d.a));
        result.add(LibraryVersionComponent.fromContext(MIN_SDK, e.a));
        result.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, f.a));
        result.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, c.a));
    ...
    static /* synthetic */ String lambda$getComponents$2(Context ctx) {
        ...
        if (i >= 16 && ctx.getPackageManager().hasSystemFeature("android.hardware.type.television")) {
            return "tv";
        }
        if (i >= 20 && ctx.getPackageManager().hasSystemFeature("android.hardware.type.watch")) {
            return "watch";
        }
        if (i >= 23 && ctx.getPackageManager().hasSystemFeature("android.hardware.type.automotive")) {
            return "auto";
        }
        if (i < 26 || !ctx.getPackageManager().hasSystemFeature("android.hardware.type.embedded")) {
            return "";
        }
        return "embedded";
    }
