...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private void rotateLeft(Node<K, V> root2) {
        ...
        root2.parent = pivot;
        int i = 0;
        int max = Math.max(left != null ? left.height : 0, pivotLeft != null ? pivotLeft.height : 0) + 1;
        root2.height = max;
        if (pivotRight != null) {
            i = pivotRight.height;
        }
        pivot.height = Math.max(max, i) + 1;
    }
    ...
    private void rotateRight(Node<K, V> root2) {
        ...
        root2.parent = pivot;
        int i = 0;
        int max = Math.max(right != null ? right.height : 0, pivotRight != null ? pivotRight.height : 0) + 1;
        root2.height = max;
        if (pivotLeft != null) {
            i = pivotLeft.height;
        }
