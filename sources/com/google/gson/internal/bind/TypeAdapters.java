...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<Boolean> BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() {
        ...
        public void write(JsonWriter out, Boolean value) {
            out.value(value == null ? BuildConfig.TRAVIS : value.toString());
        }
    };
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r4, com.google.gson.reflect.TypeToken<T> r5) {
            ...
            L_0x0019:
                com.google.gson.internal.bind.TypeAdapters$EnumTypeAdapter r0 = new com.google.gson.internal.bind.TypeAdapters$EnumTypeAdapter
                r0.<init>(r1)
                return r0
            L_0x001f:
                r0 = 0
    ...
    static {
        ...
        TypeAdapter<AtomicBoolean> nullSafe4 = new TypeAdapter<AtomicBoolean>() {
            ...
            public void write(JsonWriter out, AtomicBoolean value) {
                out.value(value.get());
            }
        }.nullSafe();
        ...
        TypeAdapter<AtomicIntegerArray> nullSafe5 = new TypeAdapter<AtomicIntegerArray>() {
            public AtomicIntegerArray read(JsonReader in) {
            ...
            public void write(JsonWriter out, AtomicIntegerArray value) {
                out.beginArray();
        ...
        AnonymousClass21 r010 = new TypeAdapter<URL>() {
            public URL read(JsonReader in) {
                ...
                if (BuildConfig.TRAVIS.equals(nextString)) {
                    return null;
                }
        ...
        TypeAdapter<Currency> nullSafe6 = new TypeAdapter<Currency>() {
            public Currency read(JsonReader in) {
                return Currency.getInstance(in.nextString());
            }

            public void write(JsonWriter out, Currency value) {
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> unboxed, final Class<TT> boxed, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() {
            ...
            public String toString() {
                return "Factory[type=" + boxed.getName() + e.ANY_NON_NULL_MARKER + unboxed.getName() + ",adapter=" + typeAdapter + "]";
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> base, final Class<? extends TT> sub, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() {
            ...
            public String toString() {
                return "Factory[type=" + base.getName() + e.ANY_NON_NULL_MARKER + sub.getName() + ",adapter=" + typeAdapter + "]";
            }
        };
    }
        ...
        return new TypeAdapterFactory() {
            public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
                ...
                return new TypeAdapter<T1>() {
                    public void write(JsonWriter out, T1 value) {
