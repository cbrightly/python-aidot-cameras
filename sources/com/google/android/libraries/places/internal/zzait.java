...
public final class zzait {
    ...
    static {
        ...
        if (zzg2 != null) {
            if (zzv) {
                zzais2 = new zzair(zzg2);
            } else if (zzv2) {
                zzais2 = new zzaiq(zzg2);
            }
        }
        zzf = zzais2;
        boolean z3 = true;
        if (zzais2 == null) {
            ...
            try {
                Class<?> cls9 = zzais2.zza.getClass();
                cls9.getMethod("objectFieldOffset", new Class[]{Field.class});
                cls9.getMethod("getLong", new Class[]{cls7, cls8});
                z = zzB() != null;
            } catch (Throwable th) {
                Logger.getLogger(zzait.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
                z = false;
            }
        }
        zzg = z;
        ...
        if (zzais3 == null) {
            ...
            try {
                Class<?> cls10 = zzais3.zza.getClass();
                ...
                Logger.getLogger(zzait.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
                z2 = false;
            }
        }
        zzh = z2;
        ...
        zzA(cls);
        Field zzB = zzB();
        if (!(zzB == null || (zzais = zzf) == null)) {
            zzais.zza.objectFieldOffset(zzB);
        }
    ...
    public static void zzD(Object obj, long j, byte b) {
        zzais zzais = zzf;
        long j2 = -4 & j;
        int i = zzais.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzais.zza.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        long j2 = -4 & j;
        int i = (((int) j) & 3) << 3;
        zzais.zza.putInt(obj, j2, ((255 & b) << i) | (zzais.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzaip());
        } catch (Throwable th) {
            return null;
        }
    }
