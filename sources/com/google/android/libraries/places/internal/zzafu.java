...
public enum zzafu {
    ...
    private static final zzafu[] zzZ = null;
    private final zzagl zzab;
    ...
    static {
        int i;
        zzZ = new zzafu[r1];
        for (zzafu zzafu : values()) {
            zzZ[zzafu.zzac] = zzafu;
        }
    }

    private zzafu(int i, int i2, zzagl zzagl) {
        this.zzac = i;
        this.zzab = zzagl;
        zzagl zzagl2 = zzagl.VOID;
        switch (i2 - 1) {
            case 1:
                this.zzad = zzagl.zza();
                break;
