...
public final class zzaix {
    private static final zzaiu zza = new zzaiv();

    static {
        if (zzait.zzx() && zzait.zzy()) {
            int i = zzaet.zza;
        }
    }
    ...
    static /* bridge */ /* synthetic */ int zza(byte[] bArr, int i, int i2) {
        ...
        switch (i3) {
            ...
            case 2:
                ...
                byte b4 = bArr[i + 1];
                if (b <= -12 && b3 <= -65 && b4 <= -65) {
                    return ((b3 << 8) ^ b) ^ (b4 << MappingData.PATH);
                }
            default:
    ...
    static int zzb(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        ...
        L_0x00bc:
            r1 = r4
        L_0x00bd:
            com.google.android.libraries.places.internal.zzaiw r7 = new com.google.android.libraries.places.internal.zzaiw
            int r1 = r1 + -1
            r7.<init>(r1, r0)
            throw r7
        L_0x00c5:
            if (r10 < r5) goto L_0x00e1
            if (r10 > r4) goto L_0x00e1
            int r8 = r1 + 1
            int r2 = r7.length()
        ...
        L_0x0101:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.libraries.places.internal.zzaix.zzb(java.lang.CharSequence, byte[], int, int):int");
    }
