...
public final class zzadj {
    ...
    public static int zza(int r5, int r6, java.math.RoundingMode r7) {
        ...
        L_0x000d:
            r5 = r5 ^ r6
            int[] r2 = com.google.android.libraries.places.internal.zzadi.zza
            int r3 = r7.ordinal()
            r2 = r2[r3]
            int r5 = r5 >> 31
            r3 = 1
        ...
        L_0x004f:
            ...
            return r0
        L_0x0051:
            com.google.android.libraries.places.internal.zzadk.zza(r4)
        L_0x0054:
            return r0
        L_0x0055:
        ...
        L_0x005d:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.libraries.places.internal.zzadj.zza(int, int, java.math.RoundingMode):int");
    }

    public static int zzb(int i, RoundingMode roundingMode) {
        boolean z;
        if (i > 0) {
            switch (zzadi.zza[roundingMode.ordinal()]) {
                case 1:
                    if (((i - 1) & i) == 0) {
                        z = true;
                    } else {
