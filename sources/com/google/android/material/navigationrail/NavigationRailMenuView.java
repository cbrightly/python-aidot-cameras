...
public class NavigationRailMenuView extends NavigationBarMenuView {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(View.MeasureSpec.getSize(widthMeasureSpec), widthMeasureSpec, 0), View.resolveSizeAndState(measuredHeight, heightMeasureSpec, 0));
    }
    ...
    private int makeSharedHeightSpec(int parentWidthSpec, int maxHeight, int shareCount) {
        return View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(parentWidthSpec), maxHeight / Math.max(1, shareCount)), 0);
    }
