...
public final class LinearDrawingDelegate extends DrawingDelegate<LinearProgressIndicatorSpec> {
    ...
    public void adjustCanvas(@NonNull Canvas canvas, @FloatRange(from = 0.0d, to = 1.0d) float trackThicknessFraction) {
        ...
        S s = this.spec;
        this.displayedTrackThickness = ((float) ((LinearProgressIndicatorSpec) s).trackThickness) * trackThicknessFraction;
        this.displayedCornerRadius = ((float) ((LinearProgressIndicatorSpec) s).trackCornerRadius) * trackThicknessFraction;
    }
