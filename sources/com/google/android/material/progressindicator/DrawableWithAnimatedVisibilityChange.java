...
public abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    DrawableWithAnimatedVisibilityChange(@NonNull Context context2, @NonNull BaseProgressIndicatorSpec baseSpec2) {
    ...
    public void setInternalAnimationCallback(@NonNull Animatable2Compat.AnimationCallback callback) {
    ...
    public boolean setVisibleInternal(boolean visible, boolean restart, boolean animate) {
        ...
        if (!animate) {
            ...
            if (!(visible ? this.baseSpec.isShowAnimationEnabled() : this.baseSpec.isHideAnimationEnabled())) {
                endAnimatorWithoutCallbacks(animatorInAction);
                return changed;
            }
    ...
    private void setShowAnimator(@NonNull ValueAnimator showAnimator2) {
        ValueAnimator valueAnimator = this.showAnimator;
    ...
    private void setHideAnimator(@NonNull ValueAnimator hideAnimator2) {
        ValueAnimator valueAnimator = this.hideAnimator;
        if (valueAnimator == null || !valueAnimator.isRunning()) {
    ...
    /* access modifiers changed from: package-private */
    public void setGrowFraction(@FloatRange(from = 0.0d, to = 1.0d) float growFraction2) {
    ...
    /* access modifiers changed from: package-private */
    @VisibleForTesting
    public void setMockShowAnimationRunning(boolean running, @FloatRange(from = 0.0d, to = 1.0d) float fraction) {
    ...
    /* access modifiers changed from: package-private */
    @VisibleForTesting
    public void setMockHideAnimationRunning(boolean running, @FloatRange(from = 0.0d, to = 1.0d) float fraction) {
