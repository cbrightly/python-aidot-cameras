...
public class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(@NonNull MaterialCardView card, AttributeSet attrs, int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        if (cardViewAttributes.hasValue(i)) {
            shapeAppearanceModelBuilder.setAllCornerSizes(cardViewAttributes.getDimension(i, 0.0f));
        }
    ...
    public void updateContentPadding() {
        ...
        materialCardView2.setAncestorContentPadding(rect.left + contentPaddingOffset, rect.top + contentPaddingOffset, rect.right + contentPaddingOffset, rect.bottom + contentPaddingOffset);
    }
    ...
    /* access modifiers changed from: package-private */
    public void setCheckedIconSize(@Dimension int checkedIconSize2) {
    ...
    /* access modifiers changed from: package-private */
    public void setCheckedIconMargin(@Dimension int checkedIconMargin2) {
