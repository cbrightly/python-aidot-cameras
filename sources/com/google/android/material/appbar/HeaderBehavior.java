...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    /* access modifiers changed from: package-private */
    public final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V layout, int minOffset, int maxOffset, float velocityY) {
        V v = layout;
    ...
    /* access modifiers changed from: package-private */
    public int getMaxDragOffset(@NonNull V view) {
        return -view.getHeight();
    }

    /* access modifiers changed from: package-private */
    public int getScrollRangeForDragFling(@NonNull V view) {
        return view.getHeight();
    }
