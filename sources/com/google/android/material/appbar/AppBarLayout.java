...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public AppBarLayout(@androidx.annotation.NonNull android.content.Context r11, @androidx.annotation.Nullable android.util.AttributeSet r12, int r13) {
        /*
            ...
            r10.<init>(r0, r12, r13)
            r6 = -1
            r10.totalScrollRange = r6
            r10.downPreScrollRange = r6
            r10.downScrollRange = r6
            r7 = 0
            r10.pendingAction = r7
        ...
        L_0x006f:
            ...
            float r1 = (float) r1
            com.google.android.material.appbar.ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(r10, r1)
        L_0x0082:
            r1 = 26
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = i;
        extraStates[1] = (!z || !this.lifted) ? -R.attr.state_lifted : R.attr.state_lifted;
        int i2 = R.attr.state_collapsible;
        if (!z) {
            i2 = -i2;
        }
        extraStates[2] = i2;
        extraStates[3] = (!z || !this.lifted) ? -R.attr.state_collapsed : R.attr.state_collapsed;
    ...
    private void startLiftOnScrollElevationOverlayAnimation(@NonNull final MaterialShapeDrawable background, boolean lifted2) {
    ...
    public void setLiftOnScrollTargetViewId(@IdRes int liftOnScrollTargetViewId2) {
    ...
    /* access modifiers changed from: package-private */
    public boolean shouldLift(@Nullable View defaultScrollingView) {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            if (a.hasValue(i)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(c, a.getResourceId(i, 0));
            }
            a.recycle();
        }
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void addAccessibilityScrollActions(CoordinatorLayout coordinatorLayout, @NonNull T appBarLayout, @NonNull View scrollingView) {
        ...
        /* access modifiers changed from: package-private */
        public void onFlingFinished(@NonNull CoordinatorLayout parent, @NonNull T layout) {
        ...
        /* access modifiers changed from: package-private */
        public int getMaxDragOffset(@NonNull T view) {
            return -view.getDownNestedScrollRange();
        }

        /* access modifiers changed from: package-private */
        public int getScrollRangeForDragFling(@NonNull T view) {
            return view.getTotalScrollRange();
        }

        /* access modifiers changed from: package-private */
        public int setHeaderTopBottomOffset(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T appBarLayout, int newOffset, int minOffset, int maxOffset) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        /* access modifiers changed from: package-private */
        @Nullable
        public AppBarLayout findFirstDependency(@NonNull List<View> views) {
            int z = views.size();
            for (int i = 0; i < z; i++) {
