...
public final class CalendarConstraints implements Parcelable {
    ...
    private CalendarConstraints(@NonNull Month start2, @NonNull Month end2, @NonNull DateValidator validator2, @Nullable Month openAt2) {
        this.start = start2;
        this.end = end2;
        this.openAt = openAt2;
    ...
    /* access modifiers changed from: package-private */
    public void setOpenAt(@Nullable Month openAt2) {
        this.openAt = openAt2;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!this.start.equals(that.start) || !this.end.equals(that.end) || !ObjectsCompat.equals(this.openAt, that.openAt) || !this.validator.equals(that.validator)) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setValidator(@NonNull DateValidator validator2) {
            this.validator = validator2;
            return this;
        }
