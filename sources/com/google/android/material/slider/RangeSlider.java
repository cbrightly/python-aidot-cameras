...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, R.styleable.RangeSlider, defStyleAttr, BaseSlider.DEF_STYLE_RES, new int[0]);
        int i = R.styleable.RangeSlider_values;
        if (a.hasValue(i)) {
            setValues(convertToFloat(a.getResources().obtainTypedArray(a.getResourceId(i, 0))));
        }
    ...
    public void setMinSeparation(@Dimension float minSeparation2) {
