...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public void setFabAlignmentModeAndReplaceMenu(int fabAlignmentMode2, @MenuRes int newMenu) {
    ...
    /* access modifiers changed from: package-private */
    public void removeAnimationListener(@NonNull AnimationListener listener) {
    ...
    /* access modifiers changed from: package-private */
    public void setFabCornerSize(@Dimension float radius) {
    ...
    private void translateActionMenuView(@NonNull ActionMenuView actionMenuView, int fabAlignmentMode2, boolean fabAttached2) {
        translateActionMenuView(actionMenuView, fabAlignmentMode2, fabAttached2, false);
    }

    /* access modifiers changed from: private */
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int fabAlignmentMode2, final boolean fabAttached2, boolean shouldWaitForMenuReplacement) {
    ...
    /* access modifiers changed from: protected */
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int fabAlignmentMode2, boolean fabAttached2) {
        int i;
        ...
        private final View.OnLayoutChangeListener fabLayoutListener = new View.OnLayoutChangeListener() {
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                if (Behavior.this.originalBottomMargin == 0) {
                    fabLayoutParams.bottomMargin = child.getBottomInset() + (child.getResources().getDimensionPixelOffset(R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((fab.getMeasuredHeight() - height) / 2));
