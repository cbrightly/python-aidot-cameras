...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    /* access modifiers changed from: private */
    public long dropdownPopupActivatedAt = DefaultAuthCallbacks.CREDENTIALS_NEVER_EXPIRE;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public void showHideDropdown(@Nullable AutoCompleteTextView editText) {
        if (editText != null) {
    ...
    /* access modifiers changed from: private */
    public void setPopupBackground(@NonNull AutoCompleteTextView editText) {
        if (IS_LOLLIPOP) {
    ...
    /* access modifiers changed from: private */
    public void addRippleEffect(@NonNull AutoCompleteTextView editText) {
    ...
    /* access modifiers changed from: private */
    @SuppressLint({"ClickableViewAccessibility"})
    public void setUpDropdownShowHideBehavior(@NonNull final AutoCompleteTextView editText) {
