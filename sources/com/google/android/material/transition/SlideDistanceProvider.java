...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    public void setSlideDistance(@Px int slideDistance2) {
        if (slideDistance2 >= 0) {
    ...
    private static Animator createTranslationAppearAnimator(View sceneRoot, View view, int slideEdge2, @Px int slideDistance2) {
    ...
    private static Animator createTranslationDisappearAnimator(View sceneRoot, View view, int slideEdge2, @Px int slideDistance2) {
        float originalX = view.getTranslationX();
        float originalY = view.getTranslationY();
        switch (slideEdge2) {
            case 3:
