...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    public void setProgressThreshold(@FloatRange(from = 0.0d, to = 1.0d) float progressThreshold2) {
    ...
    private static Animator createFadeThroughAnimator(final View view, float startValue, float endValue, @FloatRange(from = 0.0d, to = 1.0d) float startFraction, @FloatRange(from = 0.0d, to = 1.0d) float endFraction, final float originalAlpha) {
