...
public final class MaterialContainerTransform extends Transition {
    ...
    public void setStartViewId(@IdRes int startViewId2) {
    ...
    public void setEndViewId(@IdRes int endViewId2) {
    ...
    public void setStartView(@Nullable View startView2) {
    ...
    public void setEndView(@Nullable View endView2) {
    ...
    public void setStartShapeAppearanceModel(@Nullable ShapeAppearanceModel startShapeAppearanceModel2) {
    ...
    public void setEndShapeAppearanceModel(@Nullable ShapeAppearanceModel endShapeAppearanceModel2) {
    ...
    public void setDrawingViewId(@IdRes int drawingViewId2) {
    ...
    public void setContainerColor(@ColorInt int containerColor2) {
    ...
    public void setStartContainerColor(@ColorInt int containerColor2) {
    ...
    public void setEndContainerColor(@ColorInt int containerColor2) {
        this.endContainerColor = containerColor2;
    }

    public void setAllContainerColors(@ColorInt int containerColor2) {
        this.containerColor = containerColor2;
        this.startContainerColor = containerColor2;
        this.endContainerColor = containerColor2;
    }
    ...
    public void setScrimColor(@ColorInt int scrimColor2) {
    ...
    public void setFadeProgressThresholds(@Nullable ProgressThresholds fadeProgressThresholds2) {
    ...
    public void setScaleProgressThresholds(@Nullable ProgressThresholds scaleProgressThresholds2) {
    ...
    public void setScaleMaskProgressThresholds(@Nullable ProgressThresholds scaleMaskProgressThresholds2) {
    ...
    public void setShapeMaskProgressThresholds(@Nullable ProgressThresholds shapeMaskProgressThresholds2) {
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View viewOverride, @IdRes int viewIdOverride, @Nullable ShapeAppearanceModel shapeAppearanceModelOverride) {
        if (viewIdOverride != -1) {
            ...
            if (view.getTag(i) instanceof View) {
                transitionValues.view.setTag(i, (Object) null);
                transitionValues.view = (View) transitionValues.view.getTag(i);
            }
        }
        ...
        private void updateProgress(float progress2) {
            ...
            if (f > 1.0f || f < 0.0f) {
                if (f > 1.0f) {
                    ...
                    trajectoryMultiplier = (f / 0.01f) * -1.0f;
                }
            ...
            RectF rectF = this.currentStartBounds;
            float f2 = evaluate.currentStartWidth;
            rectF.set(motionPathX - (f2 / 2.0f), motionPathY, (f2 / 2.0f) + motionPathX, evaluate.currentStartHeight + motionPathY);
            RectF rectF2 = this.currentEndBounds;
            FitModeResult fitModeResult2 = this.fitModeResult;
            float f3 = fitModeResult2.currentEndWidth;
            rectF2.set(motionPathX - (f3 / 2.0f), motionPathY, (f3 / 2.0f) + motionPathX, fitModeResult2.currentEndHeight + motionPathY);
            ...
            float f7 = (float) ((int) (f6 * dyMultiplier));
            this.currentElevationDy = f7;
            this.shadowPaint.setShadowLayer(f6, (float) ((int) (f6 * dxMultiplier)), f7, SHADOW_COLOR);
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, to = 1.0d) float start2, @FloatRange(from = 0.0d, to = 1.0d) float end2) {
            this.start = start2;
            this.end = end2;
        }
    ...
    public static class ProgressThresholdsGroup {
        ...
        private ProgressThresholdsGroup(@NonNull ProgressThresholds fade2, @NonNull ProgressThresholds scale2, @NonNull ProgressThresholds scaleMask2, @NonNull ProgressThresholds shapeMask2) {
            this.fade = fade2;
            this.scale = scale2;
