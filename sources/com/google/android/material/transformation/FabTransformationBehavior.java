...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    /* access modifiers changed from: protected */
    @NonNull
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull View dependency, @NonNull View child, boolean expanded, boolean isAnimating) {
    ...
    @TargetApi(21)
    private void createElevationAnimation(View dependency, @NonNull View child, boolean expanded, boolean currentlyAnimating, @NonNull FabTransformationSpec spec, @NonNull List<Animator> animations, List<Animator.AnimatorListener> list) {
        Animator animator;
    ...
    private void createTranslationAnimation(@NonNull View dependency, @NonNull View child, boolean expanded, boolean currentlyAnimating, @NonNull FabTransformationSpec spec, @NonNull List<Animator> animations, List<Animator.AnimatorListener> list, @NonNull RectF childBounds) {
    ...
    private void createColorAnimation(@NonNull View dependency, View child, boolean expanded, boolean currentlyAnimating, @NonNull FabTransformationSpec spec, @NonNull List<Animator> animations, List<Animator.AnimatorListener> list) {
        ObjectAnimator animator;
    ...
    private void createChildrenFadeAnimation(View unusedDependency, View child, boolean expanded, boolean currentlyAnimating, @NonNull FabTransformationSpec spec, @NonNull List<Animator> animations, List<Animator.AnimatorListener> list) {
