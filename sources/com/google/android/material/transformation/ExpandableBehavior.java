...
public abstract class ExpandableBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public boolean onLayoutChild(@androidx.annotation.NonNull androidx.coordinatorlayout.widget.CoordinatorLayout r5, @androidx.annotation.NonNull final android.view.View r6, int r7) {
        /*
            r4 = this;
    ...
    /* access modifiers changed from: protected */
    @Nullable
    public ExpandableWidget findExpandableWidget(@NonNull CoordinatorLayout parent, @NonNull View child) {
