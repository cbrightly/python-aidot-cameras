...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    @NonNull
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull View dependency, @NonNull final View child, final boolean expanded, boolean isAnimating) {
    ...
    private void createScrimAnimation(@NonNull View child, boolean expanded, boolean currentlyAnimating, @NonNull List<Animator> animations, List<Animator.AnimatorListener> list) {
        Animator animator;
