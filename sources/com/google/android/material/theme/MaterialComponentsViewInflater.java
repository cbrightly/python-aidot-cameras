...
public class MaterialComponentsViewInflater extends AppCompatViewInflater {
    ...
    @NonNull
    public AppCompatButton createButton(@NonNull Context context, @NonNull AttributeSet attrs) {
    ...
    /* access modifiers changed from: protected */
    @NonNull
    public AppCompatAutoCompleteTextView createAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attrs) {
