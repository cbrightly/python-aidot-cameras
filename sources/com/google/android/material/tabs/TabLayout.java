...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(@androidx.annotation.NonNull android.content.Context r12, @androidx.annotation.Nullable android.util.AttributeSet r13, int r14) {
        /*
            ...
            r2.setFillColor(r3)
            r2.initializeElevationOverlay(r12)
            float r3 = androidx.core.view.ViewCompat.getElevation(r11)
            r2.setElevation(r3)
            androidx.core.view.ViewCompat.setBackground(r11, r2)
        L_0x0082:
            int r1 = com.google.android.material.R.styleable.TabLayout_tabIndicator
            android.graphics.drawable.Drawable r1 = com.google.android.material.resources.MaterialResources.getDrawable(r12, r0, r1)
            r11.setSelectedTabIndicator((android.graphics.drawable.Drawable) r1)
            int r1 = com.google.android.material.R.styleable.TabLayout_tabIndicatorColor
            int r1 = r0.getColor(r1, r6)
            r11.setSelectedTabIndicatorColor(r1)
            ...
            int r1 = r0.getResourceId(r10, r1)
            r11.tabTextAppearance = r1
            int[] r2 = androidx.appcompat.R.styleable.TextAppearance
            android.content.res.TypedArray r1 = r12.obtainStyledAttributes(r1, r2)
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x01b9 }
            int r2 = r1.getDimensionPixelSize(r2, r6)     // Catch:{ all -> 0x01b9 }
            float r2 = (float) r2     // Catch:{ all -> 0x01b9 }
            r11.tabTextSize = r2     // Catch:{ all -> 0x01b9 }
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x01b9 }
            android.content.res.ColorStateList r2 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r12, (android.content.res.TypedArray) r1, (int) r2)     // Catch:{ all -> 0x01b9 }
            r11.tabTextColors = r2     // Catch:{ all -> 0x01b9 }
            r1.recycle()
            int r2 = com.google.android.material.R.styleable.TabLayout_tabTextColor
            boolean r3 = r0.hasValue(r2)
            if (r3 == 0) goto L_0x011e
            android.content.res.ColorStateList r2 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r12, (android.content.res.TypedArray) r0, (int) r2)
            r11.tabTextColors = r2
        L_0x011e:
            int r2 = com.google.android.material.R.styleable.TabLayout_tabSelectedTextColor
            boolean r3 = r0.hasValue(r2)
            if (r3 == 0) goto L_0x0136
            int r2 = r0.getColor(r2, r6)
            android.content.res.ColorStateList r3 = r11.tabTextColors
            int r3 = r3.getDefaultColor()
            android.content.res.ColorStateList r3 = createColorStateList(r3, r2)
            r11.tabTextColors = r3
        L_0x0136:
    ...
    public final class TabView extends LinearLayout {
        ...
        /* access modifiers changed from: private */
        public void tryUpdateBadgeDrawableBounds(@NonNull View anchor) {
