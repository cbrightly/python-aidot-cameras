...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence text, int duration) {
        ...
        if (parent != null) {
            ...
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(context).inflate(hasSnackbarContentStyleAttrs(context) ? R.layout.mtrl_layout_snackbar_include : R.layout.design_layout_snackbar_include, parent, false);
    ...
    public Snackbar setAction(@Nullable CharSequence text, @Nullable final View.OnClickListener listener) {
        TextView tv2 = ((SnackbarContentLayout) this.view.getChildAt(0)).getActionView();
        if (TextUtils.isEmpty(text) || listener == null) {
            tv2.setVisibility(8);
            tv2.setOnClickListener((View.OnClickListener) null);
