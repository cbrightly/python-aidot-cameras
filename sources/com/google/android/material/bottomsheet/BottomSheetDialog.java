...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public void onAttachedToWindow() {
        ...
        if (window != null && Build.VERSION.SDK_INT >= 21) {
            ...
            if (drawEdgeToEdge) {
                window.getDecorView().setSystemUiVisibility(AVIOCTRLDEFs.IOTYPE_USER_IPCAM_AUDIOSTART);
            }
        }
    }
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.bottomSheet, new OnApplyWindowInsetsListener() {
                public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat insets) {
                    ...
                    if (insets != null) {
                        ...
                        BottomSheetBehavior.BottomSheetCallback unused = bottomSheetDialog.edgeToEdgeCallback = new EdgeToEdgeCallback(bottomSheetDialog.bottomSheet, insets);
    ...
    public static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        private EdgeToEdgeCallback(@NonNull View bottomSheet, @NonNull WindowInsetsCompat insetsCompat2) {
