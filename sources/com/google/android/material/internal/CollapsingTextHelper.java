...
public final class CollapsingTextHelper {
    ...
    public CollapsingTextHelper(View view2) {
        this.view = view2;
        TextPaint textPaint2 = new TextPaint(NeedPermissionEvent.PER_IPC_GET_SPEAK_PERM);
    ...
    private void calculateOffsets(float fraction) {
        ...
        if (this.fadeModeEnabled) {
            this.textPaint.setAlpha((int) (calculateFadeModeTextAlpha(fraction) * 255.0f));
        }
    ...
    private void calculateBaseOffsets(boolean forceRecalculate) {
        ...
        float width2 = (staticLayout3 == null || this.maxLines <= 1) ? measuredWidth : (float) staticLayout3.getWidth();
        StaticLayout staticLayout4 = this.textLayout;
        if (staticLayout4 != null) {
            f = this.maxLines > 1 ? (float) staticLayout4.getLineStart(0) : staticLayout4.getLineLeft(0);
        }
    ...
    private boolean calculateIsRtl(@NonNull CharSequence text2) {
    ...
    private boolean isTextDirectionHeuristicsIsRtl(@NonNull CharSequence text2, boolean defaultIsRtl) {
