...
public final class ThemeEnforcement {
    ...
    @NonNull
    public static TypedArray obtainStyledAttributes(@NonNull Context context, AttributeSet set, @StyleableRes @NonNull int[] attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes, @StyleableRes int... textAppearanceResIndices) {
    ...
    public static TintTypedArray obtainTintedStyledAttributes(@NonNull Context context, AttributeSet set, @StyleableRes @NonNull int[] attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes, @StyleableRes int... textAppearanceResIndices) {
        checkCompatibleTheme(context, set, defStyleAttr, defStyleRes);
        checkTextAppearance(context, set, attrs, defStyleAttr, defStyleRes, textAppearanceResIndices);
    ...
    private static void checkTextAppearance(@NonNull Context context, AttributeSet set, @StyleableRes @NonNull int[] attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes, @StyleableRes @Nullable int... textAppearanceResIndices) {
    ...
    private static boolean isCustomTextAppearanceValid(@NonNull Context context, AttributeSet set, @StyleableRes @NonNull int[] attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes, @StyleableRes @NonNull int... textAppearanceResIndices) {
