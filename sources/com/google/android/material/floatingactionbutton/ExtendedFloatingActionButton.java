...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        /* access modifiers changed from: package-private */
        @VisibleForTesting
        public void setInternalAutoHideCallback(@Nullable OnChangedCallback callback) {
            this.internalAutoHideCallback = callback;
        }

        /* access modifiers changed from: package-private */
        @VisibleForTesting
        public void setInternalAutoShrinkCallback(@Nullable OnChangedCallback callback) {
        ...
        /* access modifiers changed from: protected */
        public void shrinkOrHide(@NonNull ExtendedFloatingActionButton fab) {
        ...
        /* access modifiers changed from: protected */
        public void extendOrShow(@NonNull ExtendedFloatingActionButton fab) {
            MotionStrategy strategy;
            boolean z = this.autoShrinkEnabled;
            OnChangedCallback callback = z ? this.internalAutoShrinkCallback : this.internalAutoHideCallback;
            if (z) {
