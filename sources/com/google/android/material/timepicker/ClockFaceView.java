...
public class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    private void updateTextViews(@androidx.annotation.StringRes int r9) {
        /*
            r8 = this;
    ...
    private void findIntersectingTextView() {
        ...
        for (int i = 0; i < this.textViewPool.size(); i++) {
            TextView tv2 = this.textViewPool.get(i);
            if (tv2 != null) {
                tv2.getDrawingRect(this.textViewRect);
                this.textViewRect.offset(tv2.getPaddingLeft(), tv2.getPaddingTop());
                offsetDescendantRectToMyCoords(tv2, this.textViewRect);
                this.scratch.set(this.textViewRect);
                tv2.getPaint().setShader(getGradientForTextView(selectorBox, this.scratch));
                tv2.invalidate();
            }
        }
    }
