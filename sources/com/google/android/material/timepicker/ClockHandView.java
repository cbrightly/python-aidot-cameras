...
public class ClockHandView extends View {
    ...
    public void setHandRotation(@FloatRange(from = 0.0d, to = 360.0d) float degrees) {
        setHandRotation(degrees, false);
    }

    public void setHandRotation(@FloatRange(from = 0.0d, to = 360.0d) float degrees, boolean animate) {
    ...
    public void setHandRotationInternal(@FloatRange(from = 0.0d, to = 360.0d) float degrees, boolean animate) {
    ...
    public void setCircleRadius(@Dimension int circleRadius2) {
