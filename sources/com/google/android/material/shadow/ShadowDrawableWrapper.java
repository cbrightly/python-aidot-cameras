...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void buildComponents(@NonNull Rect bounds) {
        ...
        float verticalOffset = SHADOW_MULTIPLIER * f;
        this.contentBounds.set(((float) bounds.left) + f, ((float) bounds.top) + verticalOffset, ((float) bounds.right) - f, ((float) bounds.bottom) - verticalOffset);
