...
public final class CircularRevealCompat {
    ...
    @NonNull
    public static Animator createCircularReveal(@NonNull CircularRevealWidget view, float centerX, float centerY, float endRadius) {
    ...
    @NonNull
    public static Animator.AnimatorListener createCircularRevealListener(@NonNull final CircularRevealWidget view) {
