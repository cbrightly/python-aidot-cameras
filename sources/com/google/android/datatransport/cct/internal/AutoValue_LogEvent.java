...
public final class AutoValue_LogEvent extends LogEvent {
    ...
    private AutoValue_LogEvent(long eventTimeMs2, @Nullable Integer eventCode2, long eventUptimeMs2, @Nullable byte[] sourceExtension2, @Nullable String sourceExtensionJsonProto32, long timezoneOffsetSeconds2, @Nullable NetworkConnectionInfo networkConnectionInfo2) {
    ...
    public static final class Builder extends LogEvent.Builder {
        ...
        public LogEvent.Builder setEventCode(@Nullable Integer eventCode2) {
            this.eventCode = eventCode2;
            return this;
        }
        ...
        public LogEvent.Builder setSourceExtension(@Nullable byte[] sourceExtension2) {
            this.sourceExtension = sourceExtension2;
            return this;
        }

        /* access modifiers changed from: package-private */
        public LogEvent.Builder setSourceExtensionJsonProto3(@Nullable String sourceExtensionJsonProto32) {
            this.sourceExtensionJsonProto3 = sourceExtensionJsonProto32;
            return this;
        }
