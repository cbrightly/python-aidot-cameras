...
public final class AutoBatchedLogRequestEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> cfg) {
        ...
        cfg.registerEncoder((Class<U>) BatchedLogRequest.class, (ObjectEncoder<? super U>) batchedLogRequestEncoder);
        cfg.registerEncoder((Class<U>) AutoValue_BatchedLogRequest.class, (ObjectEncoder<? super U>) batchedLogRequestEncoder);
        LogRequestEncoder logRequestEncoder = LogRequestEncoder.INSTANCE;
        cfg.registerEncoder((Class<U>) LogRequest.class, (ObjectEncoder<? super U>) logRequestEncoder);
        cfg.registerEncoder((Class<U>) AutoValue_LogRequest.class, (ObjectEncoder<? super U>) logRequestEncoder);
        ClientInfoEncoder clientInfoEncoder = ClientInfoEncoder.INSTANCE;
        cfg.registerEncoder((Class<U>) ClientInfo.class, (ObjectEncoder<? super U>) clientInfoEncoder);
        cfg.registerEncoder((Class<U>) AutoValue_ClientInfo.class, (ObjectEncoder<? super U>) clientInfoEncoder);
        AndroidClientInfoEncoder androidClientInfoEncoder = AndroidClientInfoEncoder.INSTANCE;
        cfg.registerEncoder((Class<U>) AndroidClientInfo.class, (ObjectEncoder<? super U>) androidClientInfoEncoder);
        cfg.registerEncoder((Class<U>) AutoValue_AndroidClientInfo.class, (ObjectEncoder<? super U>) androidClientInfoEncoder);
        LogEventEncoder logEventEncoder = LogEventEncoder.INSTANCE;
        cfg.registerEncoder((Class<U>) LogEvent.class, (ObjectEncoder<? super U>) logEventEncoder);
        cfg.registerEncoder((Class<U>) AutoValue_LogEvent.class, (ObjectEncoder<? super U>) logEventEncoder);
        NetworkConnectionInfoEncoder networkConnectionInfoEncoder = NetworkConnectionInfoEncoder.INSTANCE;
        cfg.registerEncoder((Class<U>) NetworkConnectionInfo.class, (ObjectEncoder<? super U>) networkConnectionInfoEncoder);
        cfg.registerEncoder((Class<U>) AutoValue_NetworkConnectionInfo.class, (ObjectEncoder<? super U>) networkConnectionInfoEncoder);
    }
    ...
    public static final class BatchedLogRequestEncoder implements ObjectEncoder<BatchedLogRequest> {
        ...
        public void encode(BatchedLogRequest value, ObjectEncoderContext ctx) {
    ...
    public static final class LogRequestEncoder implements ObjectEncoder<LogRequest> {
        ...
        public void encode(LogRequest value, ObjectEncoderContext ctx) {
    ...
    public static final class ClientInfoEncoder implements ObjectEncoder<ClientInfo> {
        ...
        public void encode(ClientInfo value, ObjectEncoderContext ctx) {
    ...
    public static final class AndroidClientInfoEncoder implements ObjectEncoder<AndroidClientInfo> {
        ...
        private static final FieldDescriptor COUNTRY_DESCRIPTOR = FieldDescriptor.of(PlaceTypes.COUNTRY);
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.of(RoutineRule.THEN_TYPE_DEVICE);
        ...
        public void encode(AndroidClientInfo value, ObjectEncoderContext ctx) {
    ...
    public static final class LogEventEncoder implements ObjectEncoder<LogEvent> {
        ...
        public void encode(LogEvent value, ObjectEncoderContext ctx) {
    ...
    public static final class NetworkConnectionInfoEncoder implements ObjectEncoder<NetworkConnectionInfo> {
        ...
        public void encode(NetworkConnectionInfo value, ObjectEncoderContext ctx) {
