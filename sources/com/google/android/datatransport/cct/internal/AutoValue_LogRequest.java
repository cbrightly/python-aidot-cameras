...
public final class AutoValue_LogRequest extends LogRequest {
    ...
    private AutoValue_LogRequest(long requestTimeMs2, long requestUptimeMs2, @Nullable ClientInfo clientInfo2, @Nullable Integer logSource2, @Nullable String logSourceName2, @Nullable List<LogEvent> logEvents2, @Nullable QosTier qosTier2) {
    ...
    public static final class Builder extends LogRequest.Builder {
        ...
        public LogRequest.Builder setLogSource(@Nullable Integer logSource2) {
            this.logSource = logSource2;
            return this;
        }

        /* access modifiers changed from: package-private */
        public LogRequest.Builder setLogSourceName(@Nullable String logSourceName2) {
            this.logSourceName = logSourceName2;
            return this;
        }

        public LogRequest.Builder setLogEvents(@Nullable List<LogEvent> logEvents2) {
            this.logEvents = logEvents2;
            return this;
        }
