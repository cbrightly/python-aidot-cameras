...
public final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest request) {
        ...
        connection.setRequestProperty("User-Agent", String.format("datatransport/%s android/", new Object[]{"3.1.8"}));
        connection.setRequestProperty("Content-Encoding", "gzip");
        connection.setRequestProperty("Content-Type", "application/json");
        connection.setRequestProperty("Accept-Encoding", "gzip");
        String str = request.apiKey;
        if (str != null) {
            connection.setRequestProperty(API_KEY_HEADER_KEY, str);
        }
        try {
            ...
            try {
                ...
                Logging.d(LOG_TAG, "Content-Type: %s", (Object) connection.getHeaderField("Content-Type"));
                Logging.d(LOG_TAG, "Content-Encoding: %s", (Object) connection.getHeaderField("Content-Encoding"));
                if (responseCode == 302 || responseCode == 301 || responseCode == 307) {
                    return new HttpResponse(responseCode, new URL(connection.getHeaderField("Location")), 0);
                }
                if (responseCode != 200) {
            ...
            return new HttpResponse(BaseResp.ERR_MSG_SEND_FAIL, (URL) null, 0);
        } catch (Throwable th4) {
    ...
    public BackendResponse send(BackendRequest request) {
        ...
        try {
            HttpResponse response = (HttpResponse) Retries.retry(5, new HttpRequest(actualEndPoint, requestBody, apiKey), new b(this), a.a);
            int i = response.code;
            if (i == 200) {
    ...
    public static final class HttpResponse {
        ...
        HttpResponse(int code2, @Nullable URL redirectUrl2, long nextRequestMillis2) {
            this.code = code2;
    ...
    public static final class HttpRequest {
        ...
        HttpRequest(URL url2, BatchedLogRequest requestBody2, @Nullable String apiKey2) {
            this.url = url2;
