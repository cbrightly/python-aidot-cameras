...
public class AlarmManagerSchedulerBroadcastReceiver extends BroadcastReceiver {
    public void onReceive(Context context, Intent intent) {
        ...
        int priority = Integer.valueOf(intent.getData().getQueryParameter(Progress.PRIORITY)).intValue();
        ...
        TransportRuntime.getInstance().getUploader().upload(transportContext.build(), attemptNumber, a.c);
    }
