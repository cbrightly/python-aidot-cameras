...
public final class MetadataBackendRegistry_Factory implements Factory<MetadataBackendRegistry> {
    ...
    public MetadataBackendRegistry_Factory(a<Context> applicationContextProvider2, a<CreationContextFactory> creationContextFactoryProvider2) {
    ...
    public static MetadataBackendRegistry_Factory create(a<Context> applicationContextProvider2, a<CreationContextFactory> creationContextFactoryProvider2) {
