...
public final class AutoValue_TransportContext extends TransportContext {
    ...
    private AutoValue_TransportContext(String backendName2, @Nullable byte[] extras2, Priority priority2) {
    ...
    public static final class Builder extends TransportContext.Builder {
        ...
        public TransportContext.Builder setExtras(@Nullable byte[] extras2) {
            this.extras = extras2;
            return this;
        }
