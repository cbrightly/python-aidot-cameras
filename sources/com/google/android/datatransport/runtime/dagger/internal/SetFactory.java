...
public final class SetFactory<T> implements Factory<Set<T>> {
    ...
    public static final class Builder<T> {
        ...
        public Builder<T> addProvider(a<? extends T> individualProvider) {
        ...
        public Builder<T> addCollectionProvider(a<? extends Collection<? extends T>> collectionProvider) {
    ...
    private SetFactory(List<a<T>> individualProviders2, List<a<Collection<T>>> collectionProviders2) {
