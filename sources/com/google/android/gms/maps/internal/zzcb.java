...
public final class zzcb {
    private static final String zza = zzcb.class.getSimpleName();
    ...
    public static com.google.android.gms.maps.internal.zzf zza(android.content.Context r3, @androidx.annotation.Nullable com.google.android.gms.maps.MapsInitializer.Renderer r4) {
        /*
        ...
        L_0x002a:
            ...
            java.lang.Object r0 = com.google.android.gms.common.internal.Preconditions.checkNotNull(r0)     // Catch:{ ClassNotFoundException -> 0x0082 }
            java.lang.ClassLoader r0 = (java.lang.ClassLoader) r0     // Catch:{ ClassNotFoundException -> 0x0082 }
            java.lang.Class r0 = r0.loadClass(r1)     // Catch:{ ClassNotFoundException -> 0x0082 }
            java.lang.Object r0 = zzd(r0)     // Catch:{ ClassNotFoundException -> 0x0082 }
        ...
        L_0x0062:
            zzc = r0
            android.content.Context r3 = zzc(r3, r4)     // Catch:{ RemoteException -> 0x007b }
            r3.getClass()     // Catch:{ RemoteException -> 0x007b }
            android.content.res.Resources r3 = r3.getResources()     // Catch:{ RemoteException -> 0x007b }
            com.google.android.gms.dynamic.IObjectWrapper r3 = com.google.android.gms.dynamic.ObjectWrapper.wrap(r3)     // Catch:{ RemoteException -> 0x007b }
            int r4 = com.google.android.gms.common.GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_VERSION_CODE     // Catch:{ RemoteException -> 0x007b }
            r0.zzk(r3, r4)     // Catch:{ RemoteException -> 0x007b }
