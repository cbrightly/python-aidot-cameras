...
public final class zzkp {
    static String zza(zzkk zzkk, String str) {
    ...
    private static void zza(zzkk zzkk, StringBuilder sb, int i) {
        boolean z;
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet<>();
        for (Method method : zzkk.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(sb, i, zza(concat), zzjb.zza(method2, (Object) zzkk, new Object[0]));
                }
            }
            if (substring.endsWith(Constants.SERVICE_MAP) && !substring.equals(Constants.SERVICE_MAP)) {
                String valueOf3 = String.valueOf(substring.substring(0, 1).toLowerCase());
                String valueOf4 = String.valueOf(substring.substring(1, substring.length() - 3));
                String concat2 = valueOf4.length() != 0 ? valueOf3.concat(valueOf4) : new String(valueOf3);
                Method method3 = (Method) hashMap.get(str);
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zza(sb, i, zza(concat2), zzjb.zza(method3, (Object) zzkk, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object zza = zzjb.zza(method4, (Object) zzkk, new Object[0]);
                    if (method5 == null) {
                        ...
                        z2 = ((Boolean) zzjb.zza(method5, (Object) zzkk, new Object[0])).booleanValue();
                    }
                    if (z2) {
        ...
        if (zzkk instanceof zzjb.zzc) {
            Iterator<Map.Entry<zzjb.zzf, Object>> zzd = ((zzjb.zzc) zzkk).zzc.zzd();
            while (zzd.hasNext()) {
                Map.Entry next = zzd.next();
                int i2 = ((zzjb.zzf) next.getKey()).zzb;
    ...
    static final void zza(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                ...
                int i4 = i + 2;
                zza(sb, i4, CacheEntity.KEY, entry.getKey());
