...
public final class zzdp<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    /* access modifiers changed from: private */
    public transient int zzf = zzfc.zza(3, 1, 1073741823);
    ...
    public final V put(@NullableDecl K k, @NullableDecl V v) {
        ...
        V v2 = v;
        if (zza()) {
            zzde.zzb(zza(), (Object) "Arrays already allocated");
            int i2 = this.zzf;
        ...
        int i3 = this.zzg;
        int i4 = i3 + 1;
        int zza2 = zzec.zza((Object) k);
        int zzi2 = zzi();
        int i5 = zza2 & zzi2;
        int zza3 = zzea.zza(this.zze, i5);
        if (zza3 != 0) {
            int i6 = ~zzi2;
            int i7 = zza2 & i6;
            int i8 = 0;
            while (true) {
                int i9 = zza3 - 1;
                int i10 = iArr[i9];
                if ((i10 & i6) != i7 || !zzcz.zza(k2, objArr[i9])) {
                    int i11 = i10 & zzi2;
                    ...
                    if (i11 != 0) {
                        ...
                        zzi2 = zza(zzi2, zzea.zzb(zzi2), zza2, i3);
                    } else {
                        iArr[i9] = zzea.zza(i10, i4, zzi2);
                    }
                } else {
                    V v3 = vArr[i9];
                    vArr[i9] = v2;
        ...
        this.zza[i3] = zzea.zza(zza2, 0, zzi2);
        this.zzb[i3] = k2;
        this.zzc[i3] = v2;
        this.zzg = i4;
        zzc();
