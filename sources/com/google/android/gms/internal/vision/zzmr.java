...
public interface zzmr {
    ...
    void zza(int i, zzht zzht);

    <K, V> void zza(int i, zzkf<K, V> zzkf, Map<K, V> map);

    void zza(int i, Object obj);

    void zza(int i, Object obj, zzlc zzlc);

    void zza(int i, String str);

    void zza(int i, List<String> list);

    void zza(int i, List<?> list, zzlc zzlc);
    ...
    @Deprecated
    void zzb(int i, Object obj, zzlc zzlc);

    void zzb(int i, List<zzht> list);

    @Deprecated
    void zzb(int i, List<?> list, zzlc zzlc);
