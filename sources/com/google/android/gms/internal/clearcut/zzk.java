...
public final class zzk {
    ...
    public static long zza(byte[] bArr) {
        ...
        if (length <= 32) {
            ...
            return zza(Long.rotateRight(zzb9 + zzb10, 43) + Long.rotateRight(zzb11, 30) + ((zza + zzb(bArr3, i3 - 24)) * j4), zzb9 + Long.rotateRight(zzb10 + j6, 18) + zzb11, j5);
        } else {
            ...
            int i8 = 0;
            while (true) {
                long rotateRight2 = (Long.rotateRight(((zzb12 + j7) + jArr[c]) + zzb(bArr2, i8 + 8), i) * -5435081209227447693L) ^ jArr2[1];
                long rotateRight3 = (Long.rotateRight(j7 + jArr[1] + zzb(bArr2, i8 + 48), 42) * -5435081209227447693L) + jArr[0] + zzb(bArr2, i8 + 40);
                ...
                if (i11 == i10) {
                    ...
                    long rotateRight5 = (Long.rotateRight(((rotateRight4 + rotateRight3) + jArr[0]) + zzb(bArr2, i7 + 8), 37) * j9) ^ (jArr2[1] * 9);
                    long rotateRight6 = (Long.rotateRight(rotateRight3 + jArr[1] + zzb(bArr2, i7 + 48), 42) * j9) + (jArr[0] * 9) + zzb(bArr2, i7 + 40);
                    long rotateRight7 = Long.rotateRight(rotateRight2 + jArr2[0], 33) * j9;
                    zza(bArr, i7, jArr[1] * j9, rotateRight5 + jArr2[0], jArr);
                    zza(bArr, i7 + 32, jArr2[1] + rotateRight7, zzb(bArr2, i7 + 16) + rotateRight6, jArr2);
                    long j10 = j9;
                    return zza(zza(jArr[0], jArr2[0], j10) + (((rotateRight6 >>> 47) ^ rotateRight6) * -4348849565147123417L) + rotateRight5, zza(jArr[1], jArr2[1], j10) + rotateRight7, j10);
                }
                i8 = i11;
                i5 = i10;
                i6 = i9;
