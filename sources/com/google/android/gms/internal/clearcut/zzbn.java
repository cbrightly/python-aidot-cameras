...
public abstract class zzbn extends zzba {
        ...
        public final void zzb(long j) {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    this.position = i3 + 1;
                    zzfd.zza(bArr3, (long) i3, (byte) ((((int) j) & NeedPermissionEvent.PER_IPC_SPEAK_PERM) | 128));
                    j >>>= 7;
                }
        ...
        public final void zzo(int i) {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    zzfd.zza(bArr3, (long) i4, (byte) ((i & NeedPermissionEvent.PER_IPC_SPEAK_PERM) | 128));
                    i >>>= 7;
                }
                byte[] bArr4 = this.buffer;
    ...
    public static final class zzd extends zzbn {
        ...
        public final void zzb(long j) {
            while ((-128 & j) != 0) {
                this.zzgd.put((byte) ((((int) j) & NeedPermissionEvent.PER_IPC_SPEAK_PERM) | 128));
                j >>>= 7;
            }
            try {
        ...
        public final void zzo(int i) {
            while ((i & -128) != 0) {
                this.zzgd.put((byte) ((i & NeedPermissionEvent.PER_IPC_SPEAK_PERM) | 128));
                i >>>= 7;
            }
            try {
        ...
        public final void zzb(long j) {
            if (this.zzgi <= this.zzgh) {
                while ((j & -128) != 0) {
                    long j2 = this.zzgi;
                    this.zzgi = j2 + 1;
                    zzfd.zza(j2, (byte) ((((int) j) & NeedPermissionEvent.PER_IPC_SPEAK_PERM) | 128));
                    j >>>= 7;
                }
                long j3 = this.zzgi;
                this.zzgi = 1 + j3;
            ...
            while (true) {
                ...
                if (j4 >= this.zzgg) {
                    ...
                    this.zzgi = j4 + 1;
                    zzfd.zza(j4, (byte) ((((int) j) & NeedPermissionEvent.PER_IPC_SPEAK_PERM) | 128));
                    j >>>= 7;
                }
            }
        }
        ...
        public final void zzo(int i) {
            ...
            if (this.zzgi <= this.zzgh) {
                while (true) {
                    ...
                    this.zzgi = j + 1;
                    zzfd.zza(j, (byte) ((i & NeedPermissionEvent.PER_IPC_SPEAK_PERM) | 128));
                    i >>>= 7;
                }
            } else {
                while (true) {
