...
public final class zzax {
        ...
        if ((i >>> 3) != 0) {
            switch (i & 7) {
                ...
                case 2:
                    int zza = zza(bArr, i2, zzay);
                    int i4 = zzay.zzfd;
                    zzey.zzb(i, i4 == 0 ? zzbb.zzfi : zzbb.zzb(bArr, zza, i4));
                    return zza + i4;
                case 3:
                    zzey zzeb = zzey.zzeb();
                    int i5 = (i & -8) | 4;
                    ...
                    while (true) {
                        if (i2 < i3) {
                            ...
                            i6 = i7;
                            if (i7 != i5) {
                                int zza3 = zza(i6, bArr, zza2, i3, zzeb, zzay);
                                i6 = i7;
                                i2 = zza3;
                            } else {
                                i2 = zza2;
    ...
    static int zza(int i, byte[] bArr, int i2, zzay zzay) {
        int i3;
        int i4;
        int i5 = i & NeedPermissionEvent.PER_IPC_SPEAK_PERM;
        int i6 = i2 + 1;
        byte b = bArr[i2];
        if (b >= 0) {
            i4 = b << 7;
