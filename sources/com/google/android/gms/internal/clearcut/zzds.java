...
public final class zzds<T> implements zzef<T> {
    ...
    private static int zza(com.google.android.gms.internal.clearcut.zzef r6, byte[] r7, int r8, int r9, com.google.android.gms.internal.clearcut.zzay r10) {
        /*
            int r0 = r8 + 1
            byte r8 = r7[r8]
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final int zza(T r17, byte[] r18, int r19, int r20, int r21, int r22, int r23, int r24, int r25, long r26, int r28, com.google.android.gms.internal.clearcut.zzay r29) {
        /*
            r16 = this;
            r0 = r16
            r1 = r17
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final <K, V> int zza(T r7, byte[] r8, int r9, int r10, int r11, int r12, long r13, com.google.android.gms.internal.clearcut.zzay r15) {
        /*
            r6 = this;
            sun.misc.Unsafe r12 = zzmh
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static int zza(byte[] r1, int r2, int r3, com.google.android.gms.internal.clearcut.zzfl r4, java.lang.Class<?> r5, com.google.android.gms.internal.clearcut.zzay r6) {
        /*
            ...
            if (zzco.next()) {
                ...
                while (true) {
                    if (zzcx >= zzec.zzcv() || i7 >= ((zzcx - i2) << 2)) {
                        ...
                        iArr[i7] = zzco.zzcx();
                        int i10 = i7 + 1;
                        iArr[i10] = (zzco.zzdi() ? 536870912 : 0) | (zzco.zzdh() ? SQLiteDatabase.CREATE_IF_NECESSARY : 0) | (zzco.zzcy() << 20) | i6;
                        iArr[i7 + 2] = i5 | (i4 << 20);
                        if (zzco.zzdl() != null) {
                            int i11 = (i7 / 4) << 1;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:70:0x00c2 A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:76:0x0104 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean zzo(T r17) {
        ...
        L_0x005b:
            goto L_0x0104
        L_0x005d:
            boolean r6 = r0.zza(r1, (int) r9, (int) r10)
            if (r6 == 0) goto L_0x0104
            com.google.android.gms.internal.clearcut.zzef r6 = r0.zzad(r10)
            boolean r6 = zza((java.lang.Object) r1, (int) r11, (com.google.android.gms.internal.clearcut.zzef) r6)
            if (r6 != 0) goto L_0x0104
            r6 = 0
            return r6
        L_0x006f:
