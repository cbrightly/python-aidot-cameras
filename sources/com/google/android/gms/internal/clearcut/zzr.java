...
public final class zzr extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return "PlayLoggerContext[" + "package=" + this.packageName + StringUtil.COMMA + "packageVersionCode=" + this.zzi + StringUtil.COMMA + "logSource=" + this.zzk + StringUtil.COMMA + "logSourceName=" + this.zzj + StringUtil.COMMA + "uploadAccount=" + this.zzl + StringUtil.COMMA + "loggingId=" + this.zzm + StringUtil.COMMA + "logAndroidId=" + this.zzay + StringUtil.COMMA + "isAnonymous=" + this.zzn + StringUtil.COMMA + "qosTier=" + this.zzaz + "]";
    }
