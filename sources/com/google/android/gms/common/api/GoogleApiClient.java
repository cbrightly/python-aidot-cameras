...
public abstract class GoogleApiClient {
    ...
    public static void dumpAll(@NonNull String prefix, @NonNull FileDescriptor fd, @NonNull PrintWriter writer, @NonNull String[] args) {
        ...
        synchronized (set) {
            String str = prefix + JustifyTextView.TWO_CHINESE_BLANK;
            int i = 0;
    ...
    public static final class Builder {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public <O extends Api.ApiOptions.HasOptions> Builder addApiIfAvailable(@NonNull Api<O> api, @NonNull O options, @NonNull Scope... scopes) {
            Preconditions.checkNotNull(api, "Api must not be null");
        ...
        @NonNull
        @CanIgnoreReturnValue
        public <T extends Api.ApiOptions.NotRequiredOptions> Builder addApiIfAvailable(@NonNull Api<? extends Api.ApiOptions.NotRequiredOptions> api, @NonNull Scope... scopes) {
            Preconditions.checkNotNull(api, "Api must not be null");
            this.zaj.put(api, (Object) null);
