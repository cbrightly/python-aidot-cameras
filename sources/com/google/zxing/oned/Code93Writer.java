...
public class Code93Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String contents) {
        ...
        if (length <= 80) {
            ...
            toIntArray(iArr[check1], widths);
            int pos2 = pos + appendPattern(result, pos, widths);
            toIntArray(iArr[computeChecksumIndex(contents + "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(check1), 15)], widths);
            int pos3 = pos2 + appendPattern(result, pos2, widths);
            toIntArray(iArr[47], widths);
