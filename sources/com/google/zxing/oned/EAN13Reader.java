...
public final class EAN13Reader extends UPCEANReader {
    ...
    public int decodeMiddle(BitArray row, int[] startRange, StringBuilder resultString) {
        ...
        for (int x2 = 0; x2 < 6 && rowOffset2 < end; x2++) {
            resultString.append((char) (UPCEANReader.decodeDigit(row, counters, rowOffset2, UPCEANReader.L_PATTERNS) + 48));
