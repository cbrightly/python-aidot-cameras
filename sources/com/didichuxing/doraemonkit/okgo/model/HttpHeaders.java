...
public class HttpHeaders implements Serializable {
    ...
    public static String getAcceptLanguage() {
        ...
        if (!TextUtils.isEmpty(country)) {
            ...
            acceptLanguageBuilder.append(country);
            acceptLanguageBuilder.append(StringUtil.COMMA);
            acceptLanguageBuilder.append(language);
            acceptLanguageBuilder.append(";q=0.8");
        }
        String sb = acceptLanguageBuilder.toString();
        acceptLanguage = sb;
        return sb;
    }
    ...
    public static String getUserAgent() {
        ...
        try {
            webUserAgent = DokitOkGo.getInstance().getContext().getString(((Integer) Class.forName("com.android.internal.R$string").getDeclaredField("web_user_agent").get((Object) null)).intValue());
        } catch (Exception e) {
        }
        ...
        String format = String.format(webUserAgent, new Object[]{buffer, "Mobile "});
        userAgent = format;
        return format;
    }
