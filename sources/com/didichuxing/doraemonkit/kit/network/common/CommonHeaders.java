...
public final class CommonHeaders {
    ...
    private CommonHeaders(String[] namesAndValues2) {
    ...
    public boolean equals(Object other) {
        return (other instanceof CommonHeaders) && Arrays.equals(((CommonHeaders) other).namesAndValues, this.namesAndValues);
    }
    ...
    public static CommonHeaders of(String... namesAndValues2) {
        if (namesAndValues2 == null) {
            ...
            return new CommonHeaders(namesAndValues3);
        } else {
    ...
    public static CommonHeaders of(Map<String, String> headers) {
        if (headers != null) {
            ...
            return new CommonHeaders(namesAndValues2);
        }
        ...
        private void checkNameAndValue(String name, String value) {
            if (name == null) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    if (c <= ' ' || c >= 127) {
                        throw new IllegalArgumentException(CommonHeaders.format("Unexpected char %#04x at %d in header name: %s", Integer.valueOf(c), Integer.valueOf(i), name));
                    }
                }
                if (value != null) {
                    int i2 = 0;
                    ...
                    while (i2 < length2) {
                        ...
                        if ((c2 > 31 || c2 == 9) && c2 < 127) {
                            ...
                            throw new IllegalArgumentException(CommonHeaders.format("Unexpected char %#04x at %d in %s value: %s", Integer.valueOf(c2), Integer.valueOf(i2), name, value));
                        }
                    }
                    return;
                }
