...
import com.didichuxing.doraemonkit.picasso.Action;
...
public class DokitPicasso {
    ...
    public interface Listener {
        void onImageLoadFailed(DokitPicasso dokitPicasso, Uri uri, Exception exc);
    }
    ...
    DokitPicasso(Context context2, Dispatcher dispatcher2, Cache cache2, Listener listener2, RequestTransformer requestTransformer2, List<RequestHandler> extraRequestHandlers, Stats stats2, Bitmap.Config defaultBitmapConfig2, boolean indicatorsEnabled2, boolean loggingEnabled2) {
    ...
    public static DokitPicasso with(Context context2) {
        if (singleton == null) {
    ...
    public static class Builder {
        ...
        public DokitPicasso build() {
            ...
            Context context3 = context2;
            return new DokitPicasso(context2, new Dispatcher(context2, this.service, DokitPicasso.HANDLER, this.downloader, this.cache, stats), this.cache, this.listener, this.transformer, this.requestHandlers, stats, this.defaultBitmapConfig, this.indicatorsEnabled, this.loggingEnabled);
        }
    }
