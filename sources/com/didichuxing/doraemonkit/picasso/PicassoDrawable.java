...
public final class PicassoDrawable extends BitmapDrawable {
    ...
    static void setBitmap(ImageView target, Context context, Bitmap bitmap, DokitPicasso.LoadedFrom loadedFrom2, boolean noFade, boolean debugging2) {
    ...
    PicassoDrawable(Context context, Bitmap bitmap, Drawable placeholder2, DokitPicasso.LoadedFrom loadedFrom2, boolean noFade, boolean debugging2) {
        super(context.getResources(), bitmap);
        this.debugging = debugging2;
        this.density = context.getResources().getDisplayMetrics().density;
        this.loadedFrom = loadedFrom2;
        if (loadedFrom2 != DokitPicasso.LoadedFrom.MEMORY && !noFade) {
