...
public class UrlConnectionDownloader implements Downloader {
    ...
    /* access modifiers changed from: protected */
    public HttpURLConnection openConnection(Uri path) {
        HttpURLConnection connection = (HttpURLConnection) new URL(path.toString()).openConnection();
        connection.setConnectTimeout(15000);
        connection.setReadTimeout(GroupCtrlAdapter.TIMEOUT_WAIT_MESH_ONLINE);
        return connection;
    }
    ...
    public Downloader.Response load(Uri uri, int networkPolicy) {
        ...
        if (networkPolicy != 0) {
            ...
            connection.setRequestProperty(HttpHeaders.HEAD_KEY_CACHE_CONTROL, headerValue);
        }
