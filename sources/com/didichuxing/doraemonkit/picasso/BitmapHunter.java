...
public class BitmapHunter implements Runnable {
    ...
    DokitPicasso.Priority priority;
    ...
    BitmapHunter(DokitPicasso picasso2, Dispatcher dispatcher2, Cache cache2, Stats stats2, Action action2, RequestHandler requestHandler2) {
    ...
    public Bitmap hunt() {
        ...
        if (!MemoryPolicy.shouldReadFromMemoryCache(this.memoryPolicy) || (bitmap = this.cache.get(this.key)) == null) {
            ...
            RequestHandler.Result result2 = this.requestHandler.load(request, this.networkPolicy);
            if (result2 != null) {
        ...
        this.loadedFrom = DokitPicasso.LoadedFrom.MEMORY;
        if (this.picasso.loggingEnabled) {
    ...
    public void attach(Action action2) {
        ...
        if (this.action == null) {
            ...
            DokitPicasso.Priority actionPriority = action2.getPriority();
    ...
    private DokitPicasso.Priority computeNewPriority() {
        DokitPicasso.Priority newPriority = DokitPicasso.Priority.LOW;
        List<Action> list = this.actions;
        ...
        if (hasMultiple) {
            ...
            for (int i = 0; i < n; i++) {
                DokitPicasso.Priority actionPriority = this.actions.get(i).getPriority();
    ...
    /* access modifiers changed from: package-private */
    public DokitPicasso getPicasso() {
        return this.picasso;
    }
    ...
    /* access modifiers changed from: package-private */
    public DokitPicasso.Priority getPriority() {
    ...
    static BitmapHunter forRequest(DokitPicasso picasso2, Dispatcher dispatcher2, Cache cache2, Stats stats2, Action action2) {
    ...
    static android.graphics.Bitmap transformResult(com.didichuxing.doraemonkit.picasso.Request r19, android.graphics.Bitmap r20, int r21) {
        /*
            r0 = r19
            r1 = r21
            int r2 = r20.getWidth()
        ...
        L_0x00f3:
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.doraemonkit.picasso.BitmapHunter.transformResult(com.didichuxing.doraemonkit.picasso.Request, android.graphics.Bitmap, int):android.graphics.Bitmap");
    }
