...
public abstract class Action<T> {
    ...
    Action(DokitPicasso picasso2, T target2, Request request2, int memoryPolicy2, int networkPolicy2, int errorResId2, Drawable errorDrawable2, String key2, Object tag2, boolean noFade2) {
