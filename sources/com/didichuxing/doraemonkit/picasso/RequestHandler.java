...
public abstract class RequestHandler {
    ...
    public static final class Result {
        ...
        public Result(Bitmap bitmap2, DokitPicasso.LoadedFrom loadedFrom2) {
            this((Bitmap) Utils.checkNotNull(bitmap2, "bitmap == null"), (InputStream) null, loadedFrom2, 0);
        }

        public Result(InputStream stream2, DokitPicasso.LoadedFrom loadedFrom2) {
            this((Bitmap) null, (InputStream) Utils.checkNotNull(stream2, "stream == null"), loadedFrom2, 0);
        }

        Result(Bitmap bitmap2, InputStream stream2, DokitPicasso.LoadedFrom loadedFrom2, int exifOrientation2) {
            boolean z = true;
            if ((stream2 == null ? false : z) ^ (bitmap2 != null)) {
                this.bitmap = bitmap2;
                this.stream = stream2;
                this.loadedFrom = (DokitPicasso.LoadedFrom) Utils.checkNotNull(loadedFrom2, "loadedFrom == null");
