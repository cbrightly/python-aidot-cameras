...
public final class Request {
    ...
    public final DokitPicasso.Priority priority;
    ...
    public static final class Builder {
        ...
        private DokitPicasso.Priority priority;
        ...
        public Builder priority(DokitPicasso.Priority priority2) {
            if (priority2 == null) {
        ...
        public Request build() {
            ...
            if (z && this.centerCrop) {
                ...
                if (this.priority == null) {
                    this.priority = DokitPicasso.Priority.NORMAL;
                }
                Request request = r2;
