...
public class FastJsonRedisSerializer<T> implements RedisSerializer<T> {
    ...
    public T deserialize(byte[] bytes) {
        ...
        try {
            return JSON.parseObject(bytes, this.fastJsonConfig.getCharset(), (Type) this.type, this.fastJsonConfig.getParserConfig(), this.fastJsonConfig.getParseProcess(), JSON.DEFAULT_PARSER_FEATURE, this.fastJsonConfig.getFeatures());
        } catch (Exception ex) {
