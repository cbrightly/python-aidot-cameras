            ...
            while (true) {
                ...
                if (key == null) {
                    if (lexer.token() == 13) {
                        lexer.nextToken(i);
                        break;
                    } else if (lexer.token() == i && lexer.isEnabled(Feature.AllowArbitraryCommas)) {
                    }
                }
                ...
                if ("className".equals(key)) {
                ...
                } else if (Progress.FILE_NAME.equals(key)) {
                    if (lexer.token() == 8) {
                        fileName = null;
                    } else if (lexer.token() == 4) {
                    ...
                    if (lexer.token() != 8) {
                        if (lexer.token() == 4) {
                            String moduleName = lexer.stringVal();
                        } else {
                            throw new JSONException("syntax error");
                        }
                    }
                    ...
                    if (lexer.token() != 8) {
                        if (lexer.token() == 4) {
                            String moduleVersion = lexer.stringVal();
                        } else {
                            throw new JSONException("syntax error");
                        }
                    }
                    ...
                    if (lexer.token() == 4) {
                        String classLoaderName = lexer.stringVal();
                    } else {
                        throw new JSONException("syntax error");
                    }
                }
