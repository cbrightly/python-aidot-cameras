...
public class ClassWriter {
    ...
    public byte[] toByteArray() {
        ...
        ByteVector putShort = out.putShort(this.index);
        ByteVector byteVector = this.pool;
        putShort.putByteArray(byteVector.data, 0, byteVector.length);
    ...
    public Item newConstItem(Object cst) {
        if (cst instanceof Integer) {
            ...
            put(result2);
            return result2;
        } else if ((cst instanceof String) != 0) {
    ...
    public Item newNameTypeItem(String name2, String desc) {
        this.key2.set(12, name2, desc, (String) null);
        Item result = get(this.key2);
        if (result != null) {
            return result;
        }
    ...
    private Item get(Item key4) {
        ...
        Item i = itemArr[key4.hashCode % itemArr.length];
