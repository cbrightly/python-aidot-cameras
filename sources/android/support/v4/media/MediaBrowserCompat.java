...
public final class MediaBrowserCompat {
    ...
    public static abstract class SubscriptionCallback {
        ...
        public class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
            ...
            public void onChildrenLoaded(@NonNull String parentId, List<?> children) {
                ...
                Subscription sub = weakReference == null ? null : (Subscription) weakReference.get();
                if (sub == null) {
                        ...
                        if (mediaBrowserImplBase.mState != 0) {
                            ...
                            if (MediaBrowserCompat.DEBUG && mediaBrowserImplBase.mServiceConnection != null) {
                                ...
                                try {
                                    ...
                                    bound = mediaBrowserImplBase3.mContext.bindService(intent, mediaBrowserImplBase3.mServiceConnection, 1);
                                } catch (Exception e) {
        ...
        public void disconnect() {
            ...
            this.mHandler.post(new Runnable() {
                public void run() {
                    ...
                    MediaBrowserImplBase mediaBrowserImplBase2 = MediaBrowserImplBase.this;
                    int state = mediaBrowserImplBase2.mState;
    ...
    public static class CallbackHandler extends Handler {
        ...
        public void handleMessage(android.os.Message r12) {
            ...
            L_0x0016:
                ...
                r10 = 1
                int r3 = r12.what     // Catch:{ BadParcelableException -> 0x009f }
            ...
            L_0x0037:
                ...
                android.os.Bundle r7 = r1.getBundle(r3)     // Catch:{ BadParcelableException -> 0x009f }
                android.support.v4.media.session.MediaSessionCompat.ensureClassLoader(r7)     // Catch:{ BadParcelableException -> 0x009f }
                java.lang.String r3 = "data_notify_children_changed_options"
                android.os.Bundle r8 = r1.getBundle(r3)     // Catch:{ BadParcelableException -> 0x009f }
                android.support.v4.media.session.MediaSessionCompat.ensureClassLoader(r8)     // Catch:{ BadParcelableException -> 0x009f }
                java.lang.String r5 = r1.getString(r4)     // Catch:{ BadParcelableException -> 0x009f }
                java.lang.String r3 = "data_media_item_list"
                java.util.ArrayList r6 = r1.getParcelableArrayList(r3)     // Catch:{ BadParcelableException -> 0x009f }
                r3 = r2
                r4 = r9
                r3.onLoadChildren(r4, r5, r6, r7, r8)     // Catch:{ BadParcelableException -> 0x009f }
                goto L_0x009e
            L_0x005a:
                r2.onConnectionFailed(r9)     // Catch:{ BadParcelableException -> 0x009f }
                goto L_0x009e
            L_0x005e:
                java.lang.String r3 = "data_root_hints"
                android.os.Bundle r3 = r1.getBundle(r3)     // Catch:{ BadParcelableException -> 0x009f }
                android.support.v4.media.session.MediaSessionCompat.ensureClassLoader(r3)     // Catch:{ BadParcelableException -> 0x009f }
                java.lang.String r4 = r1.getString(r4)     // Catch:{ BadParcelableException -> 0x009f }
                java.lang.String r5 = "data_media_session_token"
                android.os.Parcelable r5 = r1.getParcelable(r5)     // Catch:{ BadParcelableException -> 0x009f }
                android.support.v4.media.session.MediaSessionCompat$Token r5 = (android.support.v4.media.session.MediaSessionCompat.Token) r5     // Catch:{ BadParcelableException -> 0x009f }
                r2.onServiceConnected(r9, r4, r5, r3)     // Catch:{ BadParcelableException -> 0x009f }
                goto L_0x009e
            L_0x0078:
                java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ BadParcelableException -> 0x009f }
                r3.<init>()     // Catch:{ BadParcelableException -> 0x009f }
                java.lang.String r4 = "Unhandled message: "
                r3.append(r4)     // Catch:{ BadParcelableException -> 0x009f }
                r3.append(r12)     // Catch:{ BadParcelableException -> 0x009f }
                java.lang.String r4 = "\n  Client version: "
                r3.append(r4)     // Catch:{ BadParcelableException -> 0x009f }
                r3.append(r10)     // Catch:{ BadParcelableException -> 0x009f }
                java.lang.String r4 = "\n  Service version: "
                r3.append(r4)     // Catch:{ BadParcelableException -> 0x009f }
                int r4 = r12.arg1     // Catch:{ BadParcelableException -> 0x009f }
                r3.append(r4)     // Catch:{ BadParcelableException -> 0x009f }
                java.lang.String r3 = r3.toString()     // Catch:{ BadParcelableException -> 0x009f }
                android.util.Log.w(r0, r3)     // Catch:{ BadParcelableException -> 0x009f }
            L_0x009e:
                goto L_0x00ac
            L_0x009f:
                r3 = move-exception
    ...
    public static class ServiceBinderWrapper {
        ...
        /* access modifiers changed from: package-private */
        public void connect(Context context, Messenger callbacksMessenger) {
        ...
        /* access modifiers changed from: package-private */
        public void disconnect(Messenger callbacksMessenger) {
            sendRequest(2, (Bundle) null, callbacksMessenger);
        }

        /* access modifiers changed from: package-private */
        public void addSubscription(String parentId, IBinder callbackToken, Bundle options, Messenger callbacksMessenger) {
            Bundle data = new Bundle();
        ...
        /* access modifiers changed from: package-private */
        public void removeSubscription(String parentId, IBinder callbackToken, Messenger callbacksMessenger) {
            Bundle data = new Bundle();
            data.putString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID, parentId);
            BundleCompat.putBinder(data, MediaBrowserProtocol.DATA_CALLBACK_TOKEN, callbackToken);
        ...
        /* access modifiers changed from: package-private */
        public void getMediaItem(String mediaId, ResultReceiver receiver, Messenger callbacksMessenger) {
            Bundle data = new Bundle();
        ...
        /* access modifiers changed from: package-private */
        public void registerCallbackMessenger(Context context, Messenger callbackMessenger) {
            Bundle data = new Bundle();
            data.putString(MediaBrowserProtocol.DATA_PACKAGE_NAME, context.getPackageName());
            data.putBundle(MediaBrowserProtocol.DATA_ROOT_HINTS, this.mRootHints);
        ...
        /* access modifiers changed from: package-private */
        public void unregisterCallbackMessenger(Messenger callbackMessenger) {
            sendRequest(7, (Bundle) null, callbackMessenger);
        }

        /* access modifiers changed from: package-private */
        public void search(String query, Bundle extras, ResultReceiver receiver, Messenger callbacksMessenger) {
            Bundle data = new Bundle();
        ...
        /* access modifiers changed from: package-private */
        public void sendCustomAction(String action, Bundle extras, ResultReceiver receiver, Messenger callbacksMessenger) {
            Bundle data = new Bundle();
