...
public final class MessageAction_LinkJsonAdapter extends f<MessageAction.Link> {
    @NotNull
    private final i.a a;
    @NotNull
    ...
    public MessageAction_LinkJsonAdapter(@NotNull r moshi) {
        Class<String> cls = String.class;
        k.e(moshi, "moshi");
        i.a a2 = i.a.a("id", "metadata", "text", "uri", "default");
        k.d(a2, "of(\"id\", \"metadata\", \"te…, \"uri\",\n      \"default\")");
        this.a = a2;
    ...
    public String toString() {
        ...
        $this$toString_u24lambda_u2d0.append("MessageAction.Link");
    ...
    @NotNull
    /* renamed from: k */
    public MessageAction.Link b(@NotNull i reader) {
        k.e(reader, "reader");
        String id = null;
        Map metadata = null;
        String text = null;
            ...
            switch (reader.J(this.a)) {
                ...
                case 4:
                    ...
                    if (b5 != null) {
                        ...
                        JsonDataException u4 = b.u("default", "default", reader);
                        k.d(u4, "unexpectedNull(\"default\"…       \"default\", reader)");
                        throw u4;
                    }
            }
        }
        ...
        if (id == null) {
            ...
            return new MessageAction.Link(id, metadata, text, uri, bool.booleanValue());
        } else {
            JsonDataException l4 = b.l("default", "default", reader);
            k.d(l4, "missingProperty(\"default\", \"default\", reader)");
            throw l4;
        }
    }

    /* renamed from: l */
    public void i(@NotNull o writer, @Nullable MessageAction.Link value_) {
        k.e(writer, "writer");
        if (value_ != null) {
            writer.g();
            writer.r("id");
