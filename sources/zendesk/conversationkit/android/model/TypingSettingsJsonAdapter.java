...
public final class TypingSettingsJsonAdapter extends f<TypingSettings> {
    ...
    public TypingSettingsJsonAdapter(@NotNull r moshi) {
        k.e(moshi, "moshi");
    ...
    public String toString() {
        ...
        $this$toString_u24lambda_u2d0.append("TypingSettings");
    ...
    @NotNull
    /* renamed from: k */
    public TypingSettings b(@NotNull i reader) {
        k.e(reader, "reader");
        ...
        reader.i();
        if (enabled != null) {
            return new TypingSettings(enabled.booleanValue());
        }
    ...
    /* renamed from: l */
    public void i(@NotNull o writer, @Nullable TypingSettings value_) {
        k.e(writer, "writer");
        if (value_ != null) {
            writer.g();
            writer.r("enabled");
