...
public final class MessageAction_PostbackJsonAdapter extends f<MessageAction.Postback> {
    ...
    public MessageAction_PostbackJsonAdapter(@NotNull r moshi) {
        Class<String> cls = String.class;
        k.e(moshi, "moshi");
        i.a a2 = i.a.a("id", "metadata", "text", "payload");
    ...
    public String toString() {
        ...
        $this$toString_u24lambda_u2d0.append("MessageAction.Postback");
    ...
    @NotNull
    /* renamed from: k */
    public MessageAction.Postback b(@NotNull i reader) {
        k.e(reader, "reader");
        String id = null;
        Map metadata = null;
        String text = null;
        ...
        if (id == null) {
            ...
            return new MessageAction.Postback(id, metadata, text, payload);
        } else {
    ...
    /* renamed from: l */
    public void i(@NotNull o writer, @Nullable MessageAction.Postback value_) {
        k.e(writer, "writer");
        if (value_ != null) {
            writer.g();
            writer.r("id");
