...
public final class MessageAction_ReplyJsonAdapter extends f<MessageAction.Reply> {
    ...
    public MessageAction_ReplyJsonAdapter(@NotNull r moshi) {
        Class<String> cls = String.class;
        k.e(moshi, "moshi");
        i.a a2 = i.a.a("id", "metadata", "text", "iconUrl", "payload");
        k.d(a2, "of(\"id\", \"metadata\", \"te…    \"iconUrl\", \"payload\")");
        this.a = a2;
        ...
        this.c = f2;
        f<String> f3 = moshi.f(cls, o0.d(), "iconUrl");
        k.d(f3, "moshi.adapter(String::cl…   emptySet(), \"iconUrl\")");
        this.d = f3;
    }
    ...
    public String toString() {
        ...
        $this$toString_u24lambda_u2d0.append("MessageAction.Reply");
    ...
    @NotNull
    /* renamed from: k */
    public MessageAction.Reply b(@NotNull i reader) {
        k.e(reader, "reader");
        String id = null;
        Map metadata = null;
        String text = null;
            ...
            switch (reader.J(this.a)) {
                ...
                case 4:
                    ...
                    if (b4 != null) {
                        ...
                        JsonDataException u3 = b.u("payload", "payload", reader);
                        k.d(u3, "unexpectedNull(\"payload\"…       \"payload\", reader)");
                        throw u3;
                    }
            }
        }
        ...
        if (id == null) {
            ...
            return new MessageAction.Reply(id, metadata, text, iconUrl, payload);
        } else {
            JsonDataException l3 = b.l("payload", "payload", reader);
            k.d(l3, "missingProperty(\"payload\", \"payload\", reader)");
            throw l3;
        }
    }

    /* renamed from: l */
    public void i(@NotNull o writer, @Nullable MessageAction.Reply value_) {
        k.e(writer, "writer");
        if (value_ != null) {
            writer.g();
            writer.r("id");
