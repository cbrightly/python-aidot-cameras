...
public class SM2P256V1Field {
    ...
    public static void a(int[] x, int[] y, int[] z) {
        if (Nat256.a(x, y, z) != 0 || ((z[7] >>> 1) >= Integer.MAX_VALUE && Nat256.q(z, a))) {
            c(z);
        }
    }

    public static void b(int[] x, int[] z) {
        if (Nat.r(8, x, z) != 0 || ((z[7] >>> 1) >= Integer.MAX_VALUE && Nat256.q(z, a))) {
            c(z);
        }
    }
    ...
    public static void h(int[] xx, int[] z) {
        ...
        long xx122 = xx12;
        long cc = 0 + (((long) xx[0]) & 4294967295L) + tt + xx13 + xx14 + xx15;
        iArr[0] = (int) cc;
        long xx112 = xx11;
        long cc2 = (cc >> 32) + (((((long) xx[1]) & 4294967295L) + tt) - xx08) + xx14 + xx15;
        iArr[1] = (int) cc2;
        long cc3 = (cc2 >> 32) + ((((long) xx[2]) & 4294967295L) - ts);
        iArr[2] = (int) cc3;
        long cc4 = (cc3 >> 32) + ((((((long) xx[3]) & 4294967295L) + tt) - xx09) - xx10) + xx13;
        iArr[3] = (int) cc4;
        long cc5 = (cc4 >> 32) + ((((((long) xx[4]) & 4294967295L) + tt) - t1) - xx08) + xx14;
        iArr[4] = (int) cc5;
        long cc6 = (cc5 >> 32) + (((long) xx[5]) & 4294967295L) + t4 + xx10;
        iArr[5] = (int) cc6;
        long cc7 = (cc6 >> 32) + (((long) xx[6]) & 4294967295L) + xx112 + xx14 + xx15;
        iArr[6] = (int) cc7;
        long cc8 = (cc7 >> 32) + (4294967295L & ((long) xx[7])) + tt + t4 + xx122;
        iArr[7] = (int) cc8;
        i((int) (cc8 >> 32), iArr);
    }
    ...
    public static void i(int x, int[] z) {
        ...
        if (x != 0) {
            ...
            long cc5 = cc3 + ((((long) z[2]) & 4294967295L) - xx08);
            z[2] = (int) cc5;
            long cc6 = (cc5 >> 32) + (((long) z[3]) & 4294967295L) + xx08;
            z[3] = (int) cc6;
            long cc7 = cc6 >> 32;
            if (cc7 != 0) {
                ...
                z[5] = (int) cc9;
                long cc10 = (cc9 >> 32) + (((long) z[6]) & 4294967295L);
                z[6] = (int) cc10;
                cc7 = cc10 >> 32;
            }
            long cc11 = cc7 + (4294967295L & ((long) z[7])) + xx08;
            z[7] = (int) cc11;
            cc = cc11 >> 32;
        }
        if (cc != 0 || ((z[7] >>> 1) >= Integer.MAX_VALUE && Nat256.q(z, a))) {
            c(z);
        }
    }
    ...
    public static void n(int[] x, int[] z) {
        if (Nat.D(8, x, 0, z) != 0 || ((z[7] >>> 1) >= Integer.MAX_VALUE && Nat256.q(z, a))) {
            c(z);
        }
    }
    ...
    private static void c(int[] z) {
        ...
        long c4 = c2 + ((((long) z[2]) & 4294967295L) - 1);
        z[2] = (int) c4;
        long c5 = (c4 >> 32) + (((long) z[3]) & 4294967295L) + 1;
        z[3] = (int) c5;
        long c6 = c5 >> 32;
        if (c6 != 0) {
            ...
            z[5] = (int) c8;
            long c9 = (c8 >> 32) + (((long) z[6]) & 4294967295L);
            z[6] = (int) c9;
            c6 = c9 >> 32;
        }
        z[7] = (int) (c6 + (4294967295L & ((long) z[7])) + 1);
    }
