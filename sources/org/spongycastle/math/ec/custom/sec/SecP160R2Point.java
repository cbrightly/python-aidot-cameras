...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint d() {
        return new SecP160R2Point((ECCurve) null, f(), g());
    }
    ...
    public ECPoint a(ECPoint b) {
        ...
        if (!Nat160.j(S12)) {
            ...
            int[] iArr10 = U2;
            int[] iArr11 = t4;
            return new SecP160R2Point(curve, X32, Y32, zs, this.f);
        } else if (Nat160.j(R)) {
            return H();
        } else {
            return curve.u();
    ...
    public ECPoint H() {
        ...
        if (!Z1IsOne) {
            int[] Z1Squared3 = t2;
            SecP160R2Field.i(Z1.h, Z1Squared3);
            Z1Squared = Z1Squared3;
        } else {
            Z1Squared = Z1Squared2;
        }
        SecP160R2Field.k(X1.h, Z1Squared, t1);
        int[] M = t2;
        SecP160R2Field.a(X1.h, Z1Squared, M);
        SecP160R2Field.d(M, t1, M);
        int c = Nat160.b(M, M, M);
        SecP160R2Field.h(c, M);
        int[] S = Y1Squared;
        SecP160R2Field.d(Y1Squared, X1.h, S);
        int i = c;
        int c2 = Nat.F(5, S, 2, 0);
        SecP160R2Field.h(c2, S);
        int i2 = c2;
        int c3 = Nat.G(5, T, 3, 0, t1);
        SecP160R2Field.h(c3, t1);
        ...
        int[] iArr7 = M;
        int[] iArr8 = Z1Squared;
        return new SecP160R2Point(curve, X32, Y32, new ECFieldElement[]{Z3}, this.f);
    }
    ...
    public ECPoint x() {
        ...
        return new SecP160R2Point(this.b, this.c, this.d.m(), this.e, this.f);
    }
}
