...
public class SecT239K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint d() {
        return new SecT239K1Point((ECCurve) null, f(), g());
    }
            ...
            if (!B.i()) {
                if (X2.i()) {
                    ...
                    if (X3.i()) {
                        ...
                        return new SecT239K1Point(curve, X3, curve.o(), this.f);
                    }
                    ...
                    if (X32.i()) {
                        ...
                        return new SecT239K1Point(curve, X32, curve.o(), this.f);
                    }
                ...
                return new SecT239K1Point(curve, X3, L3, new ECFieldElement[]{Z3}, this.f);
            } else if (A.i()) {
                return H();
            } else {
                return curve.u();
    ...
    public ECPoint H() {
        ...
        if (T.i()) {
            return new SecT239K1Point(curve, T, curve.o(), this.f);
        }
        ...
        return new SecT239K1Point(curve, X3, t1.a(T).a(Z1Sq).j(t1).a(t2).a(X3).a(Z3), new ECFieldElement[]{Z3}, this.f);
    }
    ...
    public ECPoint I(ECPoint b) {
        ...
        if (X2.i()) {
            ...
            if (B.i()) {
                ...
                return new SecT239K1Point(curve, A, curve.o(), this.f);
            } else {
                ...
                return new SecT239K1Point(curve, X3, L3, eCFieldElementArr, this.f);
            }
        }
        return H().a(eCPoint);
    }
    ...
    public ECPoint x() {
        ...
        return new SecT239K1Point(eCCurve, X, L.a(Z), new ECFieldElement[]{Z}, this.f);
    }
}
