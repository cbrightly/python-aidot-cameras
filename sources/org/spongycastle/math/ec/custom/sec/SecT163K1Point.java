...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint d() {
        return new SecT163K1Point((ECCurve) null, f(), g());
    }
            ...
            if (!B.i()) {
                if (X2.i()) {
                    ...
                    if (X3.i()) {
                        ...
                        return new SecT163K1Point(curve, X3, curve.o(), this.f);
                    }
                    ECFieldElement eCFieldElement5 = X2;
                    ECFieldElement eCFieldElement6 = L2;
                    L3 = L.j(X12.a(X3)).a(X3).a(Y1).d(X3).a(X3);
                    Z3 = curve.m(ECConstants.b);
                    ECFieldElement eCFieldElement7 = B;
                    ECFieldElement B2 = X12;
                } else {
                    ECFieldElement eCFieldElement8 = S2;
                    ECFieldElement eCFieldElement9 = X2;
                    ECFieldElement eCFieldElement10 = L2;
                    ECFieldElement B3 = B.o();
                    ECFieldElement AU1 = A.j(U1);
                    ECFieldElement AU2 = A.j(U2);
                    ECFieldElement X32 = AU1.j(AU2);
                    if (X32.i()) {
                        ECFieldElement eCFieldElement11 = X1;
                        return new SecT163K1Point(curve, X32, curve.o(), this.f);
                    }
                    ...
                    if (!Z1IsOne) {
                        ...
                        ECFieldElement eCFieldElement13 = B3;
                        X3 = X32;
                    }
                }
                ECFieldElement eCFieldElement14 = A;
                ECFieldElement eCFieldElement15 = U1;
                return new SecT163K1Point(curve, X3, L3, new ECFieldElement[]{Z3}, this.f);
            } else if (A.i()) {
                return H();
            } else {
                return curve.u();
    ...
    public ECPoint H() {
        ...
        ECFieldElement T = L1.o().a(L1Z1).a(Z1Sq);
        if (T.i()) {
            return new SecT163K1Point(curve, T, curve.o(), this.f);
        }
        ECFieldElement X3 = T.o();
        ECFieldElement Z3 = Z1IsOne ? T : T.j(Z1Sq);
        ECFieldElement t1 = L1.a(X1).o();
        ECFieldElement eCFieldElement = t1;
        return new SecT163K1Point(curve, X3, t1.a(T).a(Z1Sq).j(t1).a(X3), new ECFieldElement[]{Z3}, this.f);
    }
    ...
    public ECPoint I(ECPoint b) {
        ...
        if (X2.i()) {
            ...
            ECFieldElement T = Z1Sq.a(L1Sq).a(L1Z1);
            ECFieldElement A = L2.j(Z1Sq).a(L1Sq).l(T, X1Sq, Z1Sq);
            ECFieldElement X2Z1Sq = X2.j(Z1Sq);
            ECFieldElement eCFieldElement4 = X1;
            ECFieldElement B = X2Z1Sq.a(T).o();
            if (B.i()) {
                if (A.i()) {
                    return b.H();
                }
                ...
                ECFieldElement eCFieldElement5 = L1Z1;
                ECFieldElement eCFieldElement6 = L1Sq;
                ECFieldElement eCFieldElement7 = X2;
                return new SecT163K1Point(curve, A, curve.o(), this.f);
            } else {
                ECFieldElement eCFieldElement8 = L1Sq;
                ECFieldElement eCFieldElement9 = X2;
                ECFieldElement X3 = A.o().j(X2Z1Sq);
                ECFieldElement Z3 = A.j(B).j(Z1Sq);
                ECFieldElement eCFieldElement10 = X2Z1Sq;
                ECFieldElement eCFieldElement11 = A;
                ECFieldElement eCFieldElement12 = T;
                ECFieldElement eCFieldElement13 = Z1Sq;
                ECFieldElement eCFieldElement14 = Z3;
                return new SecT163K1Point(curve, X3, A.a(B).o().l(T, L2.b(), Z3), new ECFieldElement[]{Z3}, this.f);
            }
        }
        return H().a(eCPoint);
    }
    ...
    public ECPoint x() {
        ...
        return new SecT163K1Point(eCCurve, X, L.a(Z), new ECFieldElement[]{Z}, this.f);
    }
}
