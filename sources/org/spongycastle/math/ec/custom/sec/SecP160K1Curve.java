...
public class SecP160K1Curve extends ECCurve.AbstractFp {
    public static final BigInteger i = SecP160R2Curve.i;
    protected SecP160K1Point j = new SecP160K1Point(this, (ECFieldElement) null, (ECFieldElement) null);

    public SecP160K1Curve() {
        super(i);
        this.b = m(ECConstants.a);
        this.c = m(BigInteger.valueOf(7));
        this.d = new BigInteger(1, Hex.a("0100000000000000000001B8FA16DFAB9ACA16B6B3"));
