...
public class SecP128R1Curve extends ECCurve.AbstractFp {
    public static final BigInteger i = new BigInteger(1, Hex.a("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFF"));
    protected SecP128R1Point j = new SecP128R1Point(this, (ECFieldElement) null, (ECFieldElement) null);

    public SecP128R1Curve() {
        super(i);
        this.b = m(new BigInteger(1, Hex.a("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.c = m(new BigInteger(1, Hex.a("E87579C11079F43DD824993C2CEE5ED3")));
        this.d = new BigInteger(1, Hex.a("FFFFFFFE0000000075A30D1B9038A115"));
