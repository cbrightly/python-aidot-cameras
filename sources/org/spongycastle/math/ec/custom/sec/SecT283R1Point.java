...
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint d() {
        return new SecT283R1Point((ECCurve) null, f(), g());
    }
            ...
            if (!B.i()) {
                if (X2.i()) {
                    ...
                    if (X3.i()) {
                        ...
                        return new SecT283R1Point(curve, X3, curve.o().n(), this.f);
                    }
                    ...
                    if (X32.i()) {
                        ...
                        return new SecT283R1Point(curve, X32, curve.o().n(), this.f);
                    }
                ...
                return new SecT283R1Point(curve, X3, L3, new ECFieldElement[]{Z3}, this.f);
            } else if (A.i()) {
                return H();
            } else {
                return curve.u();
    ...
    public ECPoint H() {
        ...
        if (T.i()) {
            return new SecT283R1Point(curve, T, curve.o().n(), this.f);
        }
        ...
        return new SecT283R1Point(curve, X3, X1Z1.p(T, L1Z1).a(X3).a(Z3), new ECFieldElement[]{Z3}, this.f);
    }
    ...
    public ECPoint I(ECPoint b) {
        ...
        if (X2.i()) {
            ...
            if (B.i()) {
                ...
                return new SecT283R1Point(curve, A, curve.o().n(), this.f);
            } else {
                ...
                return new SecT283R1Point(curve, X3, A.a(B).o().l(T, L2.b(), Z3), new ECFieldElement[]{Z3}, this.f);
            }
        }
        return H().a(eCPoint);
    }
    ...
    public ECPoint x() {
        ...
        return new SecT283R1Point(eCCurve, X, L.a(Z), new ECFieldElement[]{Z}, this.f);
    }
}
