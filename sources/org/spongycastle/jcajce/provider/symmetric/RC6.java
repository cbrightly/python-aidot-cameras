...
public final class RC6 {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        public AlgorithmParameters engineGenerateParameters() {
            ...
            this.b.nextBytes(iv);
            try {
                AlgorithmParameters params = a("RC6");
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void a(ConfigurableProvider provider) {
            ...
            sb.append(str);
            sb.append("$ECB");
            provider.addAlgorithm("Cipher.RC6", sb.toString());
            provider.addAlgorithm("KeyGenerator.RC6", str + "$KeyGen");
            provider.addAlgorithm("AlgorithmParameters.RC6", str + "$AlgParams");
            c(provider, "RC6", str + "$GMAC", str + "$KeyGen");
            d(provider, "RC6", str + "$Poly1305", str + "$Poly1305KeyGen");
        }
    }
}
