...
public final class CAST6 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void a(ConfigurableProvider provider) {
            ...
            sb.append(str);
            sb.append("$ECB");
            provider.addAlgorithm("Cipher.CAST6", sb.toString());
            provider.addAlgorithm("KeyGenerator.CAST6", str + "$KeyGen");
            c(provider, "CAST6", str + "$GMAC", str + "$KeyGen");
            d(provider, "CAST6", str + "$Poly1305", str + "$Poly1305KeyGen");
        }
    }
}
