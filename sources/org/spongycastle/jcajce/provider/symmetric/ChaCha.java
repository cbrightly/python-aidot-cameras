...
public final class ChaCha {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void a(ConfigurableProvider provider) {
            ...
            sb.append(str);
            sb.append("$Base");
            provider.addAlgorithm("Cipher.CHACHA", sb.toString());
            provider.addAlgorithm("KeyGenerator.CHACHA", str + "$KeyGen");
            provider.addAlgorithm("Cipher.CHACHA7539", str + "$Base7539");
            provider.addAlgorithm("KeyGenerator.CHACHA7539", str + "$KeyGen7539");
        }
    }
}
