...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public void initialize(AlgorithmParameterSpec params, SecureRandom random) {
        ...
        if (params instanceof ECParameterSpec) {
            ...
            ECDomainParameters ecP = DSTU4145NamedCurves.a(new ASN1ObjectIdentifier(curveName));
            if (ecP != null) {
    ...
    public KeyPair generateKeyPair() {
        if (this.f) {
            ...
            if (obj instanceof ECParameterSpec) {
                ...
                BCDSTU4145PublicKey pubKey = new BCDSTU4145PublicKey(this.c, pub2, p);
                return new KeyPair(pubKey, new BCDSTU4145PrivateKey(this.c, priv, pubKey, p));
            } else if (obj == null) {
                return new KeyPair(new BCDSTU4145PublicKey(this.c, pub2), new BCDSTU4145PrivateKey(this.c, priv));
            } else {
                java.security.spec.ECParameterSpec p2 = (java.security.spec.ECParameterSpec) obj;
                BCDSTU4145PublicKey pubKey2 = new BCDSTU4145PublicKey(this.c, pub2, p2);
                return new KeyPair(pubKey2, new BCDSTU4145PrivateKey(this.c, priv, pubKey2, p2));
            }
        } else {
