...
public class IESCipher extends CipherSpi {
    ...
    public int engineGetOutputSize(int inputLen) {
        ...
        if (this.h != null) {
            int len1 = this.c.f().e();
            if (this.k == null) {
                feSize = ((((ECKeyParameters) this.h).b().a().t() + 7) / 8) * 2;
            } else {
                feSize = 0;
            }
            if (this.c.d() == null) {
                ...
                } else if (len32 == 2 || len32 == 4) {
                    len3 = this.c.d().c((inputLen - len1) - feSize);
                } else {
            ...
            int i2 = this.d;
            if (i2 == 1 || i2 == 3) {
                return this.e.size() + len1 + 1 + feSize + len3;
            }
            if (i2 == 2 || i2 == 4) {
                return ((this.e.size() - len1) - feSize) + len3;
            }
            throw new IllegalStateException("cipher not initialised");
        }
        throw new IllegalStateException("cipher not initialised");
        ...
        if (i3 == 0 || (nonce2 != null && nonce2.length == i3)) {
            if (opmode == 1 || opmode == 3) {
                if (key instanceof PublicKey) {
                    ...
                    this.h = ECUtils.a(ieKey.getPublic());
                    this.k = ECUtil.d(ieKey.getPrivate());
                } else {
                ...
                this.h = ECUtil.d((PrivateKey) key);
            } else if (key instanceof IESKey) {
                IESKey ieKey2 = (IESKey) key;
                this.k = ECUtils.a(ieKey2.getPublic());
                this.h = ECUtil.d(ieKey2.getPrivate());
            } else {
    ...
    public byte[] engineDoFinal(byte[] input, int inputOffset, int inputLen) {
        ...
        ECDomainParameters ecParams = ((ECKeyParameters) this.h).b();
        ...
        if (asymmetricKeyParameter != null) {
            ...
            if (i3 == 1 || i3 == 3) {
                ...
                gen.c(new ECKeyGenerationParameters(ecParams, this.i));
                final boolean usePointCompression = this.g.f();
                try {
                    this.c.h(this.h, params, new EphemeralKeyPairGenerator(gen, new KeyEncoder() {
                        public byte[] a(AsymmetricKeyParameter keyParameter) {
                            return ((ECPublicKeyParameters) keyParameter).c().l(usePointCompression);
                        }
                    }));
                    return this.c.j(in, 0, in.length);
                } catch (Exception e3) {
                ...
                try {
                    this.c.g(this.h, params, new ECIESPublicKeyParser(ecParams));
                    return this.c.j(in, 0, in.length);
    ...
    public static class ECIESwithCipher extends IESCipher {
        public ECIESwithCipher(BlockCipher cipher, int ivLength) {
            super(new IESEngine(new ECDHBasicAgreement(), new KDF2BytesGenerator(DigestFactory.b()), new HMac(DigestFactory.b()), new PaddedBufferedBlockCipher(cipher)), ivLength);
        }
    }
