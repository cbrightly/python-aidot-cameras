...
public class BCECGOST3410PrivateKey implements ECPrivateKey, org.spongycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private void c(PrivateKeyInfo info) {
        ...
        GOST3410PublicKeyAlgParameters gParams = GOST3410PublicKeyAlgParameters.g(info.g().h());
        this.c = gParams;
        ECNamedCurveParameterSpec spec = ECGOST3410NamedCurveTable.a(ECGOST3410NamedCurves.c(gParams.h()));
        this.f = new ECNamedCurveSpec(ECGOST3410NamedCurves.c(gParams.h()), EC5Util.a(spec.a(), spec.e()), new ECPoint(spec.b().f().t(), spec.b().g().t()), spec.d(), spec.c());
    ...
    public byte[] getEncoded() {
        ...
        if (this.c != null) {
            ...
            a(encKey, 0, getS());
            try {
                return new PrivateKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.m, this.c), new DEROctetString(encKey)).getEncoded("DER");
            } catch (IOException e) {
                return null;
            }
        } else {
            ...
            try {
                return new PrivateKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.m, params.toASN1Primitive()), keyStructure.toASN1Primitive()).getEncoded("DER");
    ...
    private void a(byte[] encKey, int offSet, BigInteger bI) {
    ...
    private DERBitString b(BCECGOST3410PublicKey pub2) {
        try {
