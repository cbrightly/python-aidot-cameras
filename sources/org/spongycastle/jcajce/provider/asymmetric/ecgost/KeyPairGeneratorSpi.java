    ...
    public KeyPair generateKeyPair() {
        if (this.g) {
            ...
            if (obj instanceof ECParameterSpec) {
                ...
                BCECGOST3410PublicKey pubKey = new BCECGOST3410PublicKey(this.c, pub2, p);
                return new KeyPair(pubKey, new BCECGOST3410PrivateKey(this.c, priv, pubKey, p));
            } else if (obj == null) {
                return new KeyPair(new BCECGOST3410PublicKey(this.c, pub2), new BCECGOST3410PrivateKey(this.c, priv));
            } else {
                java.security.spec.ECParameterSpec p2 = (java.security.spec.ECParameterSpec) obj;
                BCECGOST3410PublicKey pubKey2 = new BCECGOST3410PublicKey(this.c, pub2, p2);
                return new KeyPair(pubKey2, new BCECGOST3410PrivateKey(this.c, priv, pubKey2, p2));
            }
        } else {
