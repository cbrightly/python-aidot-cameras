...
public class DH {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        public void a(ConfigurableProvider provider) {
            ...
            provider.addAttributes("KeyAgreement.DH", DH.a);
            ...
            provider.addAlgorithm("KeyAgreement", PKCSObjectIdentifiers.A2, "org.spongycastle.jcajce.provider.asymmetric.dh.KeyAgreementSpi$DHwithRFC2631KDF");
            provider.addAlgorithm("KeyAgreement", PKCSObjectIdentifiers.B2, "org.spongycastle.jcajce.provider.asymmetric.dh.KeyAgreementSpi$DHwithRFC2631KDF");
            ...
            c(provider, PKCSObjectIdentifiers.b0, "DH", new KeyFactorySpi());
            c(provider, X9ObjectIdentifiers.k4, "DH", new KeyFactorySpi());
        }
    }
}
