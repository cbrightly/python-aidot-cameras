...
public class X509CertParser extends X509StreamParserSpi {
    ...
    private Certificate d(InputStream in) {
        ...
        if (seq.size() <= 1 || !(seq.r(0) instanceof ASN1ObjectIdentifier) || !seq.r(0).equals(PKCSObjectIdentifiers.B0)) {
            return new X509CertificateObject(org.spongycastle.asn1.x509.Certificate.f(seq));
        }
    ...
    private Certificate c() {
        ...
        while (this.c < this.b.size()) {
            ...
            int i = this.c;
            this.c = i + 1;
            Object obj = aSN1Set.s(i);
            if (obj instanceof ASN1Sequence) {
                return new X509CertificateObject(org.spongycastle.asn1.x509.Certificate.f(obj));
            }
        }
        return null;
    }

    private Certificate e(InputStream in) {
