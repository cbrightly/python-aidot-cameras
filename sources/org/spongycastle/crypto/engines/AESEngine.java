...
public class AESEngine implements BlockCipher {
    ...
    private static int l(int r, int shift) {
    ...
    public void a(boolean forEncryption, CipherParameters params) {
        if (params instanceof KeyParameter) {
            this.g = i(((KeyParameter) params).a(), forEncryption);
            this.l = forEncryption;
            if (forEncryption) {
                this.m = Arrays.h(a);
            } else {
                this.m = Arrays.h(b);
    ...
    private void n(byte[] bytes, int off) {
        int index = off;
        int index2 = index + 1;
        ...
        this.k = b13;
        int i2 = index16 + 1;
        this.k = b13 | (bytes[index16] << 24);
    }

    private void k(byte[] bytes, int off) {
        int index = off;
        int index2 = index + 1;
        int i2 = this.h;
        bytes[index] = (byte) i2;
    ...
    private void h(int[][] r21) {
        ...
        L_0x0198:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.crypto.engines.AESEngine.h(int[][]):void");
    }
    ...
    private void g(int[][] r21) {
        ...
        L_0x0195:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.crypto.engines.AESEngine.g(int[][]):void");
    }
}
