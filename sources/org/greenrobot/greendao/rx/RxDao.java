...
public class RxDao<T, K> extends RxBase {
    ...
    @Experimental
    public RxDao(AbstractDao<T, K> dao2) {
        this(dao2, (Scheduler) null);
    }

    @Experimental
    public RxDao(AbstractDao<T, K> dao2, Scheduler scheduler) {
        super(scheduler);
        this.dao = dao2;
    }
    ...
    public Observable<Object[]> insertInTx(final T... entities) {
        return wrap(new Callable<Object[]>() {
            public Object[] call() {
                RxDao.this.dao.insertInTx((T[]) entities);
                return entities;
            }
        });
    }
    ...
    public Observable<Object[]> insertOrReplaceInTx(final T... entities) {
        return wrap(new Callable<Object[]>() {
            public Object[] call() {
                RxDao.this.dao.insertOrReplaceInTx((T[]) entities);
                return entities;
            }
        });
    }
    ...
    public Observable<Object[]> saveInTx(final T... entities) {
        return wrap(new Callable<Object[]>() {
            public Object[] call() {
                RxDao.this.dao.saveInTx((T[]) entities);
                return entities;
            }
        });
    }
    ...
    public Observable<Object[]> updateInTx(final T... entities) {
        return wrap(new Callable<Object[]>() {
            public Object[] call() {
                RxDao.this.dao.updateInTx((T[]) entities);
                return entities;
            }
        });
    }
    ...
    public Observable<Void> deleteInTx(final T... entities) {
        return wrap(new Callable<Void>() {
            public Void call() {
                RxDao.this.dao.deleteInTx((T[]) entities);
                return null;
            }
        });
    }
    ...
    public Observable<Void> deleteByKeyInTx(final K... keys) {
        return wrap(new Callable<Void>() {
            public Void call() {
                RxDao.this.dao.deleteByKeyInTx((K[]) keys);
                return null;
            }
        });
    }
