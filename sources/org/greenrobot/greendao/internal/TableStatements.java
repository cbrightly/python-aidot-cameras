...
public class TableStatements {
    ...
    public TableStatements(Database db2, String tablename2, String[] allColumns2, String[] pkColumns2) {
        this.db = db2;
    ...
    public String getSelectByKey() {
        if (this.selectByKey == null) {
            ...
            SqlUtils.appendColumnsEqValue(builder, ExifInterface.GPS_DIRECTION_TRUE, this.pkColumns);
