...
public class Bits {
    ...
    static int makeInt(byte b3, byte b2, byte b1, byte b0) {
        return ((b3 & 255) << 24) | ((b2 & 255) << MappingData.PATH) | ((b1 & 255) << 8) | (b0 & 255);
    }
    ...
    static long makeLong(byte b7, byte b6, byte b5, byte b4, byte b3, byte b2, byte b1, byte b0) {
        return ((((long) b7) & 255) << 56) | ((((long) b6) & 255) << 48) | ((((long) b5) & 255) << 40) | ((((long) b4) & 255) << 32) | ((((long) b3) & 255) << 24) | ((((long) b2) & 255) << 16) | ((((long) b1) & 255) << 8) | (255 & ((long) b0));
    }
