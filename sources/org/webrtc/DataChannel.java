...
public class DataChannel {
    ...
    private native boolean nativeCustomSend(byte[] bArr, boolean z, boolean z2);
    ...
    public boolean customSend(Buffer buffer, boolean isOrder) {
        checkDataChannelExists();
        byte[] data = new byte[buffer.data.remaining()];
        buffer.data.get(data);
        return nativeCustomSend(data, buffer.binary, isOrder);
    }
