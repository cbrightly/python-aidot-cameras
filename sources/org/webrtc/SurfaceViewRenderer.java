...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    private void updateSurfaceSize() {
        ...
        Log.d(TAG, "[hyf]updateSurfaceSize. Layout size: " + getWidth() + "x" + getHeight() + ", frame size: " + this.rotatedFrameWidth + "x" + this.rotatedFrameHeight + ", requested surface size: " + width + "x" + height + ", old surface size: " + this.surfaceWidth + "x" + this.surfaceHeight);
    ...
    public void restoreFirstFrameRendered() {
        this.eglRenderer.restoreFirstFrameRendered();
    }
    ...
    public void onFrameResolutionChanged(int videoWidth, int videoHeight, int rotation) {
        ...
        postOrRun(new c0(this, (rotation == 0 || rotation == 180) ? videoWidth : videoHeight, (rotation == 0 || rotation == 180) ? videoHeight : videoWidth));
    }

    /* access modifiers changed from: private */
    /* renamed from: lambda$onFrameResolutionChanged$0 */
    public /* synthetic */ void a(int rotatedWidth, int rotatedHeight) {
    ...
    public void setKeyFrameRequired(boolean keyFrameRequired2) {
        this.keyFrameRequired = keyFrameRequired2;
    }
}
