        ...
        public CameraStatistics(SurfaceTextureHelper surfaceTextureHelper2, CameraEventsHandler eventsHandler2) {
            AnonymousClass1 r0 = new Runnable() {
                public void run() {
                    ...
                    CameraStatistics.this.surfaceTextureHelper.getHandler().postDelayed(this, CacheHandler.delayTime);
                }
            };
            ...
            if (surfaceTextureHelper2 != null) {
                ...
                surfaceTextureHelper2.getHandler().postDelayed(r0, CacheHandler.delayTime);
                return;
            }
