...
public abstract class CameraCapturer implements CameraVideoCapturer {
        ...
        public void onDone(CameraSession session) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                ...
                if (CameraCapturer.this.switchState == SwitchState.IN_PROGRESS) {
                    ...
                    cameraCapturer2.switchCameraInternal(cameraCapturer2.switchEventsHandler, selectedCameraName);
                }
            }
        }
    ...
    public /* synthetic */ void addMediaRecorderToCamera(MediaRecorder mediaRecorder, CameraVideoCapturer.MediaRecorderHandler mediaRecorderHandler) {
        q0.a(this, mediaRecorder, mediaRecorderHandler);
    }
    ...
    public /* synthetic */ void removeMediaRecorderFromCamera(CameraVideoCapturer.MediaRecorderHandler mediaRecorderHandler) {
        q0.b(this, mediaRecorderHandler);
    }
    ...
    public CameraCapturer(String cameraName2, @Nullable CameraVideoCapturer.CameraEventsHandler eventsHandler2, CameraEnumerator cameraEnumerator2) {
    ...
    /* access modifiers changed from: private */
    public void reportCameraSwitchError(String error, @Nullable CameraVideoCapturer.CameraSwitchHandler switchEventsHandler2) {
        Logging.e(TAG, error);
    ...
    /* access modifiers changed from: private */
    public void switchCameraInternal(@Nullable CameraVideoCapturer.CameraSwitchHandler switchEventsHandler2, String selectedCameraName) {
