...
public class VideoSource extends MediaSource {
    private final CapturerObserver capturerObserver = new CapturerObserver() {
        ...
        public void onFrameCaptured(org.webrtc.VideoFrame r4) {
            ...
            L_0x0024:
                monitor-exit(r1)     // Catch:{ all -> 0x0038 }
                org.webrtc.VideoFrame r1 = org.webrtc.z0.b(r4, r0)
    ...
    public void setVideoProcessor(@Nullable VideoProcessor newVideoProcessor) {
        synchronized (this.videoProcessorLock) {
            ...
            if (newVideoProcessor != null) {
                newVideoProcessor.setSink(new m0(this));
                if (this.isCapturerRunning) {
    ...
    public /* synthetic */ void b(VideoFrame frame) {
        runWithReference(new l0(this, frame));
    }
