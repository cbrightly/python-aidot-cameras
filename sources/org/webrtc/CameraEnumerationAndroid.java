...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size[]{new Size(Opcodes.IF_ICMPNE, 120), new Size(240, Opcodes.IF_ICMPNE), new Size(BuildConfig.VERSION_CODE, 240), new Size(BaseResp.ERR_MSG_SEND_FAIL, 240), new Size(480, BuildConfig.VERSION_CODE), new Size(640, 360), new Size(640, 480), new Size(AVIOCTRLDEFs.IOTYPE_USER_IPCAM_AUDIOSTART, 480), new Size(854, 480), new Size(800, 600), new Size(960, 540), new Size(960, 640), new Size(1024, 576), new Size(1024, 600), new Size(AVIOCTRLDEFs.IOTYPE_USER_IPCAM_GET_SAVE_DROPBOX_REQ, 720), new Size(AVIOCTRLDEFs.IOTYPE_USER_IPCAM_GET_SAVE_DROPBOX_REQ, 1024), new Size(1920, 1080), new Size(1920, 1440), new Size(2560, 1440), new Size(3840, 2160)}));
    ...
    public static class CaptureFormat {
        ...
        public static class FramerateRange {
            ...
            public String toString() {
                return Constants.ARRAY_TYPE + (((float) this.min) / 1000.0f) + ":" + (((float) this.max) / 1000.0f) + "]";
            }
            ...
            public int hashCode() {
                return (this.min * AVIOCTRLDEFs.IOTYPE_USER_IPCAM_SET_VSAAS_PLAYBACK_INFO_RESP) + 1 + this.max;
            }
        }
        ...
        public int hashCode() {
            return (((this.width * 65497) + this.height) * NSType.IXFR) + 1 + this.framerate.hashCode();
        }
    }
    ...
    public static CaptureFormat.FramerateRange getClosestSupportedFramerateRange(List<CaptureFormat.FramerateRange> supportedFramerates, final int requestedFps) {
        return (CaptureFormat.FramerateRange) Collections.min(supportedFramerates, new ClosestComparator<CaptureFormat.FramerateRange>() {
            ...
            public int diff(CaptureFormat.FramerateRange range) {
                return progressivePenalty(range.min, MIN_FPS_THRESHOLD, 1, 4) + progressivePenalty(Math.abs((requestedFps * 1000) - range.max), 5000, 1, 3);
            }
        });
    }
