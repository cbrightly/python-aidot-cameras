...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    private JavaI420Buffer(int width2, int height2, ByteBuffer dataY2, int strideY2, ByteBuffer dataU2, int strideU2, ByteBuffer dataV2, int strideV2, @Nullable Runnable releaseCallback) {
        this.width = width2;
        this.height = height2;
        this.dataY = dataY2;
        this.dataU = dataU2;
    ...
    public static JavaI420Buffer wrap(int width2, int height2, ByteBuffer dataY2, int strideY2, ByteBuffer dataU2, int strideU2, ByteBuffer dataV2, int strideV2, @Nullable Runnable releaseCallback) {
        int i = width2;
        int i2 = height2;
    ...
    public static JavaI420Buffer allocate(int width2, int height2) {
        ...
        return new JavaI420Buffer(width2, height2, dataY2, width2, dataU2, strideUV, buffer.slice(), strideUV, new q(buffer));
    }
    ...
    public static VideoFrame.Buffer cropAndScaleI420(VideoFrame.I420Buffer buffer, int cropX, int cropY, int cropWidth, int cropHeight, int scaleWidth, int scaleHeight) {
        if (cropWidth != scaleWidth) {
            ...
            return wrap(scaleWidth, scaleHeight, slice, strideY2, slice2, strideU2, slice3, strideV2, new o(buffer));
        }
