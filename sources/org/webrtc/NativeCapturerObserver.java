...
public class NativeCapturerObserver implements CapturerObserver {
    ...
    public void onFrameCaptured(VideoFrame frame) {
        ...
        if (parameters != null) {
            ...
            this.nativeAndroidVideoTrackSource.onFrameCaptured(new VideoFrame(adaptedBuffer, frame.getRotation(), parameters.timestampNs, "NativeCapturerObserver-0-0", frame.getIsKeyFrame()));
