...
public class JavaAudioDeviceModule implements AudioDeviceModule {
    ...
    public static class Builder {
        ...
        public Builder setInputSampleRate(int inputSampleRate2) {
            Logging.d(JavaAudioDeviceModule.TAG, "Input sample rate overridden to: " + inputSampleRate2);
            this.inputSampleRate = inputSampleRate2;
            return this;
        }

        public Builder setOutputSampleRate(int outputSampleRate2) {
            Logging.d(JavaAudioDeviceModule.TAG, "Output sample rate overridden to: " + outputSampleRate2);
    ...
    public void startIntercom() {
        this.audioInput.startIntercom();
    }

    public void stopIntercom() {
        Logging.d(TAG, "stopIntercom: ");
        this.audioInput.stopIntercom();
    }
