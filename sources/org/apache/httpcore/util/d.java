...
public final class d implements CharSequence, Serializable {
    ...
    public void append(String str) {
        String s = str != null ? str : BuildConfig.TRAVIS;
        int strlen = s.length();
    ...
    public void append(c b, int off, int len2) {
        if (b != null) {
            append(b.buffer(), off, len2);
        }
    }
    ...
    public String substringTrimmed(int beginIndex, int endIndex) {
        if (beginIndex < 0) {
            ...
            while (beginIndex0 < endIndex && c.a(this.buffer[beginIndex0])) {
                beginIndex0++;
            }
            while (endIndex0 > beginIndex0 && c.a(this.buffer[endIndex0 - 1])) {
                endIndex0--;
            }
