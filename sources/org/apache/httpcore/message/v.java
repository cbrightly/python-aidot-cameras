...
public class v {
    ...
    public String f(d buf, u cursor, BitSet delimiters) {
    ...
    public String g(d buf, u cursor, BitSet delimiters) {
        StringBuilder dst = new StringBuilder();
        boolean whitespace = false;
        while (!cursor.a()) {
            char current = buf.charAt(cursor.b());
    ...
    public void b(d buf, u cursor, BitSet delimiters, StringBuilder dst) {
        int pos = cursor.b();
        int indexFrom = cursor.b();
        int indexTo = cursor.c();
    ...
    public void d(d buf, u cursor, BitSet delimiters, StringBuilder dst) {
        int pos = cursor.b();
        int indexFrom = cursor.b();
        int indexTo = cursor.c();
        for (int i = indexFrom; i < indexTo; i++) {
    ...
    public void c(d buf, u cursor, StringBuilder dst) {
        if (!cursor.a()) {
            int pos = cursor.b();
            int indexFrom = cursor.b();
            int indexTo = cursor.c();
