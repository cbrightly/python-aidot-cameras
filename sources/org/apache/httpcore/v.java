...
public class v implements Serializable, Cloneable {
    ...
    public v(String protocol2, int major2, int minor2) {
        this.protocol = (String) a.g(protocol2, "Protocol name");
        this.major = a.e(major2, "Protocol major version");
        this.minor = a.e(minor2, "Protocol minor version");
    }
