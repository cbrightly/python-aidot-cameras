...
public class DatabaseUtils {
    ...
    public static long queryNumEntries(SQLiteDatabase db, String table) {
        Cursor cursor = db.query(table, countProjection, (String) null, (String[]) null, (String) null, (String) null, (String) null);
        try {
            cursor.moveToFirst();
    ...
    public static class InsertHelper {
        ...
        private void buildSQL() {
            ...
            try {
                ...
                cur = sQLiteDatabase.rawQuery("PRAGMA table_info(" + this.mTableName + ")", (String[]) null);
